...
`//`/`#` prose untouched — so an over-long comment line silently passes the format
check and ships. Break a line only when the next word would push it past 88: Claude
