...
type Status struct {
	...
	Variant       Variant                `protobuf:"varint,8,opt,name=variant,proto3,enum=x.status.Variant" json:"variant,omitempty"`
...
const file_x_go_status_pb_status_proto_rawDesc = "" +
	"\n" +
	"\x1bx/go/status/pb/status.proto\x12\bx.status\x1a\x19google/protobuf/any.proto\x1a\x19x/go/label/pb/label.proto\"\x83\x02\n" +
	"\x06Status\x12\x10\n" +
	...
	"\x06labels\x18\a \x03(\v2\x0e.x.label.LabelR\x06labels\x12+\n" +
	"\avariant\x18\b \x01(\x0e2\x11.x.status.VariantR\avariant*d\n" +
	"\aVariant\x12\x0f\n" +
	...
	"\bDISABLED\x10\x06B\x7f\n" +
	"\fcom.x.statusB\vStatusProtoP\x01Z!github.com/synnaxlabs/x/status/pb\xa2\x02\x03XSX\xaa\x02\bX.Status\xca\x02\bX\\Status\xe2\x02\x14X\\Status\\GPBMetadata\xea\x02\tX::Statusb\x06proto3"
...
var file_x_go_status_pb_status_proto_goTypes = []any{
	(Variant)(0),      // 0: x.status.Variant
	(*Status)(nil),    // 1: x.status.Status
	(*anypb.Any)(nil), // 2: google.protobuf.Any
	(*pb.Label)(nil),  // 3: x.label.Label
}
var file_x_go_status_pb_status_proto_depIdxs = []int32{
	2, // 0: x.status.Status.details:type_name -> google.protobuf.Any
	3, // 1: x.status.Status.labels:type_name -> x.label.Label
	0, // 2: x.status.Status.variant:type_name -> x.status.Variant
