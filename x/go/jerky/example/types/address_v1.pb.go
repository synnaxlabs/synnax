...
var File_x_go_jerky_example_types_address_v1_proto protoreflect.FileDescriptor
...
var (
	...
	file_x_go_jerky_example_types_address_v1_proto_rawDescData []byte
)

func file_x_go_jerky_example_types_address_v1_proto_rawDescGZIP() []byte {
	file_x_go_jerky_example_types_address_v1_proto_rawDescOnce.Do(func() {
		file_x_go_jerky_example_types_address_v1_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_x_go_jerky_example_types_address_v1_proto_rawDesc), len(file_x_go_jerky_example_types_address_v1_proto_rawDesc)))
	})
	return file_x_go_jerky_example_types_address_v1_proto_rawDescData
}
...
func init() { file_x_go_jerky_example_types_address_v1_proto_init() }
func file_x_go_jerky_example_types_address_v1_proto_init() {
	if File_x_go_jerky_example_types_address_v1_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_x_go_jerky_example_types_address_v1_proto_rawDesc), len(file_x_go_jerky_example_types_address_v1_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_x_go_jerky_example_types_address_v1_proto_goTypes,
		DependencyIndexes: file_x_go_jerky_example_types_address_v1_proto_depIdxs,
		MessageInfos:      file_x_go_jerky_example_types_address_v1_proto_msgTypes,
	}.Build()
	File_x_go_jerky_example_types_address_v1_proto = out.File
	file_x_go_jerky_example_types_address_v1_proto_goTypes = nil
	file_x_go_jerky_example_types_address_v1_proto_depIdxs = nil
}
