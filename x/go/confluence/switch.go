...
// SwitchFunc resolves the address of the input value. If ok is false, the
...
type BatchSwitchFunc[I, O Value] func(
	ctx context.Context, batch I, out map[address.Address]O,
) error
