...
// Migrate runs the provided migrations in order, skipping any that are already
// applied. It returns the updated applied set. All migration keys must be unique.
