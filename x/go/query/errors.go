...
func decode(_ context.Context, pld errors.Payload) (error, bool) {
	...
	if strings.HasPrefix(pld.Type, typePrefix) {
		return errors.Wrap(Err, pld.Data), true
	}
	return nil, false
}
