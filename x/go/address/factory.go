...
type Factory struct {
	...
	host      string
	generated []Address
	// portStart is the starting point for the sequential addresses generated. A
	// portStart of 9090 would mean the first address is 9090, the second is 9091, and
	// so on.
	portStart int
}
...
// NextN returns a slice containing the next N addresses in the sequence. These
// addresses are guaranteed to be unique against all other addresses previously
// generated by the factory.
func (f *Factory) NextN(n int) []Address {
