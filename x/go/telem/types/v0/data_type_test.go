...
func DataTypeInferTest[T v0.Sample](expected v0.DataType) func() {
	return func() {
		dt := v0.InferDataType[T]()
...
var _ = Describe("DataType", func() {
	...
	Describe("Infer", func() {
		Specify("uint8", DataTypeInferTest[uint8](v0.Uint8T))
		Specify("uint16", DataTypeInferTest[uint16](v0.Uint16T))
		Specify("uint32", DataTypeInferTest[uint32](v0.Uint32T))
		Specify("uint64", DataTypeInferTest[uint64](v0.Uint64T))
		Specify("int8", DataTypeInferTest[int8](v0.Int8T))
		Specify("int16", DataTypeInferTest[int16](v0.Int16T))
		Specify("int32", DataTypeInferTest[int32](v0.Int32T))
		Specify("int64", DataTypeInferTest[int64](v0.Int64T))
		Specify("float32", DataTypeInferTest[float32](v0.Float32T))
		Specify("float64", DataTypeInferTest[float64](v0.Float64T))
		Specify("timestamp", DataTypeInferTest[v0.TimeStamp](v0.TimeStampT))
		Specify("uuid", DataTypeInferTest[uuid.UUID](v0.UUIDT))
		Specify("string", DataTypeInferTest[string](v0.StringT))
		Specify("bytes", DataTypeInferTest[[]byte](v0.BytesT))
	})
})
