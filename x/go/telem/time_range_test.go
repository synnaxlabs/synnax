	...
	Describe("Stringer", func() {
		DescribeTable("Should format time ranges with appropriate precision",
			...
			Entry("nanoseconds differ",
				time.Date(2024, time.March, 15, 10, 30, 45, 100, time.UTC),
				time.Date(2024, time.March, 15, 10, 30, 45, 500, time.UTC),
				"2024-03-15T10:30:45.000000100Z - .000000500 (400ns)"),
			Entry("microseconds differ",
				time.Date(2024, time.March, 15, 10, 30, 45, 100000, time.UTC),
				time.Date(2024, time.March, 15, 10, 30, 45, 500000, time.UTC),
			...
			Entry("seconds differ",
				time.Date(2024, time.March, 15, 10, 30, 45, 0, time.UTC),
				time.Date(2024, time.March, 15, 10, 30, 55, 0, time.UTC),
				"2024-03-15T10:30:45Z - :55 (10s)"),
			Entry("minutes differ",
				time.Date(2024, time.March, 15, 10, 30, 0, 0, time.UTC),
				time.Date(2024, time.March, 15, 10, 45, 0, 0, time.UTC),
				"2024-03-15T10:30:00Z - 45:00 (15m)"),
			Entry("hours differ",
				time.Date(2024, time.March, 15, 10, 30, 0, 0, time.UTC),
				time.Date(2024, time.March, 15, 11, 45, 0, 0, time.UTC),
				"2024-03-15T10:30:00Z - 11:45:00 (1h 15m)"),
			Entry("days differ",
				time.Date(2024, time.March, 15, 23, 45, 0, 0, time.UTC),
				time.Date(2024, time.March, 16, 0, 15, 0, 0, time.UTC),
