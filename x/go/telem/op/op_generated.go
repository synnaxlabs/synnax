...
func BitOrI64(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func BitXorI64(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func ShiftLeftI64(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func ShiftRightI64(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func BitAndScalarI64(series telem.Series, scalar int64, output *telem.Series) {
	length := series.Len()
	output.Resize(length)

	inData := unsafe.CastSlice[uint8, int64](series.Data)
	outData := unsafe.CastSlice[uint8, int64](output.Data)
...
func BitOrScalarI64(series telem.Series, scalar int64, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func BitXorScalarI64(series telem.Series, scalar int64, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ShiftLeftScalarI64(series telem.Series, scalar int64, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ShiftRightScalarI64(series telem.Series, scalar int64, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ReverseShiftLeftScalarI64(series telem.Series, scalar int64, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ReverseShiftRightScalarI64(series telem.Series, scalar int64, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func BitNotI64(input telem.Series, output *telem.Series) {
	inputLen := input.Len()
	output.Resize(inputLen)
...
func BitAndI32(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func BitOrI32(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func BitXorI32(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func ShiftLeftI32(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func ShiftRightI32(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func BitAndScalarI32(series telem.Series, scalar int32, output *telem.Series) {
	length := series.Len()
	output.Resize(length)

	inData := unsafe.CastSlice[uint8, int32](series.Data)
	outData := unsafe.CastSlice[uint8, int32](output.Data)
...
func BitOrScalarI32(series telem.Series, scalar int32, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func BitXorScalarI32(series telem.Series, scalar int32, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ShiftLeftScalarI32(series telem.Series, scalar int32, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ShiftRightScalarI32(series telem.Series, scalar int32, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ReverseShiftLeftScalarI32(series telem.Series, scalar int32, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ReverseShiftRightScalarI32(series telem.Series, scalar int32, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func BitNotI32(input telem.Series, output *telem.Series) {
	inputLen := input.Len()
	output.Resize(inputLen)
...
func BitAndI16(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func BitOrI16(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func BitXorI16(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func ShiftLeftI16(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func ShiftRightI16(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func BitAndScalarI16(series telem.Series, scalar int16, output *telem.Series) {
	length := series.Len()
	output.Resize(length)

	inData := unsafe.CastSlice[uint8, int16](series.Data)
	outData := unsafe.CastSlice[uint8, int16](output.Data)
...
func BitOrScalarI16(series telem.Series, scalar int16, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func BitXorScalarI16(series telem.Series, scalar int16, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ShiftLeftScalarI16(series telem.Series, scalar int16, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ShiftRightScalarI16(series telem.Series, scalar int16, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ReverseShiftLeftScalarI16(series telem.Series, scalar int16, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ReverseShiftRightScalarI16(series telem.Series, scalar int16, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func BitNotI16(input telem.Series, output *telem.Series) {
	inputLen := input.Len()
	output.Resize(inputLen)
...
func BitAndI8(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func BitOrI8(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func BitXorI8(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func ShiftLeftI8(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func ShiftRightI8(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func BitAndScalarI8(series telem.Series, scalar int8, output *telem.Series) {
	length := series.Len()
	output.Resize(length)

	inData := unsafe.CastSlice[uint8, int8](series.Data)
	outData := unsafe.CastSlice[uint8, int8](output.Data)
...
func BitOrScalarI8(series telem.Series, scalar int8, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func BitXorScalarI8(series telem.Series, scalar int8, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ShiftLeftScalarI8(series telem.Series, scalar int8, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ShiftRightScalarI8(series telem.Series, scalar int8, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ReverseShiftLeftScalarI8(series telem.Series, scalar int8, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ReverseShiftRightScalarI8(series telem.Series, scalar int8, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func BitNotI8(input telem.Series, output *telem.Series) {
	inputLen := input.Len()
	output.Resize(inputLen)
...
func BitAndU64(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func BitOrU64(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func BitXorU64(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func ShiftLeftU64(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func ShiftRightU64(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func BitAndScalarU64(series telem.Series, scalar uint64, output *telem.Series) {
	length := series.Len()
	output.Resize(length)

	inData := unsafe.CastSlice[uint8, uint64](series.Data)
	outData := unsafe.CastSlice[uint8, uint64](output.Data)
...
func BitOrScalarU64(series telem.Series, scalar uint64, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func BitXorScalarU64(series telem.Series, scalar uint64, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ShiftLeftScalarU64(series telem.Series, scalar uint64, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ShiftRightScalarU64(series telem.Series, scalar uint64, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ReverseShiftLeftScalarU64(series telem.Series, scalar uint64, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ReverseShiftRightScalarU64(series telem.Series, scalar uint64, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func BitNotU64(input telem.Series, output *telem.Series) {
	inputLen := input.Len()
	output.Resize(inputLen)
...
func BitAndU32(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func BitOrU32(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func BitXorU32(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func ShiftLeftU32(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func ShiftRightU32(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func BitAndScalarU32(series telem.Series, scalar uint32, output *telem.Series) {
	length := series.Len()
	output.Resize(length)

	inData := unsafe.CastSlice[uint8, uint32](series.Data)
	outData := unsafe.CastSlice[uint8, uint32](output.Data)
...
func BitOrScalarU32(series telem.Series, scalar uint32, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func BitXorScalarU32(series telem.Series, scalar uint32, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ShiftLeftScalarU32(series telem.Series, scalar uint32, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ShiftRightScalarU32(series telem.Series, scalar uint32, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ReverseShiftLeftScalarU32(series telem.Series, scalar uint32, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ReverseShiftRightScalarU32(series telem.Series, scalar uint32, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func BitNotU32(input telem.Series, output *telem.Series) {
	inputLen := input.Len()
	output.Resize(inputLen)
...
func BitAndU16(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func BitOrU16(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func BitXorU16(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func ShiftLeftU16(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func ShiftRightU16(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func BitAndScalarU16(series telem.Series, scalar uint16, output *telem.Series) {
	length := series.Len()
	output.Resize(length)

	inData := unsafe.CastSlice[uint8, uint16](series.Data)
	outData := unsafe.CastSlice[uint8, uint16](output.Data)
...
func BitOrScalarU16(series telem.Series, scalar uint16, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func BitXorScalarU16(series telem.Series, scalar uint16, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ShiftLeftScalarU16(series telem.Series, scalar uint16, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ShiftRightScalarU16(series telem.Series, scalar uint16, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ReverseShiftLeftScalarU16(series telem.Series, scalar uint16, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ReverseShiftRightScalarU16(series telem.Series, scalar uint16, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func BitNotU16(input telem.Series, output *telem.Series) {
	inputLen := input.Len()
	output.Resize(inputLen)
...
func BitAndU8(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func BitOrU8(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func BitXorU8(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func ShiftLeftU8(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func ShiftRightU8(lhs, rhs telem.Series, output *telem.Series) {
	lhsLen := lhs.Len()
	rhsLen := rhs.Len()
	maxLen := lhsLen
	if rhsLen > maxLen {
...
func BitAndScalarU8(series telem.Series, scalar uint8, output *telem.Series) {
	length := series.Len()
	output.Resize(length)

	inData := unsafe.CastSlice[uint8, uint8](series.Data)
	outData := unsafe.CastSlice[uint8, uint8](output.Data)
...
func BitOrScalarU8(series telem.Series, scalar uint8, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func BitXorScalarU8(series telem.Series, scalar uint8, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ShiftLeftScalarU8(series telem.Series, scalar uint8, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ShiftRightScalarU8(series telem.Series, scalar uint8, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ReverseShiftLeftScalarU8(series telem.Series, scalar uint8, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func ReverseShiftRightScalarU8(series telem.Series, scalar uint8, output *telem.Series) {
	length := series.Len()
	output.Resize(length)
...
func BitNotU8(input telem.Series, output *telem.Series) {
	inputLen := input.Len()
	output.Resize(inputLen)
...
func AddScalarF64(series telem.Series, scalar float64, output *telem.Series) {
	...
	inData := unsafe.CastSlice[uint8, float64](series.Data)
	outData := unsafe.CastSlice[uint8, float64](output.Data)
...
func AddScalarF32(series telem.Series, scalar float32, output *telem.Series) {
	...
	inData := unsafe.CastSlice[uint8, float32](series.Data)
	outData := unsafe.CastSlice[uint8, float32](output.Data)
