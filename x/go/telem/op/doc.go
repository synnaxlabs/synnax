...
// ScalarArith is the signature for scalar arithmetic operations (series op scalar ->
// same type). Note: Actual generated functions are type-specific, e.g.,
// AddScalarF64(series, scalar float64, output).
type ScalarArith[T any] func(series telem.Series, scalar T, output *telem.Series)

// ScalarComp is the signature for scalar comparison operations (series op scalar ->
// uint8). Note: Actual generated functions are type-specific, e.g.,
// GreaterThanScalarF64(series, scalar float64, output).
