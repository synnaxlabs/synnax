...
// TranslateConcurrencyForward converts control.Concurrency to Concurrency.
func TranslateConcurrencyForward(v control.Concurrency) Concurrency {
	switch v {
...
// TranslateConcurrencyBackward converts Concurrency to control.Concurrency.
func TranslateConcurrencyBackward(v Concurrency) control.Concurrency {
	switch v {
