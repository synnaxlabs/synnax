...
import control "github.com/synnaxlabs/x/control/types/v0"
...
const (
	ConcurrencyExclusive Concurrency = control.ConcurrencyExclusive
	ConcurrencyShared    Concurrency = control.ConcurrencyShared
)
