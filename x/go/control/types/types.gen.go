...
type State[R any] = latest.State[R]
...
type Transfer[R comparable] = latest.Transfer[R]

// Update represents a batch of control transfers that occurred atomically.
type Update[R comparable] = latest.Update[R]

const (
	ConcurrencyExclusive = latest.ConcurrencyExclusive
	ConcurrencyShared    = latest.ConcurrencyShared
)
