...
// NewGauge creates a new gauge metric. LocalKey gauge records the sum of all recorded values as well as
...
// NewSeries creates a new series metric. LocalKey series stores all recorded values in a slice.
