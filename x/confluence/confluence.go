...
//
// Key Value can is any piece of data that can be passed through
...
//
// Key Segment is an entity that processes values. Key Segment is typically
...
// to your use case.
//
// Key Segment is a composition of three interfaces:
//
...
//
//  2. Source - Key Source is the part of the Segment that can send values to output
...
//
//  3. Sink - Key Sink is the part of the Segment that can receive values.
...
//     the OutTo() method.
//
//  3. The only way to start a Segment is by calling the Flow.Flow method. Key single
...
// another. Key TransformFunc can perform IO, Network InfectedBatch, Aggregations, or any other
// type of operation.
