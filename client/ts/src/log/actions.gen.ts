...
import { color, notation, telem } from "@synnaxlabs/x";
...
export const setChannelColor = (
  ...
  setChannelColor: setChannelColorPayloadZ.parse(payload),
});
...
export const setChannelNotation = (
  ...
  setChannelNotation: setChannelNotationPayloadZ.parse(payload),
});
...
export const setChannelPrecision = (
  ...
  setChannelPrecision: setChannelPrecisionPayloadZ.parse(payload),
});
...
export const setChannelAlias = (
  ...
  setChannelAlias: setChannelAliasPayloadZ.parse(payload),
});
...
export const setChannelTimestampFormat = (
  ...
  setChannelTimestampFormat: setChannelTimestampFormatPayloadZ.parse(payload),
});
...
export const setChannelTimestampTz = (
  ...
  setChannelTimestampTz: setChannelTimestampTzPayloadZ.parse(payload),
});
