...
export const TEXT_LEVELS = ["h1", "h2", "h3", "h4", "h5", "p", "small"] as const;
export const textLevelZ = z.enum(TEXT_LEVELS);
export type TextLevel = z.infer<typeof textLevelZ>;
