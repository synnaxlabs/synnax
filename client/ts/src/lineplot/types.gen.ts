...
import { color, spatial, telem, text, uuid, zod } from "@synnaxlabs/x";
import { z } from "zod";
...
export const dynamicCustomRangeZ = z.object({
  variant: z.literal("dynamic"),
  /** span is the span of the window, which ends now. */
  span: telem.numericTimeSpanZ.default(0),
});
export interface DynamicCustomRange extends z.infer<typeof dynamicCustomRangeZ> {}
