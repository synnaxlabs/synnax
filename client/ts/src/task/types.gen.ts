...
export type New<Type extends z.ZodType = z.ZodString, Config extends z.ZodType = z.ZodType, StatusData extends z.ZodType = z.ZodType> = optional.Optional<Omit<Payload<Type, Config, StatusData>, "internal" | "snapshot" | "status">, "key"> & {
