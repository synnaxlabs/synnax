...
import { optional, status, zod } from "@synnaxlabs/x";
import { z } from "zod";

import { ontology } from "@/ontology";

export const keyZ = z.string().or(z.number().transform(String));
...
export interface Payload<Type extends z.ZodType = z.ZodString, Config extends z.ZodType = z.ZodType, StatusData extends z.ZodType = z.ZodType> {
  key: Key;
  name: string;
  type: z.infer<Type>;
...
export type New<Type extends z.ZodType = z.ZodString, Config extends z.ZodType = z.ZodType, StatusData extends z.ZodType = z.ZodType> = optional.Optional<Omit<Payload<Type, Config, StatusData>, "internal" | "snapshot" | "config" | "status">, "key"> & {
  config: z.infer<Config>;
