...
import { DataType, TimeSpan, array, control, zod } from "@synnaxlabs/x";
import { z } from "zod";
...
export const newZ = payloadZ
  ...
  .partial({ key: true, leaseholder: true, index: true, isIndex: true, internal: true, virtual: true, expression: true })
  .extend({
    operations: array.nullToUndefined(operationZ),
    concurrency: control.concurrencyZ.optional(),
  });
