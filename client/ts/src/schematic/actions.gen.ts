 ...
 * the new edge's color is inherited from the source node's config
 * (if any) when the payload does not specify a color.
 */
...
export interface Handlers {
  ...
  addEdge: (state: Schematic, payload: AddEdgePayload) => void;
