...
import { caseconv, crdt, record, spatial, zod } from "@synnaxlabs/x";
...
export const create = (payload: z.input<typeof createPayloadZ>): Action => ({
  ...
  create: zod.parse(createPayloadZ, payload, {
    label: "Arc create action payload",
  }),
});
...
export const rename = (payload: z.input<typeof renamePayloadZ>): Action => ({
  ...
  rename: zod.parse(renamePayloadZ, payload, {
    label: "Arc rename action payload",
  }),
});
...
export const setNode = (payload: z.input<typeof setNodePayloadZ>): Action => ({
  ...
  setNode: zod.parse(setNodePayloadZ, payload, {
    label: "Arc set_node action payload",
  }),
});
...
export const setNodePosition = (
  ...
  setNodePosition: zod.parse(setNodePositionPayloadZ, payload, {
    label: "Arc set_node_position action payload",
  }),
});
...
export const setNodeInputs = (
  ...
  setNodeInputs: zod.parse(setNodeInputsPayloadZ, payload, {
    label: "Arc set_node_inputs action payload",
  }),
});
...
export const removeNode = (payload: z.input<typeof removeNodePayloadZ>): Action => ({
  ...
  removeNode: zod.parse(removeNodePayloadZ, payload, {
    label: "Arc remove_node action payload",
  }),
});
...
export const addEdge = (payload: z.input<typeof addEdgePayloadZ>): Action => ({
  ...
  addEdge: zod.parse(addEdgePayloadZ, payload, {
    label: "Arc add_edge action payload",
  }),
});
...
export const removeEdge = (payload: z.input<typeof removeEdgePayloadZ>): Action => ({
  ...
  removeEdge: zod.parse(removeEdgePayloadZ, payload, {
    label: "Arc remove_edge action payload",
  }),
});
...
export const reconnectEdge = (
  ...
  type: "reconnect_edge",
  reconnectEdge: zod.parse(reconnectEdgePayloadZ, payload, {
    label: "Arc reconnect_edge action payload",
  }),
});

export const insertChar = (payload: z.input<typeof insertCharPayloadZ>): Action => ({
  type: "insert_char",
  insertChar: zod.parse(insertCharPayloadZ, payload, {
    label: "Arc insert_char action payload",
  }),
});

export const deleteChar = (payload: z.input<typeof deleteCharPayloadZ>): Action => ({
  type: "delete_char",
  deleteChar: zod.parse(deleteCharPayloadZ, payload, {
    label: "Arc delete_char action payload",
  }),
});

export const forgetChars = (payload: z.input<typeof forgetCharsPayloadZ>): Action => ({
  type: "forget_chars",
  forgetChars: zod.parse(forgetCharsPayloadZ, payload, {
    label: "Arc forget_chars action payload",
  }),
});
