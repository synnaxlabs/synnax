...
const retrieveResZ = z.object({ logs: nullableArrayZ(logZ) });
...
export class Client {
  ...
  async retrieve(args: SingleRetrieveArgs): Promise<Log>;
  async retrieve(args: MultiRetrieveArgs): Promise<Log[]>;
  async retrieve(
