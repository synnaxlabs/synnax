...
type TestingUser = user.NewUser & { key?: string };
...
const userTwo: TestingUser = { username: id.id(), password: "test" };

const userThree: TestingUser = {
  username: id.id(),
  password: "test",
  firstName: "John",
  lastName: "Adams",
