...
//
// @public (undocumented)
const actionZ: z.ZodUnion<
  [
    z.ZodLiteral<"all">,
    z.ZodLiteral<"create">,
    z.ZodLiteral<"delete">,
    z.ZodLiteral<"retrieve">,
    z.ZodLiteral<"rename">,
  ]
>;
...
//
// @public (undocumented)
const analyzeChannelParams: (channels: Params_2) => ParamAnalysisResult_2<
  KeyOrName,
  {
    number: "keys";
    string: "names";
...
//
// @public (undocumented)
const analyzeParams_2: (params: Params_5) => ParamAnalysisResult_3;
...
class Client_14 implements AsyncTermSearcher<string, TaskKey, Payload_5> {
  ...
  // (undocumented)
  create<
    C extends UnknownRecord_2 = UnknownRecord_2,
    D extends {} = UnknownRecord_2,
  ...
  // (undocumented)
  openStateObserver<D extends UnknownRecord_2 = UnknownRecord_2>(): Promise<
    StateObservable<D>
  >;
  // (undocumented)
  ...
  retrieve<
    ...
    D extends {} = UnknownRecord_2,
    T extends string = string,
  >(rack: number, options?: RetrieveOptions_3): Promise<Task<C, D, T>[]>;
  // (undocumented)
  retrieve<
    C extends UnknownRecord_2 = UnknownRecord_2,
    D extends {} = UnknownRecord_2,
    T extends string = string,
  >(keys: string[], options?: RetrieveOptions_3): Promise<Task<C, D, T>[]>;
  // (undocumented)
  retrieve<
    C extends UnknownRecord_2 = UnknownRecord_2,
    D extends {} = UnknownRecord_2,
    T extends string = string,
  >(key: string, options?: RetrieveOptions_3): Promise<Task<C, D, T>>;
  // (undocumented)
...
class Client_16 implements AsyncTermSearcher<string, DeviceKey, Device> {
  ...
  // (undocumented)
  retrieve<P extends UnknownRecord = UnknownRecord>(
    key: string,
    options?: RetrieveOptions_4,
  ): Promise<Device<P>>;
  // (undocumented)
...
class Client_5 implements AsyncTermSearcher<string, Key_2, Channel> {
  ...
  // (undocumented)
  newSearcherWithOptions(
    options: RetrieveOptions_2,
  ): AsyncTermSearcher<string, Key_2, Channel>;
  // (undocumented)
  page(
    offset: number,
    limit: number,
    options?: Omit<RetrieveOptions_2, "limit" | "offset">,
  ): Promise<Channel[]>;
  // (undocumented)
...
const commandZ: z.ZodObject<
  {
    task: z.ZodUnion<
      [
        z.ZodString,
        z.ZodEffects<z.ZodBigInt, string, bigint>,
        z.ZodEffects<z.ZodNumber, string, number>,
      ]
    >;
    type: z.ZodString;
    key: z.ZodString;
...
declare namespace connection {
  export { status_2 as status, Status, state, State, Checker };
}
    ...
    z.ZodObject<
      {
        type: z.ZodUnion<
          [
            ...
            z.ZodLiteral<"builtin">,
            z.ZodLiteral<"cluster">,
            z.ZodLiteral<"channel">,
            z.ZodLiteral<"node">,
            z.ZodLiteral<"group">,
            z.ZodLiteral<"range">,
            z.ZodLiteral<"range-alias">,
            z.ZodLiteral<"user">,
            z.ZodLiteral<"workspace">,
            z.ZodLiteral<"schematic">,
            z.ZodLiteral<"lineplot">,
            z.ZodLiteral<"rack">,
            z.ZodLiteral<"device">,
            z.ZodLiteral<"task">,
            z.ZodLiteral<"policy">,
...
// @public (undocumented)
type Decoder<K, V> = (
  variant: change_2.Variant,
  data: Series,
) => Array<change_2.Change<K, V>>;
...
//
// @public (undocumented)
type Device<P extends UnknownRecord = UnknownRecord> = Omit<
...
const frameZ: z.ZodObject<
  {
    keys: z.ZodUnion<
      [
        z.ZodEffects<z.ZodNull, number[], null>,
        z.ZodDefault<z.ZodOptional<z.ZodArray<z.ZodNumber, "many">>>,
      ]
    >;
    series: z.ZodUnion<
      [
              ...
              z.ZodObject<
                {
                          ...
                          z.ZodObject<
                            {
                              start: z.ZodUnion<
                                [
                                  ...
                                  >,
                                  z.ZodEffects<z.ZodString, TimeStamp, string>,
                                  z.ZodEffects<
                                    z.ZodType<Number, z.ZodTypeDef, Number>,
                                    TimeStamp,
                                    Number
                                  >,
                                  z.ZodEffects<z.ZodNumber, TimeStamp, number>,
                                  z.ZodType<TimeStamp, z.ZodTypeDef, TimeStamp>,
                                ]
                              >;
                              end: z.ZodUnion<
                                [
                  ...
                  alignment: z.ZodOptional<
                    z.ZodUnion<[z.ZodBigInt, z.ZodEffects<z.ZodString, bigint, string>]>
                  >;
                  dataType: z.ZodUnion<
                    [
                      z.ZodEffects<z.ZodString, DataType, string>,
                      z.ZodType<DataType, z.ZodTypeDef, DataType>,
                    ]
                  >;
                  data: z.ZodEffects<
                    z.ZodString,
...
class ID {
  ...
  type: ResourceType;
  // (undocumented)
  static readonly z: z.ZodUnion<
    [
      z.ZodType<ID, z.ZodTypeDef, ID>,
      z.ZodEffects<
        z.ZodUnion<
          [
            z.ZodEffects<
...
//
// @public (undocumented)
type NewDevice<P extends UnknownRecord = UnknownRecord> = Omit<
...
//
// @public (undocumented)
const newLabelPayloadZ: z.ZodObject<
  z.objectUtil.extendShape<
    {
      key: z.ZodString;
      name: z.ZodString;
  ...
  z.objectUtil.extendShape<
    {
      ...
      rate: z.ZodUnion<
        [
          z.ZodEffects<z.ZodNumber, Rate, number>,
          z.ZodEffects<z.ZodType<Number, z.ZodTypeDef, Number>, Rate, Number>,
          z.ZodType<Rate, z.ZodTypeDef, Rate>,
        ]
      >;
      dataType: z.ZodUnion<
        [
...
//
// @public (undocumented)
const newPayloadZ: z.ZodObject<
  z.objectUtil.extendShape<
    {
      key: z.ZodString;
      name: z.ZodString;
      timeRange: z.ZodUnion<
        [
          z.ZodEffects<
            z.ZodObject<
              {
    ...
    actions: z.ZodUnion<
      [
        ...
        z.ZodEffects<
          ...
          >,
          ("delete" | "all" | "create" | "retrieve" | "rename")[],
          "delete" | "all" | "create" | "retrieve" | "rename"
        >,
      ]
    >;
...
//
// @public (undocumented)
type NewTask<C extends UnknownRecord = UnknownRecord, T extends string = string> = Omit<
  z.input<typeof newTaskZ>,
  "config" | "state"
> & {
  type: T;
  config: C;
...
//
// @public (undocumented)
interface Observable<K, V>
  extends observe_2.ObservableAsyncCloseable<Array<change_2.Change<K, V>>> {}
...
//
// @public (undocumented)
class ObservableStreamer<V = Frame>
...
class Range_2 {
  ...
  constructor(
    name: string,
    timeRange: TimeRange_2 | undefined,
    key: string,
    color: string | undefined,
...
//
// @public (undocumented)
type Resource<T extends UnknownRecord = UnknownRecord> = Omit<
...
//
// @public (undocumented)
const resourceSchemaZ: z.ZodEffects<
  z.ZodObject<
    {
      id: z.ZodUnion<
        [
...
//
// @public (undocumented)
const resourceTypeZ: z.ZodUnion<
  [
    z.ZodLiteral<"label">,
    z.ZodLiteral<"builtin">,
    z.ZodLiteral<"cluster">,
...
class Retriever_3 {
  ...
  page(offset: number, limit: number): Promise<Label[]>;
  // (undocumented)
  retrieve(params: Params_4): Promise<Label[]>;
  // (undocumented)
...
declare namespace signals {
  export { Decoder, Observable, openObservable };
}
...
//
// @public (undocumented)
type StateObservable<D extends UnknownRecord = UnknownRecord> =
  observe.ObservableAsyncCloseable<State_2<D>>;
...
class StateTracker
  ...
  implements observe_2.ObservableAsyncCloseable<Transfer[]>
{
...
const stateZ_2: z.ZodObject<
  {
    ...
    authority: z.ZodUnion<
      [
        z.ZodType<control_2.Authority, z.ZodTypeDef, control_2.Authority>,
        z.ZodEffects<z.ZodNumber, control_2.Authority, number>,
        z.ZodEffects<
          z.ZodType<Number, z.ZodTypeDef, Number>,
          control_2.Authority,
          Number
...
export const synnaxPropsZ: z.ZodObject<
  {
    ...
    connectivityPollFrequency: z.ZodDefault<
      z.ZodUnion<
        [
          z.ZodEffects<
            z.ZodObject<
          ...
          >,
          z.ZodEffects<z.ZodString, TimeSpan, string>,
          z.ZodEffects<z.ZodType<Number, z.ZodTypeDef, Number>, TimeSpan, Number>,
          z.ZodEffects<z.ZodNumber, TimeSpan, number>,
          z.ZodType<TimeSpan, z.ZodTypeDef, TimeSpan>,
        ]
      >
    >;
...
> {
  constructor(
    ...
    ontologyClient?: ontology.Client | null,
    rangeClient?: ranger.Client | null,
  );
  // (undocumented)
  readonly config: C;
  // (undocumented)
  ...
  // (undocumented)
  executeCommandSync<D extends UnknownRecord_2 = UnknownRecord_2>(
    type: string,
    args: UnknownRecord_2,
...
//
// @public (undocumented)
const workspaceRemoteZ: z.ZodObject<
  z.objectUtil.extendShape<
    Omit<
      {
        name: z.ZodString;
        ...
        layout: z.ZodUnion<
          [
            z.ZodRecord<
              z.ZodUnion<[z.ZodNumber, z.ZodString, z.ZodSymbol]>,
              z.ZodUnknown
            >,
            z.ZodEffects<z.ZodString, UnknownRecord_2, string>,
          ]
        >;
      },
      "layout"
...
const workspaceZ: z.ZodObject<
  {
    ...
    layout: z.ZodUnion<
      [
        z.ZodRecord<z.ZodUnion<[z.ZodNumber, z.ZodString, z.ZodSymbol]>, z.ZodUnknown>,
        z.ZodEffects<z.ZodString, UnknownRecord_2, string>,
      ]
    >;
  },
...
class Writer {
  ...
  // (undocumented)
  write(
    channelsOrData: Params_2 | Record<KeyOrName, CrudeSeries> | CrudeFrame,
