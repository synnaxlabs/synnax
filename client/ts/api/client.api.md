...
class Client_2 implements AsyncTermSearcher<string, string, Resource> {
    ...
    // (undocumented)
    openDependentTracker(parent: ID, initial: Resource[], type?: string): Promise<observe.ObservableAsyncCloseable<Resource[]>>;
...
class DependentTracker extends observe.Observer<Resource[]> implements observe.ObservableAsyncCloseable<Resource[]> {
    ...
    close(): Promise<void>;
    // (undocumented)
    static open(from: ID, client: Client_2, framer: framer.Client, initial: Resource[], type?: string): Promise<DependentTracker>;
}
...
class Range_2 {
    ...
    // (undocumented)
    openSubRangeTracker(): Promise<observe.ObservableAsyncCloseable<Range_2[]>>;
    // (undocumented)
