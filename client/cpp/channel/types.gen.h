...
struct Operation {
    ...
    /// If 0, duration-based reset is used.
    Key reset_channel = 0;
...
struct Channel {
    ...
    /// each value with a timestamp. If zero, the channel's data will be indexed using
    /// its rate.
    Key index = 0;
    ...
    /// but can still be used for streaming purposes.
    ...
    /// channel is automatically configured as virtual.
    ...
    /// Only virtual channels can have a policy of shared concurrency.
