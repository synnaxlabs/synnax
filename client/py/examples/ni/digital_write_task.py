...
with tsk.start():
    with client.control.acquire(
        ...
        ctrl.sleep(100 * sy.TimeSpan.MILLISECOND)
        ctrl["6289_do_1_cmd"] = 1
        ctrl.wait_until(lambda c: c["6289_do_1_state"] == 1)
        ctrl.sleep(100 * sy.TimeSpan.MILLISECOND)
        ctrl["6289_do_1_cmd"] = 0
        ctrl.wait_until(lambda c: c["6289_do_1_state"] == 0)
