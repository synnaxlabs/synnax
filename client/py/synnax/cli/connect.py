...
def prompt_client_options(ctx: Context) -> SynnaxOptions:
    ...
    params = dict()
    params["host"] = ctx.console.prompt("Host", default="localhost")
    params["port"] = ctx.console.ask_intint("Port", default=9090)
    params["username"] = ctx.console.prompt("Username", default="synnax")
