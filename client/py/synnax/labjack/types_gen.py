...
# Is a single LabJack output channel. The type field selects the output mode.
...
# Is a single LabJack input channel. The type field selects the input mode and the
