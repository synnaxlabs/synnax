...
# Is a single Modbus input channel. The type field selects the register space the
...
# Is a single Modbus output channel. The type field selects the register space the
