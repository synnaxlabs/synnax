...
# Transitional: the config cutover deletes this module; OPC UA task models fold
# into the opc package and its generated types.
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            configured: Whether the device has been configured (default: True for OPC UA)
        """
