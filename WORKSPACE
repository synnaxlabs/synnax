...
http_archive(
    ...
    strip_prefix = "rules_proto_grpc_cpp-4.6.0",
    urls = ["https://github.com/rules-proto-grpc/rules_proto_grpc_cpp/releases/download/4.6.0/rules_proto_grpc_cpp-4.6.0.tar.gz"],
)

load("@rules_proto_grpc_cpp//:repositories.bzl", "rules_proto_grpc_cpp_repos", "rules_proto_grpc_cpp_toolchains")

rules_proto_grpc_cpp_toolchains()
...
load("@rules_proto_grpc_cpp//cpp:repositories.bzl", "cpp_repos")
