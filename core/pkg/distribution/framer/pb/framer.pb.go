...
type DeleteRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Keys          []uint32               `protobuf:"varint,1,rep,packed,name=keys,proto3" json:"keys,omitempty"`
	Bounds        *pb.TimeRange          `protobuf:"bytes,2,opt,name=bounds,proto3" json:"bounds,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_core_pkg_distribution_framer_pb_framer_proto_rawDesc = "" +
	...
	"\x05frame\x18\x03 \x01(\v2\x11.x.telem.pb.FrameR\x05frame\"\xcb\x02\n" +
	...
	"\x0fcontrol_subject\x18\x04 \x01(\v2\x15.x.control.pb.SubjectR\x0econtrolSubject\x12.\n" +
	...
	"\x06bounds\x18\x02 \x01(\v2\x15.x.telem.pb.TimeRangeR\x06bounds2}\n" +
