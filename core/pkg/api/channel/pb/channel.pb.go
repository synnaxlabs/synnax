...
const file_core_pkg_api_channel_pb_channel_proto_rawDesc = "" +
	"\n" +
	"%core/pkg/api/channel/pb/channel.proto\x12\x0eapi.channel.pb\x1a.core/pkg/distribution/channel/pb/channel.proto\x1a\x1dx/go/control/pb/control.proto\"\x8c\x03\n" +
	"\aChannel\x12\x10\n" +
