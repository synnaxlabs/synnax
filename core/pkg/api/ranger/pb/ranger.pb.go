...
const file_core_pkg_api_ranger_pb_ranger_proto_rawDesc = "" +
	"\n" +
	"#core/pkg/api/ranger/pb/ranger.proto\x12\rapi.ranger.pb\x1a\x19x/go/telem/pb/telem.proto\x1a\x19x/go/color/pb/color.proto\x1a\x19x/go/label/pb/label.proto\"\xf5\x01\n" +
	"\x05Range\x12\x10\n" +
