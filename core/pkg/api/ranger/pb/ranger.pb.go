...
func (x *Range) Reset() {
	*x = Range{}
	mi := &file_core_pkg_api_ranger_pb_ranger_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Range) Descriptor() ([]byte, []int) {
	return file_core_pkg_api_ranger_pb_ranger_proto_rawDescGZIP(), []int{1}
}
...
const file_core_pkg_api_ranger_pb_ranger_proto_rawDesc = "" +
	"\n" +
	"#core/pkg/api/ranger/pb/ranger.proto\x12\rapi.ranger.pb\x1a\x19x/go/color/pb/color.proto\x1a\x19x/go/label/pb/label.proto\x1a\x19x/go/telem/pb/telem.proto\"6\n" +
	"\tLabelList\x12)\n" +
	"\x06values\x18\x01 \x03(\v2\x11.x.label.pb.LabelR\x06values\"\x8b\x02\n" +
	"\x05Range\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x124\n" +
	"\n" +
	"time_range\x18\x03 \x01(\v2\x15.x.telem.pb.TimeRangeR\ttimeRange\x12,\n" +
	"\x05color\x18\x04 \x01(\v2\x11.x.color.pb.ColorH\x00R\x05color\x88\x01\x01\x120\n" +
	"\x06labels\x18\x05 \x01(\v2\x18.api.ranger.pb.LabelListR\x06labels\x121\n" +
	"\x06parent\x18\x06 \x01(\v2\x14.api.ranger.pb.RangeH\x01R\x06parent\x88\x01\x01B\b\n" +
	"\x06_colorB\t\n" +
	"\a_parentB\xa6\x01\n" +
...
var file_core_pkg_api_ranger_pb_ranger_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_core_pkg_api_ranger_pb_ranger_proto_goTypes = []any{
	(*LabelList)(nil),     // 0: api.ranger.pb.LabelList
	(*Range)(nil),         // 1: api.ranger.pb.Range
...
var file_core_pkg_api_ranger_pb_ranger_proto_depIdxs = []int32{
	2, // 0: api.ranger.pb.LabelList.values:type_name -> x.label.pb.Label
	3, // 1: api.ranger.pb.Range.time_range:type_name -> x.telem.pb.TimeRange
	4, // 2: api.ranger.pb.Range.color:type_name -> x.color.pb.Color
	0, // 3: api.ranger.pb.Range.labels:type_name -> api.ranger.pb.LabelList
	1, // 4: api.ranger.pb.Range.parent:type_name -> api.ranger.pb.Range
...
func file_core_pkg_api_ranger_pb_ranger_proto_init() {
	...
	file_core_pkg_api_ranger_pb_ranger_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
