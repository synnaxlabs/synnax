...
const (
	ConnectivityService_Exec_FullMethodName = "/grpc.connectivity.ConnectivityService/Exec"
)
...
type ConnectivityServiceClient interface {
	Exec(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CheckResponse, error)
}
...
func (c *connectivityServiceClient) Exec(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CheckResponse, error) {
...
type ConnectivityServiceServer interface {
	Exec(context.Context, *emptypb.Empty) (*CheckResponse, error)
}
...
func (UnimplementedConnectivityServiceServer) Exec(context.Context, *emptypb.Empty) (*CheckResponse, error) {
...
var ConnectivityService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpc.connectivity.ConnectivityService",
	...
	Metadata: "core/pkg/api/grpc/connectivity/connectivity.proto",
}
