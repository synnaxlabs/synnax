...
const (
	RangeRenameService_Exec_FullMethodName = "/api.v1.RangeRenameService/Exec"
)
...
type RangeRenameServiceClient interface {
	Exec(ctx context.Context, in *RangeRenameRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *rangeRenameServiceClient) Exec(ctx context.Context, in *RangeRenameRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
type RangeRenameServiceServer interface {
	Exec(context.Context, *RangeRenameRequest) (*emptypb.Empty, error)
}
...
func (UnimplementedRangeRenameServiceServer) Exec(context.Context, *RangeRenameRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method Exec not implemented")
}
...
func _RangeRenameService_Exec_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RangeRenameServiceServer).Exec(ctx, req.(*RangeRenameRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RangeRenameService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.v1.RangeRenameService",
...
const (
	RangeAliasRetrieveService_Exec_FullMethodName = "/api.v1.RangeAliasRetrieveService/Exec"
)

// RangeAliasRetrieveServiceClient is the client API for RangeAliasRetrieveService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type RangeAliasRetrieveServiceClient interface {
	Exec(ctx context.Context, in *RangeAliasRetrieveRequest, opts ...grpc.CallOption) (*RangeAliasRetrieveResponse, error)
}

type rangeAliasRetrieveServiceClient struct {
	cc grpc.ClientConnInterface
}

func NewRangeAliasRetrieveServiceClient(cc grpc.ClientConnInterface) RangeAliasRetrieveServiceClient {
	return &rangeAliasRetrieveServiceClient{cc}
}

func (c *rangeAliasRetrieveServiceClient) Exec(ctx context.Context, in *RangeAliasRetrieveRequest, opts ...grpc.CallOption) (*RangeAliasRetrieveResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RangeAliasRetrieveResponse)
	err := c.cc.Invoke(ctx, RangeAliasRetrieveService_Exec_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// RangeAliasRetrieveServiceServer is the server API for RangeAliasRetrieveService service.
// All implementations should embed UnimplementedRangeAliasRetrieveServiceServer
// for forward compatibility.
type RangeAliasRetrieveServiceServer interface {
	Exec(context.Context, *RangeAliasRetrieveRequest) (*RangeAliasRetrieveResponse, error)
}

// UnimplementedRangeAliasRetrieveServiceServer should be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
type UnimplementedRangeAliasRetrieveServiceServer struct{}

func (UnimplementedRangeAliasRetrieveServiceServer) Exec(context.Context, *RangeAliasRetrieveRequest) (*RangeAliasRetrieveResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Exec not implemented")
}
func (UnimplementedRangeAliasRetrieveServiceServer) testEmbeddedByValue() {}

// UnsafeRangeAliasRetrieveServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to RangeAliasRetrieveServiceServer will
// result in compilation errors.
type UnsafeRangeAliasRetrieveServiceServer interface {
	mustEmbedUnimplementedRangeAliasRetrieveServiceServer()
}

func RegisterRangeAliasRetrieveServiceServer(s grpc.ServiceRegistrar, srv RangeAliasRetrieveServiceServer) {
	// If the following call panics, it indicates UnimplementedRangeAliasRetrieveServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
	...
	s.RegisterService(&RangeAliasRetrieveService_ServiceDesc, srv)
}

func _RangeAliasRetrieveService_Exec_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RangeAliasRetrieveRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RangeAliasRetrieveServiceServer).Exec(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RangeAliasRetrieveService_Exec_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RangeAliasRetrieveServiceServer).Exec(ctx, req.(*RangeAliasRetrieveRequest))
	}
	return interceptor(ctx, in, info, handler)
}

// RangeAliasRetrieveService_ServiceDesc is the grpc.ServiceDesc for RangeAliasRetrieveService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var RangeAliasRetrieveService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.v1.RangeAliasRetrieveService",
	HandlerType: (*RangeAliasRetrieveServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Exec",
			Handler:    _RangeAliasRetrieveService_Exec_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "core/pkg/api/grpc/v1/ranger.proto",
