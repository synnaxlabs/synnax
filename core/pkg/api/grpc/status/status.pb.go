...
const file_core_pkg_api_grpc_status_status_proto_rawDesc = "" +
	...
	"\x04Exec\x12\".grpc.status.SetByKeyOrNameRequest\x1a#.grpc.status.SetByKeyOrNameResponse\"\x00B\x9d\x01\n" +
...
var file_core_pkg_api_grpc_status_status_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
