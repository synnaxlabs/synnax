...
type Service struct{ cluster core.Cluster }
...
// ClusterInfo is general information about the cluster and Core that the request was
// sent to.
type ClusterInfo struct {
	...
	// CoreKey is the key of the Core that the request was sent to.
...
func (s *Service) Check(context.Context, types.Nil) (CheckResponse, error) {
