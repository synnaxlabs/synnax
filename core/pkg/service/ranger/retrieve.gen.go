...
type Filter func(r Retrieve) gorp.Filter[Key, Range]
...
func Match(
	f func(ctx gorp.Context, r Retrieve, e *Range) (bool, error),
) Filter {
	return func(r Retrieve) gorp.Filter[Key, Range] {
		return gorp.Match(func(ctx gorp.Context, e *Range) (bool, error) {
			return f(ctx, r, e)
		})
	}
}
...
func And(fs ...Filter) Filter {
	return func(r Retrieve) gorp.Filter[Key, Range] {
		inner := make([]gorp.Filter[Key, Range], len(fs))
		for i, f := range fs {
			inner[i] = f(r)
		}
