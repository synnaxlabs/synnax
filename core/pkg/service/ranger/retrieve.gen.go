...
type Filter = gorp.BoundFilter[Retrieve, Key, Range]
...
func Match(f func(ctx gorp.Context, r Retrieve, e *Range) (bool, error)) Filter {
	return gorp.MatchBound[Retrieve, Key, Range](f)
}

// And returns a filter that matches when all provided filters match.
func And(fs ...Filter) Filter {
	return gorp.AndBound[Retrieve, Key, Range](fs...)
}

// Or returns a filter that matches when any provided filter matches.
func Or(fs ...Filter) Filter {
	return gorp.OrBound[Retrieve, Key, Range](fs...)
}

// Not returns a filter that inverts the provided filter.
func Not(f Filter) Filter {
	return gorp.NotBound[Retrieve, Key, Range](f)
}
...
// ranges whose key matches any of the provided
...
// ranges whose Name matches any of the
// provided values.
func MatchNames(vals ...string) Filter {
	return func(r Retrieve) gorp.Filter[Key, Range] {
		return gorp.Match(func(_ gorp.Context, e *Range) (bool, error) {
...
// Entry binds the provided range as the result container for the
// query. If multiple ranges match, the first one is
// used.
...
// Entries binds the provided slice of ranges as the
...
// Offset sets the starting index of the ranges to
// return.
