...
// ServiceConfig is the configuration for opening the rack task config service.
...
// OpenService opens the rack task config service with the provided configuration.
...
func (s *Service) Stores() []common.ConfigStore {
	return []common.ConfigStore{s.Status}
}
