...
func AutoMigrateRack(ctx context.Context, old rackv1.Rack) (Rack, error) {
	var status *Status
	if old.Status != nil {
...
func AutoMigrateStatus(ctx context.Context, old rackv1.Status) (Status, error) {
...
func AutoMigrateStatusDetails(_ context.Context, old rackv1.StatusDetails) (StatusDetails, error) {
