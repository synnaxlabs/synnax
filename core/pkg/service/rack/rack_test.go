	...
	Describe("Status", func() {
		...
		It(
			...
			func(ctx SpecContext) {
				...
				Expect(stat.NewWriter[rack.StatusDetails](tx).
		...
		It(
			...
			func(ctx SpecContext) {
				...
				Expect(
					stat.NewWriter[rack.StatusDetails](nil).Set(ctx, &rack.Status{
