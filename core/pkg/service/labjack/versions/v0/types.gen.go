...
type ReadConfig struct {
	...
	// reports a skew warning. Defaults to two seconds of scans.
	DeviceScanBacklogWarnOnCount *uint32 `json:"device_scan_backlog_warn_on_count,omitempty" msgpack:"device_scan_backlog_warn_on_count,omitempty"`
	// LjmScanBacklogWarnOnCount is the LJM-side scan backlog above which the task
	// reports a skew warning. Defaults to one second of scans.
