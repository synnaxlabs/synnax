...
func (u ReadChannel) MarshalJSONTo(enc *jsontext.Encoder) error {
	...
	case AutomaticReadChannel:
		...
		}{Type: AutomaticReadChannelType, AutomaticReadChannel: v})
	case ManualReadChannel:
		return json.MarshalEncode(enc, struct {
			Type ReadChannelType `json:"type"`
			ManualReadChannel
		}{Type: ManualReadChannelType, ManualReadChannel: v})
	default:
...
func (u WriteChannel) MarshalJSONTo(enc *jsontext.Encoder) error {
	...
	case AutomaticWriteChannel:
		...
		}{Type: AutomaticWriteChannelType, AutomaticWriteChannel: v})
	case ManualWriteChannel:
		return json.MarshalEncode(enc, struct {
			Type WriteChannelType `json:"type"`
			ManualWriteChannel
		}{Type: ManualWriteChannelType, ManualWriteChannel: v})
	default:
