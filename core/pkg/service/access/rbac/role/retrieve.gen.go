...
// WhereNames returns a filter for roles whose Name matches any of the provided values.
func WhereNames(vals ...string) gorp.Filter[Key, Role] {
	return gorp.Match(func(_ gorp.Context, e *Role) (bool, error) {
		return lo.Contains(vals, e.Name), nil
	})
}

// WhereInternal returns a filter for roles by their Internal field.
func WhereInternal(v bool) gorp.Filter[Key, Role] {
	return gorp.Match(func(_ gorp.Context, e *Role) (bool, error) {
