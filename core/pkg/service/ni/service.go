...
type Service struct {
	...
	AnalogRead *common.ConfigService[AnalogReadConfig, *AnalogReadConfig]
	// AnalogWrite stores ni_analog_write task configuration records.
	AnalogWrite *common.ConfigService[AnalogWriteConfig, *AnalogWriteConfig]
	// CounterRead stores ni_counter_read task configuration records.
	CounterRead *common.ConfigService[CounterReadConfig, *CounterReadConfig]
	// DigitalRead stores ni_digital_read task configuration records.
	DigitalRead *common.ConfigService[DigitalReadConfig, *DigitalReadConfig]
