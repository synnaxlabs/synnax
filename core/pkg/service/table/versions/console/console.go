...
// Package console is the single entry point for migrating an opaque table data blob
...
// currently has a single Console snapshot, but the package shape matches line plot and
// schematic so adding a future v1 is mechanical.
package console

import (
	"github.com/synnaxlabs/synnax/pkg/service/imex"
	v0 "github.com/synnaxlabs/synnax/pkg/service/table/versions/console/v0"
