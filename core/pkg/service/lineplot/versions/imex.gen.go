...
// Latest is the portable schema version stamped on exported LinePlot envelopes and
...
// LinePlot shape and lifts it through the per-version migration chain to the
