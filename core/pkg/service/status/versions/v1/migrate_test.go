...
var _ = Describe("v0 -> v1 Status migration", func() {
	It(
		"drops Labels from the wire and preserves core fields when v0 entries carry populated Labels",
