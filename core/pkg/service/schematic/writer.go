...
// Create creates the given log within the workspace provided. If ws is uuid.Nil,
// the schematic is created as a top-level resource with no workspace parent. If
// the log does not have a key, a new key will be generated.
