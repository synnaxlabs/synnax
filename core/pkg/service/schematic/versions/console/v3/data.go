...
// Package v3 holds the frozen wire format for Console schematic state at version 3. v3
// added segments[] to each edge.
package v3
...
// Edge is the wire shape of a schematic edge at version 3. Inherits the flat
