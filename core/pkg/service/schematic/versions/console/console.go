...
// Package console is the single entry point for migrating an opaque schematic data blob
// through the chain of historical wire formats up to the latest Console snapshot,
...
import (
	...
	v0 "github.com/synnaxlabs/synnax/pkg/service/schematic/versions/console/v0"
	v1 "github.com/synnaxlabs/synnax/pkg/service/schematic/versions/console/v1"
	v2 "github.com/synnaxlabs/synnax/pkg/service/schematic/versions/console/v2"
	v3 "github.com/synnaxlabs/synnax/pkg/service/schematic/versions/console/v3"
	v4 "github.com/synnaxlabs/synnax/pkg/service/schematic/versions/console/v4"
	v5 "github.com/synnaxlabs/synnax/pkg/service/schematic/versions/console/v5"
	"github.com/synnaxlabs/x/encoding/msgpack"
	"github.com/synnaxlabs/x/errors"
)

// Data is the latest Console snapshot; the migration chain terminates in it.
type Data = v5.Data
