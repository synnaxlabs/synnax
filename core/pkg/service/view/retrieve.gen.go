...
// views whose key matches any of the provided
...
// views whose Type matches any of the
// provided values.
...
// Entry binds the provided view as the result container for the
// query. If multiple views match, the first one is
// used.
...
// Entries binds the provided slice of views as the
...
// Offset sets the starting index of the views to
// return.
