...
// SetData replaces the body of the log with the given key with the provided
// value. Key and Name are preserved from the existing entry; every other field
// on data overwrites the stored entry verbatim.
