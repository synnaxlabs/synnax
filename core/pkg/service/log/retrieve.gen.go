...
// logs whose key matches any of the provided
...
// Entry binds the provided log as the result container for the
// query. If multiple logs match, the first one is
// used.
...
// Entries binds the provided slice of logs as the
...
// Offset sets the starting index of the logs to
// return.
