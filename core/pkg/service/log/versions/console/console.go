...
// Package console is the single entry point for migrating an opaque log data blob
...
import (
	...
	v0 "github.com/synnaxlabs/synnax/pkg/service/log/versions/console/v0"
	v1 "github.com/synnaxlabs/synnax/pkg/service/log/versions/console/v1"
