...
var _ = Describe("MigrateData", func() {
	...
	It(
		...
		func() {
			...
			result := MustSucceed(console.MigrateData(blob))
	...
	It("Should produce a zero v1.Data for a nil blob", func() {
		result := MustSucceed(console.MigrateData(nil))
