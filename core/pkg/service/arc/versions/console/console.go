...
// Package console is the single entry point for migrating an opaque Console Arc state
...
import (
	...
	v0 "github.com/synnaxlabs/synnax/pkg/service/arc/versions/console/v0"
	v1 "github.com/synnaxlabs/synnax/pkg/service/arc/versions/console/v1"
	v2 "github.com/synnaxlabs/synnax/pkg/service/arc/versions/console/v2"
...
// walks the per-step Migrate functions forward to v2.Data, and lifts the result
// into
...
// lift converts the latest Console snapshot into the typed graph, text, and mode
// parts of an Arc.
