...
type Arc struct {
	...
	Graph graphv54.Graph `json:"graph" msgpack:"graph"`
	// Text is the text-based Arc source code.
	Text textv54.Text `json:"text" msgpack:"text"`
	// Program is the compiled module output including IR and WebAssembly bytecode.
	Program *programv54.Program `json:"program,omitempty" msgpack:"program,omitempty"`
