...
type Status = statusv56.Status[StatusDetails]
...
type Arc struct {
	...
	Graph graphv56.Graph `json:"graph" msgpack:"graph"`
	// Text is the text-based Arc source code.
	Text textv56.Text `json:"text" msgpack:"text"`
	// Program is the compiled module output including IR and WebAssembly bytecode.
	Program *programv56.Program `json:"program,omitempty" msgpack:"program,omitempty"`
