...
var _ = Describe("Task", Ordered, func() {
	...
	newContext := func() godriver2.Context {
		return godriver2.NewContext(ctx, statusSvc)
	}
	...
	newTask := func(factory *runtime.Factory) godriver2.Task {
