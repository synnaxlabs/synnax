...
// ServiceConfig is the configuration for opening the PagerDuty task config service.
...
type Service struct {
	...
	Alert  *common.ConfigService[TaskConfig, *TaskConfig]
	closer xio.MultiCloser
}

// OpenService opens the PagerDuty task config service with the provided
...
func OpenService(ctx context.Context, cfgs ...ServiceConfig) (s *Service, err error) {
	...
	if s.Alert, err = common.OpenConfigService[TaskConfig, *TaskConfig](
		ctx,
		base,
...
func (s *Service) Stores() []common.ConfigStore {
	return []common.ConfigStore{s.Alert}
}
