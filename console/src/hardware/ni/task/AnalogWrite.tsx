...
// export const createAnalogWriteLayout = createLayoutCreator<AnalogWritePayload>(
//   ANALOG_WRITE_TYPE,
//   "New NI Analog Write Task",
// );
...
//   icon: <Icon.Logo.NI />,
//   create: (layoutKey) => ({
//     ...createAnalogWriteLayout({ create: true }),
//     key: layoutKey,
//   }),
// };

// const schema = z.object({ name: z.string(), config: analogWriteConfigZ });

// const Wrapped = ({
//   task,
//   initialValues,
//   layoutKey,
// }: WrappedTaskLayoutProps<AnalogWrite, AnalogWritePayload>): ReactElement => {
...
//   const taskState = useObserveState<AnalogWriteDetails>(
//     methods.setStatus,
...
//   const createTask = useCreate<AnalogWriteConfig, AnalogWriteDetails, AnalogWriteType>(
//     layoutKey,
//   );
...
//     onError: (e) => handleException(e, "Failed to configure NI Analog Write Task}"),
//     mutationFn: async () => {
...
// export const ConfigureAnalogWrite = wrapTaskLayout(Wrapped, ZERO_ANALOG_WRITE_PAYLOAD);
