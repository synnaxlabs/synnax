...
const diChannelZ = Task.readChannelZ.extend(digitalChannelExtensionShape).extend({
...
const doChannelZ = Task.writeChannelZ.extend(digitalChannelExtensionShape).extend({
