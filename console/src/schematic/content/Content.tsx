...
export const Content: Tabs.Content = Tab.createSuspended<ContentProps>(
  ({ visible = true }) => {
    ...
    const store = useStore<Panel.Session.StoreState & Drift.StoreState>();
    const enableTriggers = useCallback(
      () => Panel.Session.selectIsFocused(store.getState(), key),
      [store, key],
    );
