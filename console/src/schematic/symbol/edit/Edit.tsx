...
import { HandleList } from "@/schematic/symbol/edit/HandleList";
import { Preview } from "@/schematic/symbol/edit/Preview";
import { RegionList } from "@/schematic/symbol/edit/RegionList";
import { StateList } from "@/schematic/symbol/edit/StateList";
import { SelectVariantField } from "@/schematic/symbol/SelectVariant";
...
const EDIT_LAYOUT: Modals.BaseState<CreateLayoutArgs> = {
...
export const createEditLayout = (
  initial: Partial<Modals.BaseState<CreateLayoutArgs>> = {},
): Modals.BaseState<CreateLayoutArgs> => {
...
export const Edit: Modals.Renderer = ({ layoutKey, onClose }): ReactElement => {
  const { key, parent, createKey } = Modals.useArgs<CreateLayoutArgs>();
