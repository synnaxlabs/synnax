...
import { type Control, control, Diagram, Stage, Viewport } from "@synnaxlabs/pluto";
...
export const nodePropsZ = z
  .object({})
  .and(
    z.object({ key: Stage.variantZ, color: color.crudeZ.optional() }).passthrough(),
  );
...
export const sliceStateZ = z.object({
  ...
  stages: z.record(z.string(), stateZ),
});
