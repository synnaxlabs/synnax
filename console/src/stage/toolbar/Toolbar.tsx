...
import { useExport } from "@/stage/export";
import {
...
import { setActiveToolbarTab, setEditable, type ToolbarTab } from "@/stage/slice";
import { Control } from "@/stage/toolbar/Control";
import { PropertiesControls } from "@/stage/toolbar/Properties";
import { Symbols } from "@/stage/toolbar/Symbols";
        ...
        <Align.Space x align="center" empty>
          <Align.Space x empty style={{ height: "100%", width: 66 }}>
            ...
            <Cluster.CopyLinkToolbarButton
              name={name}
              ontologyID={stage.ontologyID(layoutKey)}
            />
          </Align.Space>
