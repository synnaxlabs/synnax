    ...
    const handleSubmit = (): void =>
      handleError(async () => {
        ...
        if (isEdit && existing != null && clusterKey != null) {
          ...
          dispatch(Session.Node.set({ ...data, key, username: "", password: "" }));
        }
        close();
