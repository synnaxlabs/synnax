...
export interface RenderTreeContextMenuOptions {
  ...
  store?: TestStore;
  baseOverrides?: Partial<Ontology.BaseProps>;
  stateOverrides?: Partial<Ontology.TreeState>;
}
...
export const renderTreeContextMenu = async (
  TreeContextMenu: Ontology.TreeContextMenu,
  {
    client,
    resources,
    selected,
...
export interface RenderToolbarOptions {
  client: Client;
  /** Real ontology services keyed by resource type; other types get NOOP services. */
  services?: Partial<Record<ontology.ResourceType, Ontology.Service>>;
}
...
export const renderToolbar = async (
  content: ReactNode,
  { client, services }: RenderToolbarOptions,
