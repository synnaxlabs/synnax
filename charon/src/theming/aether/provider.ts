...
import { theming } from "@/theming/base";
...
export class Provider extends aether.Composite<typeof providerStateZ> {
  ...
  afterUpdate(ctx: aether.Context): void {
    const v = ctx.getOptional<theming.Theme>(CONTEXT_KEY);
...
export const use = (ctx: aether.Context): theming.Theme => ctx.get<theming.Theme>(CONTEXT_KEY);
