...
class ChannelClient:
    ...
    def create(
        ...
        *,
        ...
        :param data_type: The data type of the samples in the channel.
        :param is_index: Boolean indicating whether the channel is an index.
    ...
    def create_calculated(self, *, name: ChannelName, expression: str) -> str | None:
        ...
        editor = self.layout.locator(".monaco-editor")
        editor.click()
        self.layout.wait_for_selector_visible(".monaco-editor.focused")
        sy.sleep(0.2)
    ...
    def edit_calculated(self, name: ChannelName, new_expression: str) -> None:
        ...
        """
        self._ctx_menu_action(name, "Edit calculation")

        editor = self.layout.wait_for_selector_visible(".monaco-editor")
        editor.click()
        self.layout.wait_for_selector_visible(".monaco-editor.focused")
        self.layout.sleep(50)
        self.layout.select_all_and_type(new_expression)

        self.layout.locator("button").filter(has_text="Save").first.click()
        self.layout.wait_for_hidden(editor)
    ...
    def set_alias(self, *, name: ChannelName, alias: str) -> None:
        ...
        """
        self._ctx_menu_action(name, "Set alias under", exact=False)
        self.layout.type_text(alias)
    ...
    def clear_alias(self, name: ChannelName) -> None:
        ...
        """
        self._ctx_menu_action(name, "Remove alias under", exact=False)
        self.hide_channels()
    ...
    def group(
        ...
        *,
        ...
        :param parent_group: Optional parent group to expand first.
        """
        if len(names) < 2:
    ...
    def copy_link(self, name: ChannelName) -> str:
        ...
        """
        self._ctx_menu_action(name, "Copy link")
        self.hide_channels()
    ...
    def _rename_single_channel(self, *, old_name: str, new_name: str) -> None:
        ...
        item = self._ctx_menu_action(old_name, "Rename")
    ...
    def close_modal(self) -> None:
        ...
        self.layout.close_modal(self.layout.MODAL_SELECTOR)
