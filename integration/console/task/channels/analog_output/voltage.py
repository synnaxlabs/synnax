...
class Voltage(Analog):
    """
    Voltage channel type for NI analog write/output tasks.

    Note: This is the output variant without terminal_config support.
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """Initialize voltage output channel with configuration."""
