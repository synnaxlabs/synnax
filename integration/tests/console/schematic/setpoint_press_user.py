...
class SetpointPressUser(ConsoleCase):
    ...
    def run(self) -> None:
        ...
        start_cmd = schematic.create.valve("test_flag_cmd")
        start_cmd.move(-90, -100)
        end_cmd = schematic.create.button("end_test_cmd", mode="Fire")
        end_cmd.move(90, -100)
        ...
        setpoint = schematic.create.setpoint("press_setpoint_cmd")
        setpoint.move(0, 120)
