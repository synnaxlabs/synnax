...
class ThermalSimDaq(TestCase):
    ...
    def run(self) -> None:
        ...
        with client.open_streamer(["end_thermal_test_cmd", "heater_cmd"]) as streamer:
            with client.open_writer(
                ...
                self.log("Thermal Sim DAQ running")
                end_test_flag = 0
        ...
        assert state["heater_state"] == 0, "Heater was left on"
