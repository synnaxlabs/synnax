...
sequence main {
    ...
    stage select_on {
        ...
        wait{50ms} => select_hold
    }
    stage select_off {
        "select_off" -> routing_stage_log,
        wait{50ms} => decide_stage_hold
    }
...
class StageRouting(ArcConsoleCase):
    ...
    def verify_sequence_execution(self) -> None:
        ...
        self.log("[select] Waiting for select_on -> select_hold")
        self.wait_for_eq("routing_stage_log", "select_hold", is_virtual=True)
        ...
        # Phase 2: decide_stage routing (select_off waits 50ms then -> decide_stage_hold)
        self.log("[decide_stage] Waiting for select_off -> decide_stage_hold")
        ...
        self.log("[decide_stage] Waiting for decide_stage_press -> decide_stage_hold")
        self.wait_for_eq("routing_stage_log", "decide_stage_hold", is_virtual=True)
        ...
        self.log("[decide_stage] Waiting for decide_stage_vent -> decide_stage_hold")
        self.wait_for_eq("routing_stage_log", "decide_stage_hold", is_virtual=True)
        ...
        self.log("[decide_stage] Waiting for decide_stage_abort -> done")
