...
scales horizontally, and can be deployed on edge devices (data acquisition) in
...
Synnax is currently in alpha and is under active development. The API
...
response, check out
the [Contributing Guide](https://docs.synnaxlabs.com/category/developers)
