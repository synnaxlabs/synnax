...
struct OutputChan {
    ...
    /// externally fetched.
    void bind_remote_info(const synnax::channel::Channel::Channel &state_ch) {
...
struct WriteTaskConfig : driver::task::common::BaseWriteTaskConfig {
    ...
    std::map<synnax::channel::Channel::Key, std::unique_ptr<OutputChan>> channels;
    ...
    explicit WriteTaskConfig(
        ...
        std::vector<synnax::channel::Channel::Key> state_channels;
    ...
    [[nodiscard]] std::vector<synnax::channel::Channel::Channel> state_channels() const {
    ...
    [[nodiscard]] std::vector<synnax::channel::Channel::Key> cmd_channels() const {
