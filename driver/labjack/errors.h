...
std::unordered_map<std::string, std::string> ERROR_DESCRIPTIONS = {
    {"LJ_SUCCESS", ""},
    {"LJME_WARNINGS_BEGIN", "This indicates where the warning codes start is not a real warning code."},
    {"LJME_WARNINGS_END", "This indicates where the warning codes end is not a real warning code."},
    {
    ...
    {"LJME_MODBUS_ERRORS_END", "This indicates where the Modbus error codes end is not a real Modbus error code."},
    ...
    {"LJME_MBE5_ACKNOWLEDGE", "The device acknowledges the request, but will take some time to process."},
    ...
    {"LJME_LIBRARY_ERRORS_BEGIN", "This indicates where the LJM error codes start is not a real LJM error code."},
    {"LJME_LIBRARY_ERRORS_END", "This indicates where the LJM error codes end is not a real LJM error code."},
    {
        "LJME_UNKNOWN_ERROR",
        "LJM reached an unexpected state. Please contact LabJack support if you've received this error."
    },
    {"LJME_INVALID_DEVICE_TYPE", "LJM received an unsupported device type during device open or discovery."},
    {"LJME_INVALID_HANDLE", "LJM reached an invalid state due to an issue with an invalid handle reference."},
    {
    ...
    {"LJME_STREAM_NOT_INITIALIZED", "The requested device does not have a stream initialized in LJM."},
    {
    ...
    {"LJME_STREAM_OUT_INDEX_OUT_OF_RANGE", "An invalid index value was passed to a stream-out function."},
    ...
    {"LJME_U3_NOT_SUPPORTED_BY_LJM", "LJM does not support UD-series LabJack devices; use the UD driver"},
    {"LJME_U6_NOT_SUPPORTED_BY_LJM", "LJM does not support UD-series LabJack devices; use the UD driver"},
    {"LJME_UE9_NOT_SUPPORTED_BY_LJM", "LJM does not support UD-series LabJack devices; use the UD driver"},
    {
        "LJME_INVALID_ADDRESS",
        "The requested address did not match any address known to LJM (included in ljm_constants.json)"
    },
    {"LJME_INVALID_CONNECTION_TYPE", "LJM received an unexpected connection type during device open or discovery."},
    ...
    {"LJME_NO_COMMAND_BYTES_SENT", "No Modbus command bytes could be sent to the device."},
    {
    ...
    {"LJME_UNKNOWN_IDENTIFIER", "LJM received an unknown identifier type during device open or discovery."},
    {
    ...
    {"LJME_INVALID_MAXBYTESPERMBFB", "LJM_AddressesToMBFB received a value of MaxBytesPerMBFB that was too small."},
    {"LJME_NULL_POINTER", "LJM received a null pointer for a pointer parameter that is required to not be null."},
    {"LJME_NULL_OBJ", "LJM found a null object. Please contact LabJack support if you've received this error."},
    {"LJME_RESERVED_NAME", "The requested name was invalid/reserved."},
    {"LJME_UNPARSABLE_DEVICE_TYPE", "LJM received a device type string that was unparsable or unexpected."},
    {"LJME_UNPARSABLE_CONNECTION_TYPE", "LJM received a connection type string that was unparsable or unexpected."},
    {"LJME_UNPARSABLE_IDENTIFIER", "LJM received a identifier string that was unparsable or unexpected."},
    {
    ...
    {"LJME_TRANSACTION_ID_ERR", "LJM received a mismatched Modbus transaction ID from the device."},
    {"LJME_PROTOCOL_ID_ERR", "LJM received a mismatched Modbus protocol ID from the device."},
    {"LJME_LENGTH_ERR", "LJM received a mismatched Modbus packet length from the device."},
    {"LJME_UNIT_ID_ERR", "LJM received a mismatched Modbus unit ID from the device."},
    {"LJME_FUNCTION_ERR", "LJM received a mismatched Modbus function ID from the device."},
    {"LJME_STARTING_REG_ERR", "LJM received a mismatched Modbus register address from the device."},
    {"LJME_NUM_REGS_ERR", "LJM received a mismatched Modbus number of registers from the device."},
    {"LJME_NUM_BYTES_ERR", "LJM received a mismatched Modbus number of bytes from the device."},
    {"LJME_CONFIG_FILE_NOT_FOUND", "The LJM configuration file could not be opened for reading."},
    {"LJME_CONFIG_PARSING_ERROR", "An error occurred while parsing the LJM configuration file."},
    ...
    {"LJME_OVERSPECIFIED_PORT", "The requested connection type is ANY and port is specified."},
    {
    ...
    {"LJME_CANNOT_READ_OUT_ONLY_STREAM", "The stream running is out-only and does not produce data values."},
    {
    ...
    {"MODBUS_INVALID_NUM_REGISTERS", "Register data types does not match the number of registers in the request."},
    ...
    {"STARTUP_CONFIG_INVALID_READ", "An attempt was made to read beyond the configuration structure."},
    {"USER_RAM_FIFO_MUST_BE_EMPTY", "The FIFO can not contain any data when data size is being changed."},
    {"USER_RAM_FIFO_INSUFFICIENT_VALUES", "The FIFO contains fewer values than requested."},
    {
    ...
    {"USER_RAM_FIFO_SIZE_MUST_BE_EVEN", "The number of bytes allocated to the FIFO must be even."},
    {"INTFLASH_ADD_INVALID", ""},
    {"INTFLASH_CODE_INVALID", ""},
    {"INTFLASH_OP_PROHIBITED", "Attempted to read or write a section that is not allowed."},
    {"INTFLASH_SECTION_OVERWRITE", "Attempted to write or read beyond the currently selected section."},
    {"INTFLASH_KEY_INVALID", "Specified Key and Address mismatch."},
    {"FLASH_VERIFICATION_FAILED", "A write to flash failed to set one or more bits to the desired values."},
    {"FLASH_ERASE_FAILED", "One or more bits failed to set during a flash erase operation."},
    {"INTFLASH_UNAVAILABLE", "Flash can not be accessed due to the WiFi module booting up."},
    {"FILEIO_UNAVAILABLE", "The file system can not be accessed due to the WiFi module booting up."},
    ...
    {"AIN_RESOLUTION_INVALID", "Selected resolution is invalid. Valid range is 0-5 for T4 and 0-12 for T7."},
    {
        "AIN_RATE_INVALID",
    ...
    {"LUA_INVALID_NUM_IO_FLOATS", "Requested more than the max possible number of IO floats."},
    {"LUA_IO_FLOATMEM_OVERFLOW", "Attempt to read/write beyond the currently allocated IO space."},
    {"LUA_INVALID_MODE", ""},
    ...
    {"LUA_DEBUG_IS_DISABLED", "Attempted to read from debug buffer while debug is disabled."},
    {"LUA_TABLE_SMALLER_THAN_SPECIFIED_SIZE", "The Lua table provided is too small to process the request."},
    ...
    {"SYSTEM_NVRAM_INVALID_ADDRESS", "The specified NVRAM location is not available on this device."},
    ...
    {"DEVICE_NAME_MUST_BE_ALPHANUM", "Attempted to write a device name with invalid characters."},
    {"POWER_INVALID_SETTING", "Unknown value specified."},
    {"POWER_USB_NEEDS_20MHZ_OR_MORE", "Core must be running at 20MHz minimum for USB to operate."},
    {"POWER_ETH_NEEDS_20MHZ_OR_MORE", "Core must be running at 20MHz minimum for Ethernet to operate."},
    {"POWER_AIN_NEEDS_20MHZ_OR_MORE", "Core must be running at 20MHz minimum for AIN to operate."},
    {"POWER_STREAM_NEEDS_20MHZ_OR_MORE", "Core must be running at 20MHz minimum to use stream mode."},
    {"POWER_SD_NEEDS_20MHZ_OR_MORE", "Core must be running at 20MHz minimum to use the SD card."},
    {"POWER_CAN_NOT_CHANGE_USED_CONNECTION", "Can not change the power level of the connected medium."},
    ...
    {"DIO_SET_TO_ANALOG", "The digital line addressed is set to analog. Digital operations cannot be performed."},
    {
    ...
    {"HW_DAC1_NOT_AVAILABLE", "DAC1 is an active stream out target and therefore unavailable."},
    {"HW_LEDS_NOT_AVAILABLE", "The LEDs cannot be controlled when the LED power mode is not set to manual."},
    {"EF_DIO_HAS_NO_TNC_FEATURES", "The DIO accessed does not support any extended features."},
    ...
    {"EF_CLOCK_SOURCE_NOT_ENABLED", "Attempted to disable a clock source that is not running."},
    {
    ...
    {"EF_INVALID_DIO_NUMBER", "The specified DIO_EF address is not supported on this device."},
    {
    ...
    {"AIN_EF_INVALID_CJC_REGISTER", "The register address specified for CJC measurement is not supported."},
    {"AIN_EF_STREAM_START_FAILURE", "Could not start the data collection stream."},
    {"AIN_EF_COULD_NOT_FIND_PERIOD", "Failed to detect a period to perform calculations over."},
    ...
    {"STREAM_IN_SPONTANEOUS_MODE", "Stream data can not be read with commands while in spontaneous mode."},
    {
        "STREAM_USB_PKT_OVERFLOW",
        "STREAM_SAMPLES_PER_PACKET is set to a value greater than the USB interface can support."
    },
    {"STREAM_IS_ACTIVE", "The requested operation can not be performed while stream is running."},
    ...
    {"STREAM_TARGET_CONFIG_INVALID", "Stream must be set to either spontaneous or command-response."},
    {"STREAM_OUT_BUFF_FULL", "Attempted to write more data than the buffer can hold. Extra data was discarded."},
    {"STREAM_OUT_TARGET_INVALID", "The specified address cannot be a stream out target."},
    {"STREAM_BUFF_SIZE_INVALID", "The specified buffer was either too large or was not a power of 2."},
    {"STREAM_OUT_BUFF_LOOP_OVERWRITE", ""},
    {"STREAM_OUT_BUFF_DNE", "The buffer size must be set before data can be written to it."},
    {"STREAM_SAMPLES_PER_PKT_INVALID", "The specified number of samples per packet is too large."},
    {"STREAM_BUFFER_DNE", ""},
    {"STREAM_NOT_RUNNING", "Stream was already disabled."},
    {"STREAM_SETTLING_INVALID", "Specified settling time is greater than the max possible."},
    ...
    {"STREAM_TRIGGER_INDEX_INVALID", "The stream trigger index is not valid for this device"},
    {
    ...
    {"SWDT_ENABLED", "The watchdog must be disabled before the requested operation can be performed."},
    {"SWDT_DIO_SETTINGS_INVALID", "The specified Software Watchdog DIO configurations are not valid."},
    {"SWDT_DAC0_SETTINGS_INVALID", "The specified Software Watchdog DAC0 configurations are not valid."},
    {"SWDT_DAC1_SETTINGS_INVALID", "The specified Software Watchdog DAC1 configurations are not valid."},
    {"RTC_TIME_INVALID", ""},
    {"RTC_SNTP_TIME_INVALID", "The specified SNTP update interval is too short."},
    {"RTC_NOT_PRESENT", "The requested operation can not be performed on units without a real-time-clock."},
    ...
    {"I2C_BUS_BUSY", "One or both of the I2C lines are held low. Check hardware and reset the bus."},
    ...
    {"I2C_SPEED_TOO_LOW", "The throttle setting is too low, watchdog may fire. Minimum value = 46000"},
    ...
    {"TDAC_NOT_INITIALIZED", "A TDAC has not been initialized, try writing to the the TDAC# register."},
    {"ONEWIRE_UNSUPPORTED_FUNCTION", "Unknown function specified."},
    {"ONEWIRE_NO_PRESENCE_PULSE", "Unable to detect any devices on the bus."},
    {"ASYNCH_NUM_DATA_BITS_INVALID", "The specified number of data bits is not supported."},
    {"ASYNCH_NUM_TO_WRITE_INVALID", "The number of bytes to send is invalid."},
    {"ASYNCH_READ_BUFF_SIZE_INVALID", "The specified buffer size is invalid. Max is 2048."},
    ...
    {"ASYNCH_IS_NOT_ENABLED", "The specified operation can not be performed while disabled."},
    {"ASYNCH_TX_BUFFER_FULL", "The transmit buffer is full."},
    {"ASYNCH_TX_TIMEOUT", "Transmission timed out. Do not write more than 100 ms at a time."},
    ...
    {"FILE_IO_DENIED", "Access denied due to prohibited access or the directory is full."},
    ...
    {"FILE_IO_TIMEOUT", "Could not get granted access to the volume within the defined timeout period."},
    ...
    {"WIFI_APPLYING_SETTINGS", "The WiFi module is attempting to apply the desired network settings."},
    {"WIFI_DHCP_STARTED", "The WiFi module has begun the process of claiming a DHCP lease."},
    ...
    {"WIFI_UPDATE_REBOOT", "The WiFi module has updated and will restart to apply the new changes."},
    ...
    {"FILE_IO_FILE_NOT_OPEN", "An open file is required to perform the requested operation."},
    {"FILE_IO_TOO_MANY_OPEN", "There are too many files open."},
    {"FILE_IO_SD_CARD_NOT_FOUND", "Failed to mount the SD card. Card may be bad or incompatible."},
