...
json ni::Scanner::getDeviceProperties(NISysCfgResourceHandle resource) {
    ...
    ni::NiSysCfgInterface::GetResourceIndexedProperty(resource, NISysCfgIndexedPropertyExpertUserAlias, 0,
                                                      propertyValue);
    device["location"] = propertyValue;

    ni::NiSysCfgInterface::GetResourceIndexedProperty(resource, NISysCfgIndexedPropertyExpertResourceName, 0,
                                                      propertyValue);
