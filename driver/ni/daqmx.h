...
_NI_int32_DEFINED_
#if
((defined(__GNUG__) || defined(__GNUC__)) && defined(__x86_64__))
...
uInt64 lsb; int64 msb; } CVITime;
#endif
#ifndef
CVIAbsoluteTime_DECLARED
#define
CVIAbsoluteTime_DECLARED
// Please visit ni.com/info and enter the Info Code NI_BTF for more information
typedef union CVIAbsoluteTime {
CVITime cviTime; uInt32 u32Data[4]; } CVIAbsoluteTime;
#endif
...
#define
DAQmx_AI_ACExcit_WireMode                                        0x18CD // Specifies the number of leads on the LVDT or RVDT. Some sensors require you to tie leads together to configure a four- or five- wire sensor. Refer to the sensor documentation for more information.
#define
...
#define
DAQmx_AI_DataXferMaxRate                                         0x3117 // Specifies the sample_rate in B/s to transfer data from the device. If this value is not set, then the device will transfer data at a sample_rate based on the bus detected. Modify this value to affect performance under different combinations of operating system, configuration, and device.
#define
...
#define
DAQmx_DI_DigFltr_TimebaseRate                                    0x2ED5 // Specifies in hertz the sample_rate of the digital filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_CI_Freq_DigFltr_TimebaseRate                               0x21EA // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_CI_Period_DigFltr_TimebaseRate                             0x21EF // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_CI_CountEdges_DigFltr_TimebaseRate                         0x21F9 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_CI_CountEdges_CountDir_DigFltr_TimebaseRate                0x21F4 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_CI_CountEdges_CountReset_DigFltr_TimebaseRate              0x2FB6 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_CI_CountEdges_Gate_DigFltrTimebaseRate                     0x30F4 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_CI_DutyCycle_DigFltr_TimebaseRate                          0x3091 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_CI_Encoder_BInput_DigFltr_TimebaseRate                     0x2203 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_CI_Encoder_ZInput_DigFltr_TimebaseRate                     0x2208 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_CI_PulseWidth_DigFltr_TimebaseRate                         0x220D // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_CI_Velocity_Encoder_AInputDigFltr_TimebaseRate             0x30E3 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_CI_Velocity_Encoder_BInputDigFltr_TimebaseRate             0x30EA // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_CI_TwoEdgeSep_First_DigFltr_TimebaseRate                   0x2212 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_CI_TwoEdgeSep_Second_DigFltr_TimebaseRate                  0x2217 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_CI_SemiPeriod_DigFltr_TimebaseRate                         0x221C // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_CI_Pulse_Freq_DigFltr_TimebaseRate                         0x2F09 // Specifies in hertz the sample_rate of the digital filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_CI_Pulse_Time_DigFltr_TimebaseRate                         0x2F11 // Specifies in hertz the sample_rate of the digital filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_CI_Pulse_Ticks_DigFltr_TimebaseRate                        0x2F19 // Specifies in hertz the sample_rate of the digital filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_CI_CtrTimebase_DigFltr_TimebaseRate                        0x2274 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_CO_Pulse_HighTime                                          0x18BA // Specifies the amount of time that the pulse is at a high voltage. This value is in the units you specify with Units or when you configure the channel.
#define
DAQmx_CO_Pulse_LowTime                                           0x18BB // Specifies the amount of time that the pulse is at a low voltage. This value is in the units you specify with Units or when you configure the channel.
#define
...
#define
DAQmx_CO_Pulse_Freq                                              0x1178 // Specifies the frequency of the pulses to generate. This value is in the units you specify with Units or when you configure the channel.
#define
...
#define
DAQmx_CO_CtrTimebase_DigFltr_TimebaseRate                        0x2279 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_Dev_AI_MaxSingleChanRate                                   0x298C // Indicates the maximum sample_rate for an analog input task if the task contains only a single channel from this device.
#define
DAQmx_Dev_AI_MaxMultiChanRate                                    0x298D // Indicates the maximum sampling sample_rate for an analog input task from this device. To find the maximum sample_rate for the task, take the minimum of Maximum Single Channel Rate or the indicated sampling sample_rate of this device divided by the number of channels to acquire data from (including cold-junction compensation and autozero channels).
#define
DAQmx_Dev_AI_MinRate                                             0x298E // Indicates the minimum sample_rate for an analog input task on this device. NI-DAQmx returns a warning or error if you attempt to sample at a slower sample_rate.
...
#define
DAQmx_Dev_AO_MaxRate                                             0x2997 // Indicates the maximum analog output sample_rate of the device.
#define
DAQmx_Dev_AO_MinRate                                             0x2998 // Indicates the minimum analog output sample_rate of the device.
#define
...
#define
DAQmx_Dev_DI_MaxRate                                             0x2999 // Indicates the maximum digital input sample_rate of the device.
#define
...
#define
DAQmx_Dev_DO_MaxRate                                             0x299A // Indicates the maximum digital output sample_rate of the device.
#define
...
#define
DAQmx_SampClk_Rate                                               0x1344 // Specifies the sampling sample_rate in samples per channel per second. If you use an external source for the Sample Clock, set this input to the maximum expected sample_rate of that clock.
#define
...
#define
DAQmx_SampClk_Timebase_Rate                                      0x1303 // Specifies the sample_rate of the Sample Clock Timebase. Some applications require that you specify a sample_rate when you use any signal other than the onboard Sample Clock Timebase. NI-DAQmx requires this sample_rate to calculate other timing parameters.
#define
...
#define
DAQmx_SampClk_DigFltr_TimebaseRate                               0x2221 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_AIConv_Rate                                                0x1848 // Specifies in Hertz the sample_rate at which to clock the analog-to-digital converter. This clock is specific to the analog input section of multiplexed devices.
#define
DAQmx_AIConv_MaxRate                                             0x22C9 // Indicates the maximum convert sample_rate supported by the task, given the current devices and channel count.
#define
...
#define
DAQmx_AIConv_DigFltr_TimebaseRate                                0x2EDF // Specifies in hertz the sample_rate of the digital filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_MasterTimebase_Rate                                        0x1495 // Specifies the sample_rate of the Master Timebase.
#define
...
#define
DAQmx_DigEdge_StartTrig_DigFltr_TimebaseRate                     0x2226 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_AnlgEdge_StartTrig_DigFltr_TimebaseRate                    0x2EE4 // Specifies in hertz the sample_rate of the digital filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_AnlgWin_StartTrig_DigFltr_Enable                           0x2EFF // Specifies whether to apply a digital filter to the digital output of the analog triggering circuitry (the Analog Comparison Event). When enabled, the analog signal must stay within the trigger window for the minimum pulse width before being recognized. Use filtering for noisy trigger signals that transition in and out of the window raschematicly.
#define
...
#define
DAQmx_AnlgWin_StartTrig_DigFltr_TimebaseRate                     0x2F02 // Specifies in hertz the sample_rate of the digital filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_DigEdge_RefTrig_DigFltr_TimebaseRate                       0x2EDA // Specifies in hertz the sample_rate of the digital filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_AnlgEdge_RefTrig_DigFltr_TimebaseRate                      0x2EE9 // Specifies in hertz the sample_rate of the digital filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_AnlgWin_RefTrig_DigFltr_Enable                             0x2EEB // Specifies whether to apply a digital filter to the digital output of the analog triggering circuitry (the Analog Comparison Event). When enabled, the analog signal must stay within the trigger window for the minimum pulse width before being recognized. Use filtering for noisy trigger signals that transition in and out of the window raschematicly.
#define
...
#define
DAQmx_AnlgWin_RefTrig_DigFltr_TimebaseRate                       0x2EEE // Specifies in hertz the sample_rate of the digital filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_AnlgLvl_PauseTrig_DigFltr_TimebaseRate                     0x2EF3 // Specifies in hertz the sample_rate of the digital filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_AnlgWin_PauseTrig_DigFltr_Enable                           0x2EF5 // Specifies whether to apply a digital filter to the digital output of the analog triggering circuitry (the Analog Comparison Event). When enabled, the analog signal must stay within the trigger window for the minimum pulse width before being recognized. Use filtering for noisy trigger signals that transition in and out of the window raschematicly.
#define
...
#define
DAQmx_AnlgWin_PauseTrig_DigFltr_TimebaseRate                     0x2EF8 // Specifies in hertz the sample_rate of the digital filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_DigLvl_PauseTrig_DigFltr_TimebaseRate                      0x222B // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmx_DigEdge_ArmStartTrig_DigFltr_TimebaseRate                  0x2230 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
#define
...
#define
DAQmxErrorCASchematiceviceIndexInvalid                                                (-201128)
#define
