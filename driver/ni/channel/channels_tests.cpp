...
TEST(ChannelsTest, ParseLegacyEnabledKeyInput) {
    x::json::json j = {
        {"type", "ai_voltage"},
        {"key", "ks1VnWdrSVA"},
        {"port", 0},
    ...
    ASSERT_FALSE(p.error()) << p.error();
    ASSERT_NE(chan, nullptr);
    EXPECT_EQ(chan->enabled, false);
}

TEST(ChannelsTest, ParseLegacyEnabledKeyOutput) {
    x::json::json j = {
        {"type", "ao_voltage"},
        {"key", "hCzuNC9glqc"},
        {"port", 0},
...
TEST(ChannelsTest, ParseExplicitDisabledKeyWins) {
    x::json::json j = {
        {"type", "ai_voltage"},
        {"key", "ks1VnWdrSVA"},
        {"port", 0},
