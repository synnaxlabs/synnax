...
TEST(ChannelsTest, ParseAIAccelChan) {
    ...
    accel_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod2");
...
TEST(ChannelsTest, ParseAIBridgeChan) {
    ...
    bridge_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod2");
...
TEST(ChannelsTest, ParseAICurrentChan) {
    ...
    current_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod2");
...
TEST(ChannelsTest, ParseAIForceBridgeTableChan) {
    ...
    force_bridge_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod2");
...
TEST(ChannelsTest, ParseAIForceIEPEChan) {
    ...
    force_iepe_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod2");
...
TEST(ChannelsTest, ParseAIMicrophoneChan) {
    ...
    mic_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod2");
...
TEST(ChannelsTest, ParseAIPressureBridgeTableChan) {
    ...
    pressure_bridge_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod2");
...
TEST(ChannelsTest, ParseAIRTDChan) {
    ...
    rtd_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod2");
...
TEST(ChannelsTest, ParseAIStrainGaugeChan) {
    ...
    strain_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod2");
...
TEST(ChannelsTest, ParseAITempBuiltInChan) {
    ...
    temp_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod2");
...
TEST(ChannelsTest, ParseAIThermoChan) {
    ...
    thermo_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod2");
...
TEST(ChannelsTest, ParseAITorqueBridgeTableChan) {
    ...
    torque_bridge_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod2");
...
TEST(ChannelsTest, ParseAIVelocityIEPEChan) {
    ...
    velocity_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod2");
...
TEST(ChannelsTest, ParseAIVoltageChan) {
    ...
    voltage_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod2");
...
TEST(ChannelsTest, ParseAOFuncGenChan) {
    ...
    func_gen_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod2");
...
TEST(ChannelsTest, ParseDIChan) {
    ...
    di_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod2");
...
TEST(ChannelsTest, ParseDOChan) {
    ...
    do_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod2");
...
TEST(ChannelsTest, ParseCIFrequencyChanHz) {
    ...
    ci_freq_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod3");
...
TEST(ChannelsTest, ParseCIEdgeCountChanRising) {
    ...
    ci_edge_count_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod3");
...
TEST(ChannelsTest, ParseCIPeriodChanSeconds) {
    ...
    ci_period_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod3");
...
TEST(ChannelsTest, ParseCIPulseWidthChanSeconds) {
    ...
    ci_pulse_width_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod3");
...
TEST(ChannelsTest, ParseCISemiPeriodChanSeconds) {
    ...
    ci_semi_period_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod3");
...
TEST(ChannelsTest, ParseCITwoEdgeSepChanSeconds) {
    ...
    ci_two_edge_sep_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod3");
...
TEST(ChannelsTest, ParseCILinearVelocityChanMetersPerSecond) {
    ...
    ci_lin_vel_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod3");
...
TEST(ChannelsTest, ParseCIAngularVelocityChanRPM) {
    ...
    ci_ang_vel_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod3");
...
TEST(ChannelsTest, ParseCILinearPositionChanMeters) {
    ...
    ci_lin_pos_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod3");
...
TEST(ChannelsTest, ParseCIAngularPositionChanDegrees) {
    ...
    ci_ang_pos_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod3");
...
TEST(ChannelsTest, ParseCIDutyCycleChanRising) {
    ...
    ci_duty_cycle_chan->bind_remote_info(synnax::channel::Channel::Channel(), "cDAQ1Mod3");
