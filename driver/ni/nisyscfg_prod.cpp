...
NISYSCFGCFUNC ni::NiSysCfgInterface::InitializeSession(
    ...
    return NISysCfgInitializeSession(targetName, username, password, language, forcePropertyRefresh, connectTimeoutMsec, expertEnumHandle, sessionHandle);
}
...
NISYSCFGCFUNC ni::NiSysCfgInterface::FindHardware(
    ...
    return NISysCfgFindHardware(sessionHandle, filterMode, filterHandle, expertNames, resourceEnumHandle);
}
