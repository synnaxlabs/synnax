...
TEST(WriterTests, test_write_one_digital_channel){
    ...
    add_drive_state_index_channel_JSON(config, "do1_state", 2);
    ...
    for(int i = 0; i < frame2.series->size(); i++){
        ...
        else if(frame2.series->at(i).data_type == synnax::TIMESTAMP){
...
TEST(NiWriterTests, test_write_multiple_digital_channel){
    ...
    add_DO_channel_JSON(config, "do1_command", 65531, 65532, 0, 0);
    add_DO_channel_JSON(config, "do1_command", 65533, 65534, 0, 1);
    add_DO_channel_JSON(config, "do1_command", 65535, 65536, 0, 2);
    add_DO_channel_JSON(config, "do1_command", 65537, 65538, 0, 3);
    add_drive_state_index_channel_JSON(config, "do1_state", 2);
