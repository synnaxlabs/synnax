...
#define DAQmx_AI_ACExcit_WireMode                                        0x18CD // Specifies the number of leads on the LVDT or RVDT. Some sensors require you to tie leads together to configure a four- or five- wire sensor. Refer to the sensor documentation for more information.
...
#define DAQmx_AI_DataXferMaxRate                                         0x3117 // Specifies the sample_rate in B/s to transfer data from the device. If this value is not set, then the device will transfer data at a sample_rate based on the bus detected. Modify this value to affect performance under different combinations of operating system, configuration, and device.
...
#define DAQmx_DI_DigFltr_TimebaseRate                                    0x2ED5 // Specifies in hertz the sample_rate of the digital filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_CI_Freq_DigFltr_TimebaseRate                               0x21EA // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_CI_Period_DigFltr_TimebaseRate                             0x21EF // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_CI_CountEdges_DigFltr_TimebaseRate                         0x21F9 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_CI_CountEdges_CountDir_DigFltr_TimebaseRate                0x21F4 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_CI_CountEdges_CountReset_DigFltr_TimebaseRate              0x2FB6 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_CI_CountEdges_Gate_DigFltrTimebaseRate                     0x30F4 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_CI_DutyCycle_DigFltr_TimebaseRate                          0x3091 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_CI_Encoder_AInput_DigFltr_TimebaseRate                     0x21FE // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_CI_Encoder_BInput_DigFltr_TimebaseRate                     0x2203 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_CI_Encoder_ZInput_DigFltr_TimebaseRate                     0x2208 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_CI_PulseWidth_DigFltr_TimebaseRate                         0x220D // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_CI_Velocity_Encoder_AInputDigFltr_TimebaseRate             0x30E3 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_CI_Velocity_Encoder_BInputDigFltr_TimebaseRate             0x30EA // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_CI_TwoEdgeSep_First_DigFltr_TimebaseRate                   0x2212 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_CI_TwoEdgeSep_Second_DigFltr_TimebaseRate                  0x2217 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_CI_SemiPeriod_DigFltr_TimebaseRate                         0x221C // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_CI_Pulse_Freq_DigFltr_TimebaseRate                         0x2F09 // Specifies in hertz the sample_rate of the digital filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_CI_Pulse_Time_DigFltr_TimebaseRate                         0x2F11 // Specifies in hertz the sample_rate of the digital filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_CI_Pulse_Ticks_DigFltr_TimebaseRate                        0x2F19 // Specifies in hertz the sample_rate of the digital filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_CI_CtrTimebase_DigFltr_TimebaseRate                        0x2274 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_CO_Pulse_HighTime                                          0x18BA // Specifies the amount of time that the pulse is at a high voltage. This value is in the units you specify with Units or when you configure the channel.
#define DAQmx_CO_Pulse_LowTime                                           0x18BB // Specifies the amount of time that the pulse is at a low voltage. This value is in the units you specify with Units or when you configure the channel.
...
#define DAQmx_CO_Pulse_Freq                                              0x1178 // Specifies the frequency of the pulses to generate. This value is in the units you specify with Units or when you configure the channel.
...
#define DAQmx_CO_CtrTimebase_DigFltr_TimebaseRate                        0x2279 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_Dev_AI_MaxSingleChanRate                                   0x298C // Indicates the maximum sample_rate for an analog input task if the task contains only a single channel from this device.
#define DAQmx_Dev_AI_MaxMultiChanRate                                    0x298D // Indicates the maximum sampling sample_rate for an analog input task from this device. To find the maximum sample_rate for the task, take the minimum of Maximum Single Channel Rate or the indicated sampling sample_rate of this device divided by the number of channels to acquire data from (including cold-junction compensation and autozero channels).
#define DAQmx_Dev_AI_MinRate                                             0x298E // Indicates the minimum sample_rate for an analog input task on this device. NI-DAQmx returns a warning or error if you attempt to sample at a slower sample_rate.
...
#define DAQmx_Dev_AO_MaxRate                                             0x2997 // Indicates the maximum analog output sample_rate of the device.
#define DAQmx_Dev_AO_MinRate                                             0x2998 // Indicates the minimum analog output sample_rate of the device.
...
#define DAQmx_Dev_DI_MaxRate                                             0x2999 // Indicates the maximum digital input sample_rate of the device.
...
#define DAQmx_Dev_DO_MaxRate                                             0x299A // Indicates the maximum digital output sample_rate of the device.
...
#define DAQmx_SampClk_Rate                                               0x1344 // Specifies the sampling sample_rate in samples per channel per second. If you use an external source for the Sample Clock, set this input to the maximum expected sample_rate of that clock.
#define DAQmx_SampClk_MaxRate                                            0x22C8 // Indicates the maximum Sample Clock sample_rate supported by the task, based on other timing settings. For output tasks, the maximum Sample Clock sample_rate is the maximum sample_rate of the DAC. For input tasks, NI-DAQmx calculates the maximum sampling sample_rate differently for multiplexed devices than simultaneous sampling devices.
...
#define DAQmx_SampClk_Timebase_Rate                                      0x1303 // Specifies the sample_rate of the Sample Clock Timebase. Some applications require that you specify a sample_rate when you use any signal other than the onboard Sample Clock Timebase. NI-DAQmx requires this sample_rate to calculate other timing parameters.
...
#define DAQmx_SampClk_DigFltr_TimebaseRate                               0x2221 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_AIConv_Rate                                                0x1848 // Specifies in Hertz the sample_rate at which to clock the analog-to-digital converter. This clock is specific to the analog input section of multiplexed devices.
#define DAQmx_AIConv_MaxRate                                             0x22C9 // Indicates the maximum convert sample_rate supported by the task, given the current devices and channel count.
...
#define DAQmx_AIConv_DigFltr_TimebaseRate                                0x2EDF // Specifies in hertz the sample_rate of the digital filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_MasterTimebase_Rate                                        0x1495 // Specifies the sample_rate of the Master Timebase.
...
#define DAQmx_DigEdge_StartTrig_DigFltr_TimebaseRate                     0x2226 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_AnlgEdge_StartTrig_DigFltr_TimebaseRate                    0x2EE4 // Specifies in hertz the sample_rate of the digital filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_AnlgWin_StartTrig_DigFltr_TimebaseRate                     0x2F02 // Specifies in hertz the sample_rate of the digital filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_DigEdge_RefTrig_DigFltr_TimebaseRate                       0x2EDA // Specifies in hertz the sample_rate of the digital filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_AnlgEdge_RefTrig_DigFltr_TimebaseRate                      0x2EE9 // Specifies in hertz the sample_rate of the digital filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_AnlgWin_RefTrig_DigFltr_TimebaseRate                       0x2EEE // Specifies in hertz the sample_rate of the digital filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_AnlgLvl_PauseTrig_DigFltr_TimebaseRate                     0x2EF3 // Specifies in hertz the sample_rate of the digital filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_AnlgWin_PauseTrig_DigFltr_TimebaseRate                     0x2EF8 // Specifies in hertz the sample_rate of the digital filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_DigLvl_PauseTrig_DigFltr_TimebaseRate                      0x222B // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmx_DigEdge_ArmStartTrig_DigFltr_TimebaseRate                  0x2230 // Specifies in hertz the sample_rate of the pulse width filter timebase. NI-DAQmx uses this value to compute settings for the filter.
...
#define DAQmerrorsensorPowerSupplyVoltageLevel                                         (-209868)
#define DAQmerrorsensorPowerSupply                                                     (-209867)
...
#define DAQmerrorsampleClockTimebaseNotSupported                                       (-209845)
...
#define DAQmerrorsynchronizationLockLost                                               (-209838)
...
#define DAQmerrorsampleRateNumChansOrAttributeValues                                   (-209834)
...
#define DAQmerrorselfTestFailedPowerSupplyOutOfTolerance                               (-209816)
...
#define DAQmerrorsetupCalNeededBeforeGetCalDataPoints                                  (-201497)
...
#define DAQmerrorshuntCalFailedOutOfRange                                              (-201493)
...
#define DAQmerrorsetupCalibrationNotCalled                                             (-201486)
...
#define DAQmerrorsharingDifferentWireModes                                             (-201436)
...
#define DAQmerrorstartTrigDelayWithDSAModule                                           (-201429)
...
#define DAQmerrorsyncStrategiesCannotSync                                              (-201424)
...
#define DAQmerrorspecifiedAccessoryChannelsNotPresentOnDevice                          (-201412)
...
#define DAQmerrorselfCalFailedContactTechSupport                                       (-201386)
#define DAQmerrorselfCalFailedToConverge                                               (-201385)
...
#define DAQmerrorselfCalFailedTryExtCal                                                (-201374)
...
#define DAQmerrorsyncPulseSrcInvalidForTask                                            (-201361)
...
#define DAQmerrorslaveWithNoStartTriggerConfigured                                     (-201350)
...
#define DAQmerrorslaveAndNoExternalSyncPulse                                           (-201346)
...
#define DAQmerrorsCCSecondStageEmpty                                                   (-201328)
#define DAQmerrorsCCInvalidDualStageCombo                                              (-201327)
#define DAQmerrorsCCInvalidSecondStage                                                 (-201326)
#define DAQmerrorsCCInvalidFirstStage                                                  (-201325)
...
#define DAQmerrorscaledIQWaveformTooLarge                                              (-201264)
...
#define DAQmerrorsCXICommDevConnector0MustBeCabledToModule                             (-201241)
#define DAQmerrorsCXIModuleDoesNotSupportDigitizationMode                              (-201240)
...
#define DAQmerrorsCXIChassisCommModeInvalid                                            (-201236)
...
#define DAQmerrorstorageAlteredPriorToSave                                             (-201232)
...
#define DAQmerrorsampleRateTooHighForADCTimingMode                                     (-201208)
...
#define DAQmerrorstrainShuntCaNotSupported                                             (-201203)
...
#define DAQmerrorsampleClockRateIsTooFastForSampleClockTiming                          (-201178)
#define DAQmxErrorDeviceNotUsableUntilColdStart                                         (-201177)
#define DAQmerrorsampleClockRateIsTooFastForBurstTiming                                (-201176)
#define DAQmxErrorDevImportFailedAssociatedResourceIDsNotSupported                      (-201175)
#define DAQmerrorsCXI1600ImportNotSupported                                            (-201174)
...
#define DAQmerrorsampClockCannotBeExportedFromExternalSampClockSrc                     (-201164)
...
#define DAQmerrorspecifiedCDAQSlotNotEmpty                                             (-201161)
...
#define DAQmerrorsCCCabledDevMustNotBeSimWhenSCCCarrierIsNotSim                        (-201157)
#define DAQmerrorsCCModSimMustMatchSCCCarrierSim                                       (-201156)
#define DAQmerrorsCXIModuleDoesNotSupportSimulation                                    (-201155)
#define DAQmerrorsCXICableDevMustNotBeSimWhenModIsNotSim                               (-201154)
#define DAQmerrorsCXIDigitizerSimMustNotBeSimWhenModIsNotSim                           (-201153)
#define DAQmerrorsCXIModSimMustMatchSCXIChassisSim                                     (-201152)
#define DAQmerrorsimPXIDevReqSlotAndChassisSpecd                                       (-201151)
#define DAQmerrorsimDevConflictWithRealDev                                             (-201150)
...
#define DAQmerrorsoftwareTooNewForSelfCalibrationData                                  (-201146)
#define DAQmerrorsoftwareTooNewForExtCalibrationData                                   (-201145)
#define DAQmerrorselfCalibrationDataTooNewForSoftware                                  (-201144)
#define DAQmxErrorExtCalibrationDataTooNewForSoftware                                   (-201143)
#define DAQmerrorsoftwareTooNewForEEPROM                                               (-201142)
#define DAQmxErrorEEPROMTooNewForSoftware                                               (-201141)
#define DAQmerrorsoftwareTooNewForHardware                                             (-201140)
...
#define DAQmerrorspecdPropertyValueIsIncompatibleWithSampleTimingType                  (-201122)
#define DAQmxErrorCPUNotSupportedRequireSSE                                             (-201121)
#define DAQmerrorspecdPropertyValueIsIncompatibleWithSampleTimingResponseMode          (-201120)
...
#define DAQmerrorsampClkTimebaseDivWithExtSampClk                                      (-201100)
#define DAQmxErrorCantSaveTaskWithPerDeviceTimingProperties                             (-201099)
#define DAQmxErrorConflictingAutoZeroMode                                               (-201098)
#define DAQmerrorsampClkRateNotSupportedWithEAREnabled                                 (-201097)
#define DAQmerrorsampClkTimebaseRateNotSpecd                                           (-201096)
#define DAQmerrorsessionCorruptedByDLLReload                                           (-201095)
#define DAQmxErrorActiveDevNotSupportedWithChanExpansion                                (-201094)
#define DAQmerrorsampClkRateInvalid                                                    (-201093)
#define DAQmxErrorExtSyncPulseSrcCannotBeExported                                       (-201092)
#define DAQmerrorsyncPulseMinDelayToStartNeededForExtSyncPulseSrc                      (-201091)
#define DAQmerrorsyncPulseSrcInvalid                                                   (-201090)
#define DAQmerrorsampClkTimebaseRateInvalid                                            (-201089)
#define DAQmerrorsampClkTimebaseSrcInvalid                                             (-201088)
#define DAQmerrorsampClkRateMustBeSpecd                                                (-201087)
...
#define DAQmerrorsWObjectsFoundInFile                                                  (-201075)
...
#define DAQmerrorsCCCarrierSpecdIsMissing                                              (-201050)
...
#define DAQmerrorspecdSlotAlreadyOccupied                                              (-201033)
#define DAQmxErrorInvalidSCXISlotNumberSpecd                                            (-201032)
#define DAQmxErrorAddressAlreadyInUse                                                   (-201031)
#define DAQmerrorspecdDeviceDoesNotSupportRTSI                                         (-201030)
#define DAQmerrorspecdDeviceIsAlreadyOnRTSIBus                                         (-201029)
...
#define DAQmerrorsMIOPauseTriggersNotSupportedWithChannelExpansion                     (-201019)
...
#define DAQmerrorsetupCalNeededBeforeAdjustCal                                         (-201005)
#define DAQmxErrorMultipleChansNotSupportedDuringCalSetup                               (-201004)
#define DAQmxErrorDevCannotBeAccessed                                                   (-201003)
#define DAQmerrorsampClkRateDoesntMatchSampClkSrc                                      (-201002)
#define DAQmerrorsampClkRateNotSupportedWithEARDisabled                                (-201001)
...
#define DAQmerrorsignalEventsNotSupportedByDevice                                      (-200982)
...
#define DAQmerrorsampClkOutputTermIncludesStartTrigSrc                                 (-200954)
#define DAQmerrorstartTrigSrcEqualToSampClkSrc                                         (-200953)
...
#define DAQmerrorsignalEventAlreadyRegistered                                          (-200949)
...
#define DAQmerrorstartFailedDueToWriteFailure                                          (-200946)
...
#define DAQmerrorsampleTimebaseDivisorNotSupportedGivenTimingType                      (-200916)
...
#define DAQmerrorstartTrigOutputTermNotSupportedGivenTimingType                        (-200911)
#define DAQmerrorsampClockOutputTermNotSupportedGivenTimingType                        (-200910)
#define DAQmxError20MhzTimebaseNotSupportedGivenTimingType                              (-200909)
#define DAQmerrorsampClockSourceNotSupportedGivenTimingType                            (-200908)
...
#define DAQmerrorstartTrigTypeNotSupportedGivenTimingType                              (-200904)
...
#define DAQmerrorstartTrigDigPatternSizeDoesNotMatchSourceSize                         (-200894)
...
#define DAQmerrorstartTrigDigPatternChanNotInTask                                      (-200887)
#define DAQmerrorstartTrigDigPatternChanNotTristated                                   (-200886)
...
#define DAQmerrorsimulationCannotBeDisabledForDevCreatedAsSimulatedDev                 (-200856)
...
#define DAQmerrorsyncNoDevSampClkTimebaseOrSyncPulseInPXISlot2                         (-200852)
...
#define DAQmerrorsampClkTimingTypeWhenTristateIsFalse                                  (-200839)
#define DAQmxErrorOutputBufferSizeNotMultOfXferSize                                     (-200838)
#define DAQmerrorsampPerChanNotMultOfXferSize                                          (-200837)
#define DAQmxErrorWriteToTEDSFailed                                                     (-200836)
#define DAQmerrorsCXIDevNotUsablePowerTurnedOff                                        (-200835)
...
#define DAQmerrorsimultaneousAOWhenNotOnDemandTiming                                   (-200831)
...
#define DAQmerrorswitchDevShutDownDueToHighTemp                                        (-200818)
...
#define DAQmerrorstartTrigConflictWithCOHWTimedSinglePt                                (-200787)
#define DAQmerrorsampClkRateExtSampClkTimebaseRateMismatch                             (-200786)
...
#define DAQmerrorsuitableTimebaseNotFoundTimeCombo2                                    (-200746)
#define DAQmerrorsuitableTimebaseNotFoundFrequencyCombo2                               (-200745)
...
#define DAQmerrorswitchOpFailedDueToPrevError                                          (-200674)
...
#define DAQmerrorsampClkRateUnavailable                                                (-200660)
...
#define DAQmerrorsendAdvCmpltAfterWaitForTrigInScanlist                                (-200640)
...
#define DAQmerrorscriptNameSameAsWfmName                                               (-200633)
...
#define DAQmerrorsampClkSrcInvalidForOutputValidForInput                               (-200610)
...
#define DAQmerrorscaledMinEqualMax                                                     (-200603)
...
#define DAQmerrorswitchOperationChansSpanMultipleDevsInList                            (-200596)
...
#define DAQmerrorsampToWritePerChanNotMultipleOfIncr                                   (-200584)
...
#define DAQmerrorselfCalConstsInvalid                                                  (-200549)
...
#define DAQmerrorselfCalFailedExtNoiseOrRefVoltageOutOfCal                             (-200545)
#define DAQmxErrorExtCalTemperatureNotDAQmx                                             (-200544)
#define DAQmxErrorExtCalDateTimeNotDAQmx                                                (-200543)
#define DAQmerrorselfCalTemperatureNotDAQmx                                            (-200542)
#define DAQmerrorselfCalDateTimeNotDAQmx                                               (-200541)
...
#define DAQmerrorsensorValTooLow                                                       (-200536)
#define DAQmerrorsensorValTooHigh                                                      (-200535)
...
#define DAQmerrorsampleValueOutOfRange                                                 (-200490)
...
#define DAQmerrorstartTrigDelayWithExtSampClk                                          (-200436)
...
#define DAQmerrorstrobePhaseShiftDCMBecameUnlocked                                     (-200391)
...
#define DAQmerrorstrainGageCalibration                                                 (-200380)
...
#define DAQmerrorsampPerChanNotMultipleOfIncr                                          (-200344)
#define DAQmxErrorCannotCalculateNumSampsTaskNotStarted                                 (-200343)
#define DAQmerrorscriptNotInMem                                                        (-200342)
...
#define DAQmerrorsampRateTooHigh                                                       (-200332)
#define DAQmerrorsampRateTooLow                                                        (-200331)
...
#define DAQmerrorscriptDataUnderflow                                                   (-200316)
#define DAQmxErrorNoDevMemForWaveform                                                   (-200315)
#define DAQmerrorstreamDCMBecameUnlocked                                               (-200314)
#define DAQmerrorstreamDCMLock                                                         (-200313)
...
#define DAQmerrorsampClkTbMasterTbDivNotAppropriateForSampTbSrc                        (-200309)
#define DAQmerrorsampTbRateSampTbSrcMismatch                                           (-200308)
#define DAQmxErrorMasterTbRateMasterTbSrcMismatch                                       (-200307)
#define DAQmerrorsampsPerChanTooBig                                                    (-200306)
...
#define DAQmerrorsamplesCanNotYetBeWritten                                             (-200292)
...
#define DAQmerrorsamplesNoLongerWriteable                                              (-200289)
#define DAQmerrorsamplesWillNeverBeGenerated                                           (-200288)
#define DAQmxErrorNegativeWriteSampleNumber                                             (-200287)
#define DAQmxErrorNoAcqStarted                                                          (-200286)
#define DAQmerrorsamplesNotYetAvailable                                                (-200284)
...
#define DAQmerrorsamplesNoLongerAvailable                                              (-200279)
#define DAQmerrorsamplesWillNeverBeAvailable                                           (-200278)
...
#define DAQmerrorsampClkRateAndDivCombo                                                (-200273)
#define DAQmerrorsampClkRateTooLowForDivDown                                           (-200272)
...
#define DAQmerrorsampClkDCMBecameUnlocked                                              (-200240)
#define DAQmerrorsampClkDCMLock                                                        (-200239)
#define DAQmerrorsampClkTimebaseDCMBecameUnlocked                                      (-200238)
#define DAQmerrorsampClkTimebaseDCMLock                                                (-200237)
...
#define DAQmerrorspecifiedAttrNotValid                                                 (-200233)
...
#define DAQmerrorsCXI1126ThreshHystCombination                                         (-200223)
...
#define DAQmerrorsampleTimingTypeAndDataXferMode                                       (-200218)
...
#define DAQmerrorswitchCannotDriveMultipleTrigLines                                    (-200203)
#define DAQmxErrorInvalidRelayName                                                      (-200202)
#define DAQmerrorswitchScanlistTooBig                                                  (-200201)
#define DAQmerrorswitchChanInUse                                                       (-200200)
#define DAQmerrorswitchNotResetBeforeScan                                              (-200199)
...
#define DAQmerrorswitchOperationNotSupported                                           (-200193)
#define DAQmxErrorOnlyContinuousScanSupported                                           (-200192)
#define DAQmerrorswitchDifferentTopologyWhenScanning                                   (-200191)
...
#define DAQmerrorswitchDifferentSettlingTimeWhenScanning                               (-200178)
...
#define DAQmerrorsensorInvalidCompletionResistance                                     (-200163)
...
#define DAQmerrorsuitableTimebaseNotFoundTimeCombo                                     (-200137)
#define DAQmerrorsuitableTimebaseNotFoundFrequencyCombo                                (-200136)
...
#define DAQmerrorsCXIModuleIncorrect                                                   (-200107)
#define DAQmxErrorAttributeInconsistentAcrossChannelsOnDevice                           (-200106)
#define DAQmerrorsCXI1122ResistanceChanNotSupportedForCfg                              (-200105)
...
#define DAQmerrorsampleRateNumChansConvertPeriodCombo                                  (-200081)
...
#define DAQmerrorsuppliedCurrentDataOutsideSpecifiedRange                              (-200076)
#define DAQmerrorsuppliedVoltageDataOutsideSpecifiedRange                              (-200075)
#define DAQmxErrorCannotStoreCalConst                                                   (-200074)
#define DAQmerrorsCXIModuleNotFound                                                    (-200073)
...
#define DAQmerrorscanListCannotBeTimed                                                 (-200067)
...
#define DAQmerrorsemicolonDoesNotFollowRangeInList                                     (-200054)
#define DAQmerrorswitchActionInListSpansMultipleDevices                                (-200053)
...
#define DAQmerrorsubsetStartOffsetNotAlignedInScript                                   (-200033)
#define DAQmxErrorInvalidSubsetLengthInScript                                           (-200032)
#define DAQmxErrorMarkerPositionNotAlignedInScript                                      (-200031)
#define DAQmerrorsubsetOutsideWaveformInScript                                         (-200030)
...
#define DAQmerrorscriptHasInvalidIdentifier                                            (-200024)
#define DAQmerrorscriptHasInvalidCharacter                                             (-200023)
#define DAQmxErrorResourceAlreadyReserved                                               (-200022)
#define DAQmerrorselfTestFailed                                                        (-200020)
...
#define DAQmerrorsCXISerialCommunication                                               (-200015)
...
#define DAQmerrorstopTriggerHasNotOccurred                                             (-200008)
...
#define DAQmerrorserviceLocatorNotAvailable_Routing                                     (-88907)
