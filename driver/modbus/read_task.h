...
struct Reader {
    ...
    [[nodiscard]] virtual std::vector<synnax::channel::Channel::Channel> sy_channels() const = 0;
};
...
struct BaseReader : Reader {
    ...
    [[nodiscard]] std::vector<synnax::channel::Channel::Channel> sy_channels() const override {
        std::vector<synnax::channel::Channel::Channel> result;
...
struct ReadTaskConfig : driver::task::common::BaseReadTaskConfig {
    ...
    [[nodiscard]] std::vector<synnax::channel::Channel::Channel> data_channels() const {
        std::vector<synnax::channel::Channel::Channel> result;
