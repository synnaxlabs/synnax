    ...
    static ServerConfig create_default() {
        ...
        cfg.test_nodes = {
            {1,
             ...
             bool_val,
             "Test Boolean Node"},
            {1, "TestUInt16", &UA_TYPES[UA_TYPES_UINT16], uint16_val, "Test UInt16 Node"},
            {1, "TestUInt32", &UA_TYPES[UA_TYPES_UINT32], uint32_val, "Test UInt32 Node"},
            {1, "TestUInt64", &UA_TYPES[UA_TYPES_UINT64], uint64_val, "Test UInt64 Node"},
            ...
            {1, "TestDouble", &UA_TYPES[UA_TYPES_DOUBLE], double_val, "Test Double Node"},
