...
TEST(NodeTest, ParseStringNodeId) {
    ...
    EXPECT_EQ(std::string(reinterpret_cast<char*>(nodeId.identifier.string.data), 
...
TEST(NodeTest, ParseGuidNodeId) {
    xjson::Parser parser(std::string(R"({"nodeId": "NS=3;G=12345678-1234-5678-9ABC-123456789ABC"})"));
