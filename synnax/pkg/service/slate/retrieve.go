...
// Entry binds the given slate to the query. This pointer is where the results of the
// query will be stored after Exec is called.
func (r Retrieve) Entry(slate *Slate) Retrieve {
	r.gorp = r.gorp.Entry(slate)
	return r
}
...
func (r Retrieve) Entries(slates *[]Slate) Retrieve {
