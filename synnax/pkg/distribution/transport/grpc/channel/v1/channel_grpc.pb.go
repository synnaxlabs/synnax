...
const (
	ChannelService_Exec_FullMethodName = "/channel.v1.ChannelService/Exec"
)
...
func (c *channelServiceClient) Exec(ctx context.Context, in *CreateMessage, opts ...grpc.CallOption) (*CreateMessage, error) {
	...
	err := c.cc.Invoke(ctx, ChannelService_Exec_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ChannelService_Exec_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChannelService_Exec_FullMethodName,
	}
