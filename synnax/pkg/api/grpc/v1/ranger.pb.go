...
const file_synnax_pkg_api_grpc_v1_ranger_proto_rawDesc = "" +
	"\n" +
	"#synnax/pkg/api/grpc/v1/ranger.proto\x12\x06api.v1\x1a\x1bgoogle/protobuf/empty.proto\x1a\x16x/go/telem/telem.proto\"\xad\x01\n" +
