...
var file_synnax_pkg_api_grpc_v1_connectivity_proto_rawDesc = string([]byte{
...
var (
	...
	file_synnax_pkg_api_grpc_v1_connectivity_proto_rawDescData []byte
)
...
func file_synnax_pkg_api_grpc_v1_connectivity_proto_rawDescGZIP() []byte {
	file_synnax_pkg_api_grpc_v1_connectivity_proto_rawDescOnce.Do(func() {
		file_synnax_pkg_api_grpc_v1_connectivity_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_synnax_pkg_api_grpc_v1_connectivity_proto_rawDesc), len(file_synnax_pkg_api_grpc_v1_connectivity_proto_rawDesc)))
	})
...
func file_synnax_pkg_api_grpc_v1_connectivity_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_synnax_pkg_api_grpc_v1_connectivity_proto_rawDesc), len(file_synnax_pkg_api_grpc_v1_connectivity_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
