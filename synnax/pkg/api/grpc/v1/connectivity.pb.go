...
const file_synnax_pkg_api_grpc_v1_connectivity_proto_rawDesc = "" +
	"\n" +
	")synnax/pkg/api/grpc/v1/connectivity.proto\x12\x06api.v1\x1a\x1bgoogle/protobuf/empty.proto\"_\n" +
