...
extern ControlSubjectDefaultTypeInternal _ControlSubject_default_instance_;
class Frame;
...
class FrameWriterConfig final :
 ...
 public:
  ...
  enum : int {
    kKeysFieldNumber = 1,
    kAuthoritiesFieldNumber = 2,
    kControlSubjectFieldNumber = 4,
    kStartFieldNumber = 3,
  };
  // repeated uint32 keys = 1 [json_name = "keys"];
  int keys_size() const;
  ...
  ::uint32_t authorities(int index) const;
  void set_authorities(int index, ::uint32_t value);
  void add_authorities(::uint32_t value);
  const ::google::protobuf::RepeatedField<::uint32_t>& authorities() const;
  ::google::protobuf::RepeatedField<::uint32_t>* mutable_authorities();

  private:
  const ::google::protobuf::RepeatedField<::uint32_t>& _internal_authorities() const;
  ::google::protobuf::RepeatedField<::uint32_t>* _internal_mutable_authorities();

  public:
  // .api.v1.ControlSubject control_subject = 4 [json_name = "controlSubject"];
  bool has_control_subject() const;
  void clear_control_subject() ;
  const ::api::v1::ControlSubject& control_subject() const;
  PROTOBUF_NODISCARD ::api::v1::ControlSubject* release_control_subject();
  ::api::v1::ControlSubject* mutable_control_subject();
  void set_allocated_control_subject(::api::v1::ControlSubject* value);
  void unsafe_arena_set_allocated_control_subject(::api::v1::ControlSubject* value);
  ::api::v1::ControlSubject* unsafe_arena_release_control_subject();

  private:
  const ::api::v1::ControlSubject& _internal_control_subject() const;
  ::api::v1::ControlSubject* _internal_mutable_control_subject();
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::google::protobuf::RepeatedField<::uint32_t> keys_;
    mutable ::google::protobuf::internal::CachedSize _keys_cached_byte_size_;
    ::google::protobuf::RepeatedField<::uint32_t> authorities_;
    mutable ::google::protobuf::internal::CachedSize _authorities_cached_byte_size_;
    ::api::v1::ControlSubject* control_subject_;
    ::int64_t start_;
    PROTOBUF_TSAN_DECLARE_MEMBER
  };
  union { Impl_ _impl_; };
...
class ControlSubject final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:api.v1.ControlSubject) */ {
 public:
  inline ControlSubject() : ControlSubject(nullptr) {}
  ~ControlSubject() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR ControlSubject(::google::protobuf::internal::ConstantInitialized);

  ControlSubject(const ControlSubject& from);
  ControlSubject(ControlSubject&& from) noexcept
    : ControlSubject() {
    *this = ::std::move(from);
  }

  inline ControlSubject& operator=(const ControlSubject& from) {
    CopyFrom(from);
    return *this;
  }
  inline ControlSubject& operator=(ControlSubject&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const ControlSubject& default_instance() {
    return *internal_default_instance();
  }
  static inline const ControlSubject* internal_default_instance() {
    return reinterpret_cast<const ControlSubject*>(
               &_ControlSubject_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    4;

  friend void swap(ControlSubject& a, ControlSubject& b) {
    a.Swap(&b);
  }
  inline void Swap(ControlSubject* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(ControlSubject* other) {
    if (other == this) return;
    ABSL_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  ControlSubject* New(::google::protobuf::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<ControlSubject>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const ControlSubject& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom( const ControlSubject& from) {
    ControlSubject::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ControlSubject* other);

  private:
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "api.v1.ControlSubject";
  }
  protected:
  explicit ControlSubject(::google::protobuf::Arena* arena);
  public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:api.v1.ControlSubject)
 private:
  class _Internal;
...
// repeated uint32 authorities = 2 [json_name = "authorities"];
inline int FrameWriterConfig::_internal_authorities_size() const {
  return _internal_authorities().size();
}
inline int FrameWriterConfig::authorities_size() const {
  return _internal_authorities_size();
}
inline void FrameWriterConfig::clear_authorities() {
  _internal_mutable_authorities()->Clear();
}
inline ::uint32_t FrameWriterConfig::authorities(int index) const {
  // @@protoc_insertion_point(field_get:api.v1.FrameWriterConfig.authorities)
  return _internal_authorities().Get(index);
}
inline void FrameWriterConfig::set_authorities(int index, ::uint32_t value) {
  _internal_mutable_authorities()->Set(index, value);
  // @@protoc_insertion_point(field_set:api.v1.FrameWriterConfig.authorities)
}
inline void FrameWriterConfig::add_authorities(::uint32_t value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_authorities()->Add(value);
  // @@protoc_insertion_point(field_add:api.v1.FrameWriterConfig.authorities)
}
inline const ::google::protobuf::RepeatedField<::uint32_t>& FrameWriterConfig::authorities() const {
  // @@protoc_insertion_point(field_list:api.v1.FrameWriterConfig.authorities)
  return _internal_authorities();
}
inline ::google::protobuf::RepeatedField<::uint32_t>* FrameWriterConfig::mutable_authorities() {
  // @@protoc_insertion_point(field_mutable_list:api.v1.FrameWriterConfig.authorities)
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  return _internal_mutable_authorities();
}

inline const ::google::protobuf::RepeatedField<::uint32_t>& FrameWriterConfig::_internal_authorities() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.authorities_;
}
inline ::google::protobuf::RepeatedField<::uint32_t>* FrameWriterConfig::_internal_mutable_authorities() {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return &_impl_.authorities_;
}
...
// .api.v1.ControlSubject control_subject = 4 [json_name = "controlSubject"];
inline bool FrameWriterConfig::has_control_subject() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.control_subject_ != nullptr);
  return value;
}
inline void FrameWriterConfig::clear_control_subject() {
  if (_impl_.control_subject_ != nullptr) _impl_.control_subject_->Clear();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const ::api::v1::ControlSubject& FrameWriterConfig::_internal_control_subject() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  const ::api::v1::ControlSubject* p = _impl_.control_subject_;
  return p != nullptr ? *p : reinterpret_cast<const ::api::v1::ControlSubject&>(::api::v1::_ControlSubject_default_instance_);
}
inline const ::api::v1::ControlSubject& FrameWriterConfig::control_subject() const {
  // @@protoc_insertion_point(field_get:api.v1.FrameWriterConfig.control_subject)
  return _internal_control_subject();
}
inline void FrameWriterConfig::unsafe_arena_set_allocated_control_subject(::api::v1::ControlSubject* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.control_subject_);
  }
  _impl_.control_subject_ = reinterpret_cast<::api::v1::ControlSubject*>(value);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:api.v1.FrameWriterConfig.control_subject)
}
inline ::api::v1::ControlSubject* FrameWriterConfig::release_control_subject() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);

  _impl_._has_bits_[0] &= ~0x00000001u;
  ::api::v1::ControlSubject* released = _impl_.control_subject_;
  _impl_.control_subject_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old = reinterpret_cast<::google::protobuf::MessageLite*>(released);
  released = ::google::protobuf::internal::DuplicateIfNonNull(released);
  if (GetArenaForAllocation() == nullptr) {
...
inline ::api::v1::ControlSubject* FrameWriterConfig::unsafe_arena_release_control_subject() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:api.v1.FrameWriterConfig.control_subject)

  _impl_._has_bits_[0] &= ~0x00000001u;
  ::api::v1::ControlSubject* temp = _impl_.control_subject_;
  _impl_.control_subject_ = nullptr;
  return temp;
}
inline ::api::v1::ControlSubject* FrameWriterConfig::_internal_mutable_control_subject() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_._has_bits_[0] |= 0x00000001u;
  if (_impl_.control_subject_ == nullptr) {
    auto* p = CreateMaybeMessage<::api::v1::ControlSubject>(GetArenaForAllocation());
    _impl_.control_subject_ = reinterpret_cast<::api::v1::ControlSubject*>(p);
  }
  return _impl_.control_subject_;
}
inline ::api::v1::ControlSubject* FrameWriterConfig::mutable_control_subject() {
  ::api::v1::ControlSubject* _msg = _internal_mutable_control_subject();
  // @@protoc_insertion_point(field_mutable:api.v1.FrameWriterConfig.control_subject)
  return _msg;
}
inline void FrameWriterConfig::set_allocated_control_subject(::api::v1::ControlSubject* value) {
  ::google::protobuf::Arena* message_arena = GetArenaForAllocation();
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::api::v1::ControlSubject*>(_impl_.control_subject_);
  }

  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena =
        ::google::protobuf::Arena::InternalGetOwningArena(reinterpret_cast<::api::v1::ControlSubject*>(value));
    if (message_arena != submessage_arena) {
      value = ::google::protobuf::internal::GetOwnedMessage(message_arena, value, submessage_arena);
    }
    _impl_._has_bits_[0] |= 0x00000001u;
  ...
  _impl_.control_subject_ = reinterpret_cast<::api::v1::ControlSubject*>(value);
  // @@protoc_insertion_point(field_set_allocated:api.v1.FrameWriterConfig.control_subject)
}
...
// string key = 1 [json_name = "key"];
inline void ControlSubject::clear_key() {
  _impl_.key_.ClearToEmpty();
}
inline const std::string& ControlSubject::key() const {
  // @@protoc_insertion_point(field_get:api.v1.ControlSubject.key)
  return _internal_key();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void ControlSubject::set_key(Arg_&& arg,
                                                     Args_... args) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.key_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:api.v1.ControlSubject.key)
}
inline std::string* ControlSubject::mutable_key() {
  std::string* _s = _internal_mutable_key();
  // @@protoc_insertion_point(field_mutable:api.v1.ControlSubject.key)
  return _s;
}
inline const std::string& ControlSubject::_internal_key() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.key_.Get();
}
inline void ControlSubject::_internal_set_key(const std::string& value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.key_.Set(value, GetArenaForAllocation());
}
inline std::string* ControlSubject::_internal_mutable_key() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  return _impl_.key_.Mutable( GetArenaForAllocation());
}
inline std::string* ControlSubject::release_key() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:api.v1.ControlSubject.key)
  return _impl_.key_.Release();
}
inline void ControlSubject::set_allocated_key(std::string* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ...
  // @@protoc_insertion_point(field_set_allocated:api.v1.ControlSubject.key)
}

// string name = 2 [json_name = "name"];
inline void ControlSubject::clear_name() {
  _impl_.name_.ClearToEmpty();
}
inline const std::string& ControlSubject::name() const {
  // @@protoc_insertion_point(field_get:api.v1.ControlSubject.name)
  return _internal_name();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void ControlSubject::set_name(Arg_&& arg,
                                                     Args_... args) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.name_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:api.v1.ControlSubject.name)
}
inline std::string* ControlSubject::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:api.v1.ControlSubject.name)
  return _s;
}
inline const std::string& ControlSubject::_internal_name() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.name_.Get();
}
inline void ControlSubject::_internal_set_name(const std::string& value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.name_.Set(value, GetArenaForAllocation());
}
inline std::string* ControlSubject::_internal_mutable_name() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  return _impl_.name_.Mutable( GetArenaForAllocation());
}
inline std::string* ControlSubject::release_name() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:api.v1.ControlSubject.name)
  return _impl_.name_.Release();
}
inline void ControlSubject::set_allocated_name(std::string* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:api.v1.ControlSubject.name)
}
