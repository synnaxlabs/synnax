...
var RangeCreateService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "synnax/pkg/api/grpc/v1/ranger.proto",
}
...
const (
	RangeSetActiveService_Exec_FullMethodName = "/api.v1.RangeSetActiveService/Exec"
)

// RangeSetActiveServiceClient is the client API for RangeSetActiveService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type RangeSetActiveServiceClient interface {
	Exec(ctx context.Context, in *RangeSetActiveRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}

type rangeSetActiveServiceClient struct {
	cc grpc.ClientConnInterface
}

func NewRangeSetActiveServiceClient(cc grpc.ClientConnInterface) RangeSetActiveServiceClient {
	return &rangeSetActiveServiceClient{cc}
}

func (c *rangeSetActiveServiceClient) Exec(ctx context.Context, in *RangeSetActiveRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, RangeSetActiveService_Exec_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// RangeSetActiveServiceServer is the server API for RangeSetActiveService service.
// All implementations should embed UnimplementedRangeSetActiveServiceServer
// for forward compatibility
type RangeSetActiveServiceServer interface {
	Exec(context.Context, *RangeSetActiveRequest) (*emptypb.Empty, error)
}

// UnimplementedRangeSetActiveServiceServer should be embedded to have forward compatible implementations.
type UnimplementedRangeSetActiveServiceServer struct {
}

func (UnimplementedRangeSetActiveServiceServer) Exec(context.Context, *RangeSetActiveRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Exec not implemented")
}

// UnsafeRangeSetActiveServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to RangeSetActiveServiceServer will
// result in compilation errors.
type UnsafeRangeSetActiveServiceServer interface {
	mustEmbedUnimplementedRangeSetActiveServiceServer()
}

func RegisterRangeSetActiveServiceServer(s grpc.ServiceRegistrar, srv RangeSetActiveServiceServer) {
	s.RegisterService(&RangeSetActiveService_ServiceDesc, srv)
}

func _RangeSetActiveService_Exec_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RangeSetActiveRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RangeSetActiveServiceServer).Exec(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RangeSetActiveService_Exec_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RangeSetActiveServiceServer).Exec(ctx, req.(*RangeSetActiveRequest))
	}
	return interceptor(ctx, in, info, handler)
}

// RangeSetActiveService_ServiceDesc is the grpc.ServiceDesc for RangeSetActiveService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var RangeSetActiveService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.v1.RangeSetActiveService",
	HandlerType: (*RangeSetActiveServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Exec",
			Handler:    _RangeSetActiveService_Exec_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "synnax/pkg/api/grpc/v1/ranger.proto",
...
const (
	RangeRetrieveActiveService_Exec_FullMethodName = "/api.v1.RangeRetrieveActiveService/Exec"
)

// RangeRetrieveActiveServiceClient is the client API for RangeRetrieveActiveService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type RangeRetrieveActiveServiceClient interface {
	Exec(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*RangeRetrieveActiveResponse, error)
}

type rangeRetrieveActiveServiceClient struct {
	cc grpc.ClientConnInterface
}

func NewRangeRetrieveActiveServiceClient(cc grpc.ClientConnInterface) RangeRetrieveActiveServiceClient {
	return &rangeRetrieveActiveServiceClient{cc}
}

func (c *rangeRetrieveActiveServiceClient) Exec(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*RangeRetrieveActiveResponse, error) {
	out := new(RangeRetrieveActiveResponse)
	err := c.cc.Invoke(ctx, RangeRetrieveActiveService_Exec_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// RangeRetrieveActiveServiceServer is the server API for RangeRetrieveActiveService service.
// All implementations should embed UnimplementedRangeRetrieveActiveServiceServer
// for forward compatibility
type RangeRetrieveActiveServiceServer interface {
	Exec(context.Context, *emptypb.Empty) (*RangeRetrieveActiveResponse, error)
}

// UnimplementedRangeRetrieveActiveServiceServer should be embedded to have forward compatible implementations.
type UnimplementedRangeRetrieveActiveServiceServer struct {
}

func (UnimplementedRangeRetrieveActiveServiceServer) Exec(context.Context, *emptypb.Empty) (*RangeRetrieveActiveResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Exec not implemented")
}

// UnsafeRangeRetrieveActiveServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to RangeRetrieveActiveServiceServer will
// result in compilation errors.
type UnsafeRangeRetrieveActiveServiceServer interface {
	mustEmbedUnimplementedRangeRetrieveActiveServiceServer()
}

func RegisterRangeRetrieveActiveServiceServer(s grpc.ServiceRegistrar, srv RangeRetrieveActiveServiceServer) {
	s.RegisterService(&RangeRetrieveActiveService_ServiceDesc, srv)
}

func _RangeRetrieveActiveService_Exec_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RangeRetrieveActiveServiceServer).Exec(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RangeRetrieveActiveService_Exec_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RangeRetrieveActiveServiceServer).Exec(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}

// RangeRetrieveActiveService_ServiceDesc is the grpc.ServiceDesc for RangeRetrieveActiveService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var RangeRetrieveActiveService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.v1.RangeRetrieveActiveService",
	HandlerType: (*RangeRetrieveActiveServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Exec",
			Handler:    _RangeRetrieveActiveService_Exec_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "synnax/pkg/api/grpc/v1/ranger.proto",
...
const (
	RangeClearActiveService_Exec_FullMethodName = "/api.v1.RangeClearActiveService/Exec"
)

// RangeClearActiveServiceClient is the client API for RangeClearActiveService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type RangeClearActiveServiceClient interface {
	Exec(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error)
}

type rangeClearActiveServiceClient struct {
	cc grpc.ClientConnInterface
}

func NewRangeClearActiveServiceClient(cc grpc.ClientConnInterface) RangeClearActiveServiceClient {
	return &rangeClearActiveServiceClient{cc}
}

func (c *rangeClearActiveServiceClient) Exec(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, RangeClearActiveService_Exec_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// RangeClearActiveServiceServer is the server API for RangeClearActiveService service.
// All implementations should embed UnimplementedRangeClearActiveServiceServer
// for forward compatibility
type RangeClearActiveServiceServer interface {
	Exec(context.Context, *emptypb.Empty) (*emptypb.Empty, error)
}

// UnimplementedRangeClearActiveServiceServer should be embedded to have forward compatible implementations.
type UnimplementedRangeClearActiveServiceServer struct {
}

func (UnimplementedRangeClearActiveServiceServer) Exec(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Exec not implemented")
}

// UnsafeRangeClearActiveServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to RangeClearActiveServiceServer will
// result in compilation errors.
type UnsafeRangeClearActiveServiceServer interface {
	mustEmbedUnimplementedRangeClearActiveServiceServer()
}

func RegisterRangeClearActiveServiceServer(s grpc.ServiceRegistrar, srv RangeClearActiveServiceServer) {
	s.RegisterService(&RangeClearActiveService_ServiceDesc, srv)
}

func _RangeClearActiveService_Exec_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RangeClearActiveServiceServer).Exec(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RangeClearActiveService_Exec_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RangeClearActiveServiceServer).Exec(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}

// RangeClearActiveService_ServiceDesc is the grpc.ServiceDesc for RangeClearActiveService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var RangeClearActiveService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.v1.RangeClearActiveService",
	HandlerType: (*RangeClearActiveServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Exec",
			Handler:    _RangeClearActiveService_Exec_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "synnax/pkg/api/grpc/v1/ranger.proto",
