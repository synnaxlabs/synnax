...
func (c *channelRetrieveServiceClient) Exec(ctx context.Context, in *ChannelRetrieveRequest, opts ...grpc.CallOption) (*ChannelRetrieveResponse, error) {
	...
	err := c.cc.Invoke(ctx, ChannelRetrieveService_Exec_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedChannelRetrieveServiceServer should be embedded to have forward compatible implementations.
