...
export default function Plot() {
  ...
  useEffect(() => {
    ...
    const f = async () => {
      ...
      const d = await client.data.read("1-1", 0, TimeSpan.Second(1000000));
      // @ts-ignore
    ...
    opts.width = plotREf.current.getBoundingClientRect().width - 100;
  ...
  return (
       <Space empty direction="horizontal" >
          ...
          <Space empty direction="vertical" style={{ flexGrow: 1}} align="stretch" >
              <Header size="h3" text="Cluster Overview" />
