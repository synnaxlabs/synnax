...
/**
 * Docs `console/ranges/palette-create`: run "Create range" from the palette,
 * name the range in the dialog (From/To arrive pre-filled), and save it to
 * the core.
 */
