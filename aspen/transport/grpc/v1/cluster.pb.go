...
var file_aspen_transport_grpc_v1_cluster_proto_rawDesc = []byte{
...
var (
	...
	file_aspen_transport_grpc_v1_cluster_proto_rawDescData = file_aspen_transport_grpc_v1_cluster_proto_rawDesc
)
...
func file_aspen_transport_grpc_v1_cluster_proto_rawDescGZIP() []byte {
	file_aspen_transport_grpc_v1_cluster_proto_rawDescOnce.Do(func() {
		file_aspen_transport_grpc_v1_cluster_proto_rawDescData = protoimpl.X.CompressGZIP(file_aspen_transport_grpc_v1_cluster_proto_rawDescData)
	})
...
var file_aspen_transport_grpc_v1_cluster_proto_goTypes = []interface{}{
...
var file_aspen_transport_grpc_v1_cluster_proto_deschematicxs = []int32{
...
func file_aspen_transport_grpc_v1_cluster_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_aspen_transport_grpc_v1_cluster_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Node); i {
			case 0:
				return &v.state
			case 1:
		...
		file_aspen_transport_grpc_v1_cluster_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_aspen_transport_grpc_v1_cluster_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_aspen_transport_grpc_v1_cluster_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_aspen_transport_grpc_v1_cluster_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_aspen_transport_grpc_v1_cluster_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   2,
		...
		DependencyIndexes: file_aspen_transport_grpc_v1_cluster_proto_deschematicxs,
		MessageInfos:      file_aspen_transport_grpc_v1_cluster_proto_msgTypes,
	}.Build()
	File_aspen_transport_grpc_v1_cluster_proto = out.File
	file_aspen_transport_grpc_v1_cluster_proto_rawDesc = nil
	file_aspen_transport_grpc_v1_cluster_proto_goTypes = nil
	file_aspen_transport_grpc_v1_cluster_proto_deschematicxs = nil
}
