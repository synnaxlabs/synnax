...
type ArcParserVisitor interface {
	...
	// Visit a parse tree produced by ArcParser#configParameter.
	...
	// Visit a parse tree produced by ArcParser#channelIdentifier.
	VisitChannelIdentifier(ctx *ChannelIdentifierContext) interface{}

	// Visit a parse tree produced by ArcParser#stageInvocation.
	VisitStageInvocation(ctx *StageInvocationContext) interface{}
	...
	// Visit a parse tree produced by ArcParser#blockingRead.
	...
	// Visit a parse tree produced by ArcParser#blockingReadExpr.
