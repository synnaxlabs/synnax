...
func (v *BaseArcParserVisitor) VisitConfigParameter(ctx *ConfigParameterContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseArcParserVisitor) VisitChannelIdentifier(ctx *ChannelIdentifierContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseArcParserVisitor) VisitStageInvocation(ctx *StageInvocationContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseArcParserVisitor) VisitBlockingRead(ctx *BlockingReadContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseArcParserVisitor) VisitBlockingReadExpr(ctx *BlockingReadExprContext) interface{} {
	return v.VisitChildren(ctx)
}
