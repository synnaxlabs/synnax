...
type Bindings struct {
	...
	MathIntPowU8      func(context.Context, uint8, uint8) uint8
	MathIntPowU16     func(context.Context, uint16, uint16) uint16
	MathIntPowU32     func(context.Context, uint32, uint32) uint32
	MathIntPowU64     func(context.Context, uint64, uint64) uint64
	MathIntPowI8      func(context.Context, int8, int8) int8
	MathIntPowI16     func(context.Context, int16, int16) int16
	MathIntPowI32     func(context.Context, int32, int32) int32
	MathIntPowI64     func(context.Context, int64, int64) int64
...
func (b *Bindings) setDefaultStubs() {
	...
	if b.MathIntPowU8 == nil {
		b.MathIntPowU8 = func(ctx context.Context, base, exp uint8) uint8 {
			panic("math_int_pow_u8() not implemented")
		}
	}
	if b.MathIntPowU16 == nil {
		b.MathIntPowU16 = func(ctx context.Context, base, exp uint16) uint16 {
			panic("math_int_pow_u16() not implemented")
		}
	}
	if b.MathIntPowU32 == nil {
		b.MathIntPowU32 = func(ctx context.Context, base, exp uint32) uint32 {
			panic("math_int_pow_u32() not implemented")
		}
	}
	if b.MathIntPowU64 == nil {
		b.MathIntPowU64 = func(ctx context.Context, base, exp uint64) uint64 {
			panic("math_int_pow_u64() not implemented")
		}
	}
	if b.MathIntPowI8 == nil {
		b.MathIntPowI8 = func(ctx context.Context, base, exp int8) int8 {
			panic("math_int_pow_i8() not implemented")
		}
	}
	if b.MathIntPowI16 == nil {
		b.MathIntPowI16 = func(ctx context.Context, base, exp int16) int16 {
			panic("math_int_pow_i16() not implemented")
		}
	}
	if b.MathIntPowI32 == nil {
		b.MathIntPowI32 = func(ctx context.Context, base, exp int32) int32 {
			panic("math_int_pow_i32() not implemented")
		}
	}
	if b.MathIntPowI64 == nil {
		b.MathIntPowI64 = func(ctx context.Context, base, exp int64) int64 {
...
func (b *Bindings) Bind(ctx context.Context, rt wazero.Runtime) error {
	...
	hostBuilder.NewFunctionBuilder().WithFunc(b.wrapMathIntPowU8()).Export("math_int_pow_u8")
	hostBuilder.NewFunctionBuilder().WithFunc(b.wrapMathIntPowU16()).Export("math_int_pow_u16")
	hostBuilder.NewFunctionBuilder().WithFunc(b.wrapMathIntPowU32()).Export("math_int_pow_u32")
	hostBuilder.NewFunctionBuilder().WithFunc(b.wrapMathIntPowU64()).Export("math_int_pow_u64")
	hostBuilder.NewFunctionBuilder().WithFunc(b.wrapMathIntPowI8()).Export("math_int_pow_i8")
	hostBuilder.NewFunctionBuilder().WithFunc(b.wrapMathIntPowI16()).Export("math_int_pow_i16")
	hostBuilder.NewFunctionBuilder().WithFunc(b.wrapMathIntPowI32()).Export("math_int_pow_i32")
	hostBuilder.NewFunctionBuilder().WithFunc(b.wrapMathIntPowI64()).Export("math_int_pow_i64")
...
func (b *Bindings) wrapMathIntPowU8() func(context.Context, uint32, uint32) uint32 {
	return func(ctx context.Context, base uint32, exp uint32) uint32 {
		result := b.MathIntPowU8(ctx, uint8(base), uint8(exp))
		return uint32(result)
	}
}

func (b *Bindings) wrapMathIntPowU16() func(context.Context, uint32, uint32) uint32 {
	return func(ctx context.Context, base uint32, exp uint32) uint32 {
		result := b.MathIntPowU16(ctx, uint16(base), uint16(exp))
		return uint32(result)
	}
}

func (b *Bindings) wrapMathIntPowU32() func(context.Context, uint32, uint32) uint32 {
	return func(ctx context.Context, base uint32, exp uint32) uint32 {
		result := b.MathIntPowU32(ctx, uint32(base), uint32(exp))
		return uint32(result)
	}
}

func (b *Bindings) wrapMathIntPowU64() func(context.Context, uint64, uint64) uint64 {
	return func(ctx context.Context, base uint64, exp uint64) uint64 {
		result := b.MathIntPowU64(ctx, uint64(base), uint64(exp))
		return uint64(result)
	}
}

func (b *Bindings) wrapMathIntPowI8() func(context.Context, uint32, uint32) uint32 {
	return func(ctx context.Context, base uint32, exp uint32) uint32 {
		result := b.MathIntPowI8(ctx, int8(base), int8(exp))
		return uint32(result)
	}
}

func (b *Bindings) wrapMathIntPowI16() func(context.Context, uint32, uint32) uint32 {
	return func(ctx context.Context, base uint32, exp uint32) uint32 {
		result := b.MathIntPowI16(ctx, int16(base), int16(exp))
		return uint32(result)
	}
}

func (b *Bindings) wrapMathIntPowI32() func(context.Context, uint32, uint32) uint32 {
	return func(ctx context.Context, base uint32, exp uint32) uint32 {
		result := b.MathIntPowI32(ctx, int32(base), int32(exp))
		return uint32(result)
	}
}

func (b *Bindings) wrapMathIntPowI64() func(context.Context, uint64, uint64) uint64 {
	return func(ctx context.Context, base uint64, exp uint64) uint64 {
		result := b.MathIntPowI64(ctx, int64(base), int64(exp))
		return uint64(result)
	}
}
