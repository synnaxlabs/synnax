...
inline std::pair<Module, x::errors::Error> Module::from_proto(
    const ::arc::module::pb::Module& pb
) {
    Module cpp;
    if (auto err = x::pb::from_proto_repeated<::arc::ir::Function>(cpp.functions, pb.functions())) return {{}, err};
    if (auto err = x::pb::from_proto_repeated<::arc::ir::Node>(cpp.nodes, pb.nodes())) return {{}, err};
    ...
    if (auto err = x::pb::from_proto_repeated<::arc::ir::Sequence>(cpp.sequences, pb.sequences())) return {{}, err};
    {
