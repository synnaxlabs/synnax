...
type Graph struct {
	...
	Functions irv54.Functions `json:"functions" msgpack:"functions"`
	// Edges contains dataflow connections between node parameters.
	Edges irv54.Edges `json:"edges" msgpack:"edges"`
...
type Viewport struct {
	...
	Position spatialv54.XY `json:"position" msgpack:"position"`
