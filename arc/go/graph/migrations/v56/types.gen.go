...
type Graph struct {
	...
	Functions irv56.Functions `json:"functions" msgpack:"functions"`
	// Edges contains dataflow connections between node parameters.
	Edges irv56.Edges `json:"edges" msgpack:"edges"`
...
type Viewport struct {
	...
	Position spatialv56.XY `json:"position" msgpack:"position"`
