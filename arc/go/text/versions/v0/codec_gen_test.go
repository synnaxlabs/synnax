...
import (
	...
	"github.com/synnaxlabs/arc/text/versions/v0"
...
var _ = Describe("Codec", func() {
	Describe("Text", func() {
		DescribeTable("should round-trip encode and decode",
			...
			Entry("fully populated", v0.Text{Raw: "test_1"}),
			Entry("zero values", v0.Text{Raw: ""}),
		)
	})
})

func BenchmarkEncodeDecodeText(b *testing.B) {
	seed := v0.Text{Raw: "test_1"}
	w := orc.NewWriter(0)
	r := orc.NewReader(nil)
	for b.Loop() {
		w.Reset()
