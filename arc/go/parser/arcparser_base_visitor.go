...
func (v *BaseArcParserVisitor) VisitMatchBlock(ctx *MatchBlockContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseArcParserVisitor) VisitMatchEntry(ctx *MatchEntryContext) interface{} {
	return v.VisitChildren(ctx)
}
