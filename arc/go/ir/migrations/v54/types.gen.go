...
type Function struct {
	...
	Config typesv54.Params `json:"config" msgpack:"config"`
	// Inputs contains input parameter definitions.
	Inputs typesv54.Params `json:"inputs" msgpack:"inputs"`
	// Outputs contains output parameter definitions.
	Outputs typesv54.Params `json:"outputs" msgpack:"outputs"`
	// Channels contains channel read/write declarations.
	Channels typesv54.Channels `json:"channels" msgpack:"channels"`
}
