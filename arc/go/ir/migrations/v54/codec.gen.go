...
func (f *Function) DecodeOrc(r *orc.Reader) error {
	...
	}
	{
		...
		if present {
			...
			f.Config = make([]typesv54.Param, n)
			for j := range f.Config {
	...
	}
	{
		...
		if present {
			...
			f.Inputs = make([]typesv54.Param, n)
			for j := range f.Inputs {
	...
	}
	{
		...
		if present {
			...
			f.Outputs = make([]typesv54.Param, n)
			for j := range f.Outputs {
...
func (nv *Node) DecodeOrc(r *orc.Reader) error {
	...
	}
	{
		...
		if present {
			...
			nv.Config = make([]typesv54.Param, n)
			for j := range nv.Config {
	...
	}
	{
		...
		if present {
			...
			nv.Inputs = make([]typesv54.Param, n)
			for j := range nv.Inputs {
	...
	}
	{
		...
		if present {
			...
			nv.Outputs = make([]typesv54.Param, n)
			for j := range nv.Outputs {
