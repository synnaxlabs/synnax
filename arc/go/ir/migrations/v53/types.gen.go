...
type Function struct {
	...
	Config typesv53.Params `json:"config" msgpack:"config"`
	// Inputs contains input parameter definitions.
	Inputs typesv53.Params `json:"inputs" msgpack:"inputs"`
	// Outputs contains output parameter definitions.
	Outputs typesv53.Params `json:"outputs" msgpack:"outputs"`
	// Channels contains channel read/write declarations.
	Channels typesv53.Channels `json:"channels" msgpack:"channels"`
}
