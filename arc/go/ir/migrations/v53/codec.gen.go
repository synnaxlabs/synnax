...
func EncodeFunction(w *xbinary.Writer, s *Function) error {
	...
	if s.Config != nil {
		...
		for j := range s.Config {
			if err := typesv53.EncodeParam(w, &s.Config[j]); err != nil {
				return err
			}
		}
	} else {
	...
	if s.Inputs != nil {
		...
		for j := range s.Inputs {
			if err := typesv53.EncodeParam(w, &s.Inputs[j]); err != nil {
				return err
			}
		}
	} else {
	...
	if s.Outputs != nil {
		...
		for j := range s.Outputs {
			if err := typesv53.EncodeParam(w, &s.Outputs[j]); err != nil {
				return err
			}
		}
	} else {
	...
	if err := typesv53.EncodeChannels(w, &s.Channels); err != nil {
		return err
	}
	return nil
}
...
func DecodeFunction(r *xbinary.Reader, s *Function) error {
		...
		if present {
			{
				...
				s.Config = make([]typesv53.Param, n)
				for j := range s.Config {
					if err = typesv53.DecodeParam(r, &s.Config[j]); err != nil {
						return err
					}
				}
			}
		...
		if present {
			{
				...
				s.Inputs = make([]typesv53.Param, n)
				for j := range s.Inputs {
					if err = typesv53.DecodeParam(r, &s.Inputs[j]); err != nil {
						return err
					}
				}
			}
		...
		if present {
			{
				...
				s.Outputs = make([]typesv53.Param, n)
				for j := range s.Outputs {
					if err = typesv53.DecodeParam(r, &s.Outputs[j]); err != nil {
						return err
					}
				}
			}
	...
	if err = typesv53.DecodeChannels(r, &s.Channels); err != nil {
		return err
	}
	return nil
}
