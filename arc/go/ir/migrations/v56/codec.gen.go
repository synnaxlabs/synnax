...
func (f *Function) DecodeOrc(r *orc.Reader) error {
	...
	}
	{
		...
		if present {
			...
			f.Config = make([]typesv56.Param, n)
			for i := range f.Config {
	...
	}
	{
		...
		if present {
			...
			f.Inputs = make([]typesv56.Param, n)
			for i := range f.Inputs {
	...
	}
	{
		...
		if present {
			...
			f.Outputs = make([]typesv56.Param, n)
			for i := range f.Outputs {
...
func (nv *Node) DecodeOrc(r *orc.Reader) error {
	...
	}
	{
		...
		if present {
			...
			nv.Config = make([]typesv56.Param, n)
			for i := range nv.Config {
	...
	}
	{
		...
		if present {
			...
			nv.Inputs = make([]typesv56.Param, n)
			for i := range nv.Inputs {
	...
	}
	{
		...
		if present {
			...
			nv.Outputs = make([]typesv56.Param, n)
			for i := range nv.Outputs {
