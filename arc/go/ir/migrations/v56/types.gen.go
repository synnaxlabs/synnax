...
type Function struct {
	...
	Config typesv56.Params `json:"config" msgpack:"config"`
	// Inputs contains input parameter definitions.
	Inputs typesv56.Params `json:"inputs" msgpack:"inputs"`
	// Outputs contains output parameter definitions.
	Outputs typesv56.Params `json:"outputs" msgpack:"outputs"`
	// Channels contains channel read/write declarations.
	Channels typesv56.Channels `json:"channels" msgpack:"channels"`
}
