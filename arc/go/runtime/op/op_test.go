...
var _ = Describe("OP", func() {
	DescribeTable("Outputs", func(
		...
		*rhsNode.OutputTime(0) = rhsTime
		...
		Entry("Float64 GE", "ge", telem.NewSeriesV(2.5, 3.5, 1.5), telem.NewSeriesSecondsTSV(10, 20, 30), telem.NewSeriesV(2.5, 3.0, 2.0), telem.NewSeriesSecondsTSV(10, 20, 30), telem.NewSeriesV[uint8](1, 1, 0), telem.NewSeriesSecondsTSV(10, 20, 30)),
		...
		Entry("Float64 LE", "le", telem.NewSeriesV(1.5, 2.5, 3.5), telem.NewSeriesSecondsTSV(1, 2, 3), telem.NewSeriesV(2.0, 2.5, 3.0), telem.NewSeriesSecondsTSV(1, 2, 3), telem.NewSeriesV[uint8](1, 1, 0), telem.NewSeriesSecondsTSV(1, 2, 3)),
		...
		Entry("Float64 EQ", "eq", telem.NewSeriesV(1.5, 2.5, 3.5), telem.NewSeriesSecondsTSV(1, 2, 3), telem.NewSeriesV(1.5, 2.0, 3.5), telem.NewSeriesSecondsTSV(1, 2, 3), telem.NewSeriesV[uint8](1, 0, 1), telem.NewSeriesSecondsTSV(1, 2, 3)),
		...
		Entry("Float64 Add", "add", telem.NewSeriesV(10.5, 20.5, 30.5), telem.NewSeriesSecondsTSV(5, 10, 15), telem.NewSeriesV(5.5, 10.5, 15.5), telem.NewSeriesSecondsTSV(5, 10, 15), telem.NewSeriesV(16.0, 31.0, 46.0), telem.NewSeriesSecondsTSV(5, 10, 15)),
		...
		Entry("Float64 Multiply", "multiply", telem.NewSeriesV(2.5, 3.0, 4.0), telem.NewSeriesSecondsTSV(1, 2, 3), telem.NewSeriesV(2.0, 3.0, 5.0), telem.NewSeriesSecondsTSV(1, 2, 3), telem.NewSeriesV(5.0, 9.0, 20.0), telem.NewSeriesSecondsTSV(1, 2, 3)),
	...
	DescribeTable("Unary Outputs", func(
		...
		*inputNode.OutputTime(0) = inputTime
		...
		Entry("Float64 NEG - positive", "neg", telem.NewSeriesV(1.5, 2.5, 3.5), telem.NewSeriesSecondsTSV(1, 2, 3), telem.NewSeriesV(1.5, -2.5, -3.5), telem.NewSeriesSecondsTSV(1, 2, 3)),
		Entry("Float64 NEG - negative", "neg", telem.NewSeriesV(-10.0, -20.0, -30.0), telem.NewSeriesSecondsTSV(5, 10, 15), telem.NewSeriesV(10.0, 20.0, 30.0), telem.NewSeriesSecondsTSV(5, 10, 15)),
		Entry("Float64 NEG - mixed", "neg", telem.NewSeriesV(-1.0, 2.0, -3.0, 4.0), telem.NewSeriesSecondsTSV(1, 2, 3, 4), telem.NewSeriesV(1.0, -2.0, 3.0, -4.0), telem.NewSeriesSecondsTSV(1, 2, 3, 4)),
