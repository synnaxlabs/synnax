...
func (r *Runtime) SeriesElementAddU8(ctx context.Context, handle uint32, scalar uint8) uint32 {
	...
	for i := 0; i < length; i++ {
		v := telem.ValueAt[uint8](s, i)
		telem.SetValueAt[uint8](result, i, v + scalar)
	}
...
func (r *Runtime) SeriesSeriesAddU8(ctx context.Context, h1 uint32, h2 uint32) uint32 {
	...
	for i := 0; i < length; i++ {
		v1 := telem.ValueAt[uint8](s1, i)
		v2 := telem.ValueAt[uint8](s2, i)
		telem.SetValueAt[uint8](result, i, v1 + v2)
	}
	newHandle := r.seriesHandleCounter
	r.seriesHandleCounter++
	r.series[newHandle] = result
...
func (r *Runtime) SeriesElementAddU16(ctx context.Context, handle uint32, scalar uint16) uint32 {
	...
	result := telem.MakeSeries(s.DataType, length)
	for i := 0; i < length; i++ {
		v := telem.ValueAt[uint16](s, i)
		telem.SetValueAt[uint16](result, i, v + scalar)
	}
	newHandle := r.seriesHandleCounter
	r.seriesHandleCounter++
	r.series[newHandle] = result
...
func (r *Runtime) SeriesSeriesAddU16(ctx context.Context, h1 uint32, h2 uint32) uint32 {
	...
	result := telem.MakeSeries(s1.DataType, length)
	for i := 0; i < length; i++ {
		v1 := telem.ValueAt[uint16](s1, i)
		v2 := telem.ValueAt[uint16](s2, i)
		telem.SetValueAt[uint16](result, i, v1 + v2)
	}
	newHandle := r.seriesHandleCounter
	r.seriesHandleCounter++
	r.series[newHandle] = result
...
func (r *Runtime) SeriesElementAddU32(ctx context.Context, handle uint32, scalar uint32) uint32 {
	...
	result := telem.MakeSeries(s.DataType, length)
	for i := 0; i < length; i++ {
		v := telem.ValueAt[uint32](s, i)
		telem.SetValueAt[uint32](result, i, v + scalar)
	}
	newHandle := r.seriesHandleCounter
	r.seriesHandleCounter++
	r.series[newHandle] = result
...
func (r *Runtime) SeriesSeriesAddU32(ctx context.Context, h1 uint32, h2 uint32) uint32 {
	...
	result := telem.MakeSeries(s1.DataType, length)
	for i := 0; i < length; i++ {
		v1 := telem.ValueAt[uint32](s1, i)
		v2 := telem.ValueAt[uint32](s2, i)
		telem.SetValueAt[uint32](result, i, v1 + v2)
	}
	newHandle := r.seriesHandleCounter
	r.seriesHandleCounter++
	r.series[newHandle] = result
...
func (r *Runtime) SeriesElementAddU64(ctx context.Context, handle uint32, scalar uint64) uint32 {
	...
	result := telem.MakeSeries(s.DataType, length)
	for i := 0; i < length; i++ {
		v := telem.ValueAt[uint64](s, i)
		telem.SetValueAt[uint64](result, i, v + scalar)
	}
	newHandle := r.seriesHandleCounter
	r.seriesHandleCounter++
	r.series[newHandle] = result
...
func (r *Runtime) SeriesSeriesAddU64(ctx context.Context, h1 uint32, h2 uint32) uint32 {
	...
	result := telem.MakeSeries(s1.DataType, length)
	for i := 0; i < length; i++ {
		v1 := telem.ValueAt[uint64](s1, i)
		v2 := telem.ValueAt[uint64](s2, i)
		telem.SetValueAt[uint64](result, i, v1 + v2)
	}
	newHandle := r.seriesHandleCounter
	r.seriesHandleCounter++
	r.series[newHandle] = result
...
func (r *Runtime) SeriesElementAddI8(ctx context.Context, handle uint32, scalar int8) uint32 {
	...
	result := telem.MakeSeries(s.DataType, length)
	for i := 0; i < length; i++ {
		v := telem.ValueAt[int8](s, i)
		telem.SetValueAt[int8](result, i, v + scalar)
	}
	newHandle := r.seriesHandleCounter
	r.seriesHandleCounter++
	r.series[newHandle] = result
...
func (r *Runtime) SeriesSeriesAddI8(ctx context.Context, h1 uint32, h2 uint32) uint32 {
	...
	result := telem.MakeSeries(s1.DataType, length)
	for i := 0; i < length; i++ {
		v1 := telem.ValueAt[int8](s1, i)
		v2 := telem.ValueAt[int8](s2, i)
		telem.SetValueAt[int8](result, i, v1 + v2)
	}
	newHandle := r.seriesHandleCounter
	r.seriesHandleCounter++
	r.series[newHandle] = result
...
func (r *Runtime) SeriesElementAddI16(ctx context.Context, handle uint32, scalar int16) uint32 {
	...
	result := telem.MakeSeries(s.DataType, length)
	for i := 0; i < length; i++ {
		v := telem.ValueAt[int16](s, i)
		telem.SetValueAt[int16](result, i, v + scalar)
	}
	newHandle := r.seriesHandleCounter
	r.seriesHandleCounter++
	r.series[newHandle] = result
...
func (r *Runtime) SeriesSeriesAddI16(ctx context.Context, h1 uint32, h2 uint32) uint32 {
	...
	result := telem.MakeSeries(s1.DataType, length)
	for i := 0; i < length; i++ {
		v1 := telem.ValueAt[int16](s1, i)
		v2 := telem.ValueAt[int16](s2, i)
		telem.SetValueAt[int16](result, i, v1 + v2)
	}
	newHandle := r.seriesHandleCounter
	r.seriesHandleCounter++
	r.series[newHandle] = result
...
func (r *Runtime) SeriesElementAddI32(ctx context.Context, handle uint32, scalar int32) uint32 {
	...
	result := telem.MakeSeries(s.DataType, length)
	for i := 0; i < length; i++ {
		v := telem.ValueAt[int32](s, i)
		telem.SetValueAt[int32](result, i, v + scalar)
	}
	newHandle := r.seriesHandleCounter
	r.seriesHandleCounter++
	r.series[newHandle] = result
...
func (r *Runtime) SeriesSeriesAddI32(ctx context.Context, h1 uint32, h2 uint32) uint32 {
	...
	result := telem.MakeSeries(s1.DataType, length)
	for i := 0; i < length; i++ {
		v1 := telem.ValueAt[int32](s1, i)
		v2 := telem.ValueAt[int32](s2, i)
		telem.SetValueAt[int32](result, i, v1 + v2)
	}
	newHandle := r.seriesHandleCounter
	r.seriesHandleCounter++
	r.series[newHandle] = result
...
func (r *Runtime) SeriesElementAddI64(ctx context.Context, handle uint32, scalar int64) uint32 {
	...
	result := telem.MakeSeries(s.DataType, length)
	for i := 0; i < length; i++ {
		v := telem.ValueAt[int64](s, i)
		telem.SetValueAt[int64](result, i, v + scalar)
	}
	newHandle := r.seriesHandleCounter
	r.seriesHandleCounter++
	r.series[newHandle] = result
...
func (r *Runtime) SeriesSeriesAddI64(ctx context.Context, h1 uint32, h2 uint32) uint32 {
	...
	result := telem.MakeSeries(s1.DataType, length)
	for i := 0; i < length; i++ {
		v1 := telem.ValueAt[int64](s1, i)
		v2 := telem.ValueAt[int64](s2, i)
		telem.SetValueAt[int64](result, i, v1 + v2)
	}
	newHandle := r.seriesHandleCounter
	r.seriesHandleCounter++
	r.series[newHandle] = result
...
func (r *Runtime) SeriesElementAddF32(ctx context.Context, handle uint32, scalar float32) uint32 {
	...
	result := telem.MakeSeries(s.DataType, length)
	for i := 0; i < length; i++ {
		v := telem.ValueAt[float32](s, i)
		telem.SetValueAt[float32](result, i, v + scalar)
	}
	newHandle := r.seriesHandleCounter
	r.seriesHandleCounter++
	r.series[newHandle] = result
...
func (r *Runtime) SeriesSeriesAddF32(ctx context.Context, h1 uint32, h2 uint32) uint32 {
	...
	result := telem.MakeSeries(s1.DataType, length)
	for i := 0; i < length; i++ {
		v1 := telem.ValueAt[float32](s1, i)
		v2 := telem.ValueAt[float32](s2, i)
		telem.SetValueAt[float32](result, i, v1 + v2)
	}
	newHandle := r.seriesHandleCounter
	r.seriesHandleCounter++
	r.series[newHandle] = result
...
func (r *Runtime) SeriesElementAddF64(ctx context.Context, handle uint32, scalar float64) uint32 {
	...
	result := telem.MakeSeries(s.DataType, length)
	for i := 0; i < length; i++ {
		v := telem.ValueAt[float64](s, i)
		telem.SetValueAt[float64](result, i, v + scalar)
	}
	newHandle := r.seriesHandleCounter
	r.seriesHandleCounter++
	r.series[newHandle] = result
...
func (r *Runtime) SeriesSeriesAddF64(ctx context.Context, h1 uint32, h2 uint32) uint32 {
	...
	result := telem.MakeSeries(s1.DataType, length)
	for i := 0; i < length; i++ {
		v1 := telem.ValueAt[float64](s1, i)
		v2 := telem.ValueAt[float64](s2, i)
		telem.SetValueAt[float64](result, i, v1 + v2)
	}
	newHandle := r.seriesHandleCounter
	r.seriesHandleCounter++
	r.series[newHandle] = result
