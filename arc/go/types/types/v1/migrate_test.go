...
var _ = Describe("MigrateType", func() {
	It("Should carry the kind, name, and unit", func(ctx SpecContext) {
		migrated := MustSucceed(v1.MigrateType(ctx, v0.Type{
			Kind: v0.KindF64,
			Name: "f64",
	...
	It("Should drop config params from function properties", func(ctx SpecContext) {
		migrated := MustSucceed(v1.MigrateType(ctx, v0.Type{
