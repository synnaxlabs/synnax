...
const (
	...
	Kind_KIND_CHAN                         Kind = 12
	Kind_KIND_SERIES                       Kind = 13
	Kind_KIND_VARIABLE                     Kind = 14
	Kind_KIND_NUMERIC_CONSTANT             Kind = 15
	Kind_KIND_INTEGER_CONSTANT             Kind = 16
	Kind_KIND_FLOAT_CONSTANT               Kind = 17
	Kind_KIND_EXACT_INTEGER_FLOAT_CONSTANT Kind = 18
	Kind_KIND_FUNCTION                     Kind = 19
	Kind_KIND_SEQUENCE                     Kind = 20
	Kind_KIND_STAGE                        Kind = 21
	Kind_KIND_VAR_REF                      Kind = 22
	Kind_KIND_BOOL                         Kind = 23
)
...
var (
	Kind_name = map[int32]string{
		...
		13: "KIND_SERIES",
		14: "KIND_VARIABLE",
		15: "KIND_NUMERIC_CONSTANT",
		16: "KIND_INTEGER_CONSTANT",
		17: "KIND_FLOAT_CONSTANT",
		18: "KIND_EXACT_INTEGER_FLOAT_CONSTANT",
		19: "KIND_FUNCTION",
		20: "KIND_SEQUENCE",
		21: "KIND_STAGE",
		22: "KIND_VAR_REF",
	...
	Kind_value = map[string]int32{
		...
		"KIND_SERIES":                       13,
		"KIND_VARIABLE":                     14,
		"KIND_NUMERIC_CONSTANT":             15,
		"KIND_INTEGER_CONSTANT":             16,
		"KIND_FLOAT_CONSTANT":               17,
		"KIND_EXACT_INTEGER_FLOAT_CONSTANT": 18,
		"KIND_FUNCTION":                     19,
		"KIND_SEQUENCE":                     20,
		"KIND_STAGE":                        21,
		"KIND_VAR_REF":                      22,
...
const (
	...
	ChanDirection_CHAN_DIRECTION_READ_WRITE ChanDirection = 3
)
...
const file_arc_go_types_pb_types_proto_rawDesc = "" +
	...
	"\tKIND_CHAN\x10\f\x12\x0f\n" +
	"\vKIND_SERIES\x10\r\x12\x11\n" +
	"\rKIND_VARIABLE\x10\x0e\x12\x19\n" +
	"\x15KIND_NUMERIC_CONSTANT\x10\x0f\x12\x19\n" +
	"\x15KIND_INTEGER_CONSTANT\x10\x10\x12\x17\n" +
	"\x13KIND_FLOAT_CONSTANT\x10\x11\x12%\n" +
	"!KIND_EXACT_INTEGER_FLOAT_CONSTANT\x10\x12\x12\x11\n" +
	"\rKIND_FUNCTION\x10\x13\x12\x11\n" +
	"\rKIND_SEQUENCE\x10\x14\x12\x0e\n" +
	"\n" +
	"KIND_STAGE\x10\x15\x12\x10\n" +
	"\fKIND_VAR_REF\x10\x16\x12\r\n" +
	"\tKIND_BOOL\x10\x17*z\n" +
	"\rChanDirection\x12\x17\n" +
	"\x13CHAN_DIRECTION_NONE\x10\x00\x12\x17\n" +
	"\x13CHAN_DIRECTION_READ\x10\x01\x12\x18\n" +
	"\x14CHAN_DIRECTION_WRITE\x10\x02\x12\x1d\n" +
	"\x19CHAN_DIRECTION_READ_WRITE\x10\x03B\x94\x01\n" +
