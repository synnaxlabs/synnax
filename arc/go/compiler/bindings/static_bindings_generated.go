...
type Bindings struct {
	...
	SeriesElementRAddU8   func(context.Context, uint8, uint32) uint32  // (scalar, handle) for scalar + series
	SeriesElementRMulU8   func(context.Context, uint8, uint32) uint32  // (scalar, handle) for scalar * series
	SeriesElementRModU8   func(context.Context, uint8, uint32) uint32  // (scalar, handle) for scalar % series
	...
	SeriesElementRAddU16   func(context.Context, uint16, uint32) uint32  // (scalar, handle) for scalar + series
	SeriesElementRMulU16   func(context.Context, uint16, uint32) uint32  // (scalar, handle) for scalar * series
	SeriesElementRModU16   func(context.Context, uint16, uint32) uint32  // (scalar, handle) for scalar % series
	...
	SeriesElementRAddU32   func(context.Context, uint32, uint32) uint32  // (scalar, handle) for scalar + series
	SeriesElementRMulU32   func(context.Context, uint32, uint32) uint32  // (scalar, handle) for scalar * series
	SeriesElementRModU32   func(context.Context, uint32, uint32) uint32  // (scalar, handle) for scalar % series
	...
	SeriesElementRAddU64   func(context.Context, uint64, uint32) uint32  // (scalar, handle) for scalar + series
	SeriesElementRMulU64   func(context.Context, uint64, uint32) uint32  // (scalar, handle) for scalar * series
	SeriesElementRModU64   func(context.Context, uint64, uint32) uint32  // (scalar, handle) for scalar % series
	...
	SeriesElementRAddI8   func(context.Context, int8, uint32) uint32  // (scalar, handle) for scalar + series
	SeriesElementRMulI8   func(context.Context, int8, uint32) uint32  // (scalar, handle) for scalar * series
	SeriesElementRModI8   func(context.Context, int8, uint32) uint32  // (scalar, handle) for scalar % series
	...
	SeriesElementRAddI16   func(context.Context, int16, uint32) uint32  // (scalar, handle) for scalar + series
	SeriesElementRMulI16   func(context.Context, int16, uint32) uint32  // (scalar, handle) for scalar * series
	SeriesElementRModI16   func(context.Context, int16, uint32) uint32  // (scalar, handle) for scalar % series
	...
	SeriesElementRAddI32   func(context.Context, int32, uint32) uint32  // (scalar, handle) for scalar + series
	SeriesElementRMulI32   func(context.Context, int32, uint32) uint32  // (scalar, handle) for scalar * series
	SeriesElementRModI32   func(context.Context, int32, uint32) uint32  // (scalar, handle) for scalar % series
	...
	SeriesElementRAddI64   func(context.Context, int64, uint32) uint32  // (scalar, handle) for scalar + series
	SeriesElementRMulI64   func(context.Context, int64, uint32) uint32  // (scalar, handle) for scalar * series
	SeriesElementRModI64   func(context.Context, int64, uint32) uint32  // (scalar, handle) for scalar % series
	...
	SeriesElementRAddF32   func(context.Context, float32, uint32) uint32  // (scalar, handle) for scalar + series
	SeriesElementRMulF32   func(context.Context, float32, uint32) uint32  // (scalar, handle) for scalar * series
	SeriesElementRModF32   func(context.Context, float32, uint32) uint32  // (scalar, handle) for scalar % series
	...
	SeriesElementRAddF64   func(context.Context, float64, uint32) uint32  // (scalar, handle) for scalar + series
	SeriesElementRMulF64   func(context.Context, float64, uint32) uint32  // (scalar, handle) for scalar * series
	SeriesElementRModF64   func(context.Context, float64, uint32) uint32  // (scalar, handle) for scalar % series
...
func (b *Bindings) setDefaultStubs() {
	...
	if b.SeriesElementRAddU8 == nil {
		b.SeriesElementRAddU8 = func(ctx context.Context, value uint8, handle uint32) uint32 {
			panic("series_element_radd_u8 not implemented")
		}
	}
	if b.SeriesElementRMulU8 == nil {
		b.SeriesElementRMulU8 = func(ctx context.Context, value uint8, handle uint32) uint32 {
			panic("series_element_rmul_u8 not implemented")
		}
	}
	if b.SeriesElementRModU8 == nil {
		b.SeriesElementRModU8 = func(ctx context.Context, value uint8, handle uint32) uint32 {
			panic("series_element_rmod_u8 not implemented")
		}
	}
	...
	if b.SeriesElementRAddU16 == nil {
		b.SeriesElementRAddU16 = func(ctx context.Context, value uint16, handle uint32) uint32 {
			panic("series_element_radd_u16 not implemented")
		}
	}
	if b.SeriesElementRMulU16 == nil {
		b.SeriesElementRMulU16 = func(ctx context.Context, value uint16, handle uint32) uint32 {
			panic("series_element_rmul_u16 not implemented")
		}
	}
	if b.SeriesElementRModU16 == nil {
		b.SeriesElementRModU16 = func(ctx context.Context, value uint16, handle uint32) uint32 {
			panic("series_element_rmod_u16 not implemented")
		}
	}
	...
	if b.SeriesElementRAddU32 == nil {
		b.SeriesElementRAddU32 = func(ctx context.Context, value uint32, handle uint32) uint32 {
			panic("series_element_radd_u32 not implemented")
		}
	}
	if b.SeriesElementRMulU32 == nil {
		b.SeriesElementRMulU32 = func(ctx context.Context, value uint32, handle uint32) uint32 {
			panic("series_element_rmul_u32 not implemented")
		}
	}
	if b.SeriesElementRModU32 == nil {
		b.SeriesElementRModU32 = func(ctx context.Context, value uint32, handle uint32) uint32 {
			panic("series_element_rmod_u32 not implemented")
		}
	}
	...
	if b.SeriesElementRAddU64 == nil {
		b.SeriesElementRAddU64 = func(ctx context.Context, value uint64, handle uint32) uint32 {
			panic("series_element_radd_u64 not implemented")
		}
	}
	if b.SeriesElementRMulU64 == nil {
		b.SeriesElementRMulU64 = func(ctx context.Context, value uint64, handle uint32) uint32 {
			panic("series_element_rmul_u64 not implemented")
		}
	}
	if b.SeriesElementRModU64 == nil {
		b.SeriesElementRModU64 = func(ctx context.Context, value uint64, handle uint32) uint32 {
			panic("series_element_rmod_u64 not implemented")
		}
	}
	...
	if b.SeriesElementRAddI8 == nil {
		b.SeriesElementRAddI8 = func(ctx context.Context, value int8, handle uint32) uint32 {
			panic("series_element_radd_i8 not implemented")
		}
	}
	if b.SeriesElementRMulI8 == nil {
		b.SeriesElementRMulI8 = func(ctx context.Context, value int8, handle uint32) uint32 {
			panic("series_element_rmul_i8 not implemented")
		}
	}
	if b.SeriesElementRModI8 == nil {
		b.SeriesElementRModI8 = func(ctx context.Context, value int8, handle uint32) uint32 {
			panic("series_element_rmod_i8 not implemented")
		}
	}
	...
	if b.SeriesElementRAddI16 == nil {
		b.SeriesElementRAddI16 = func(ctx context.Context, value int16, handle uint32) uint32 {
			panic("series_element_radd_i16 not implemented")
		}
	}
	if b.SeriesElementRMulI16 == nil {
		b.SeriesElementRMulI16 = func(ctx context.Context, value int16, handle uint32) uint32 {
			panic("series_element_rmul_i16 not implemented")
		}
	}
	if b.SeriesElementRModI16 == nil {
		b.SeriesElementRModI16 = func(ctx context.Context, value int16, handle uint32) uint32 {
			panic("series_element_rmod_i16 not implemented")
		}
	}
	...
	if b.SeriesElementRAddI32 == nil {
		b.SeriesElementRAddI32 = func(ctx context.Context, value int32, handle uint32) uint32 {
			panic("series_element_radd_i32 not implemented")
		}
	}
	if b.SeriesElementRMulI32 == nil {
		b.SeriesElementRMulI32 = func(ctx context.Context, value int32, handle uint32) uint32 {
			panic("series_element_rmul_i32 not implemented")
		}
	}
	if b.SeriesElementRModI32 == nil {
		b.SeriesElementRModI32 = func(ctx context.Context, value int32, handle uint32) uint32 {
			panic("series_element_rmod_i32 not implemented")
		}
	}
	...
	if b.SeriesElementRAddI64 == nil {
		b.SeriesElementRAddI64 = func(ctx context.Context, value int64, handle uint32) uint32 {
			panic("series_element_radd_i64 not implemented")
		}
	}
	if b.SeriesElementRMulI64 == nil {
		b.SeriesElementRMulI64 = func(ctx context.Context, value int64, handle uint32) uint32 {
			panic("series_element_rmul_i64 not implemented")
		}
	}
	if b.SeriesElementRModI64 == nil {
		b.SeriesElementRModI64 = func(ctx context.Context, value int64, handle uint32) uint32 {
			panic("series_element_rmod_i64 not implemented")
		}
	}
	...
	if b.SeriesElementRAddF32 == nil {
		b.SeriesElementRAddF32 = func(ctx context.Context, value float32, handle uint32) uint32 {
			panic("series_element_radd_f32 not implemented")
		}
	}
	if b.SeriesElementRMulF32 == nil {
		b.SeriesElementRMulF32 = func(ctx context.Context, value float32, handle uint32) uint32 {
			panic("series_element_rmul_f32 not implemented")
		}
	}
	if b.SeriesElementRModF32 == nil {
		b.SeriesElementRModF32 = func(ctx context.Context, value float32, handle uint32) uint32 {
			panic("series_element_rmod_f32 not implemented")
		}
	}
	...
	if b.SeriesElementRAddF64 == nil {
		b.SeriesElementRAddF64 = func(ctx context.Context, value float64, handle uint32) uint32 {
			panic("series_element_radd_f64 not implemented")
		}
	}
	if b.SeriesElementRMulF64 == nil {
		b.SeriesElementRMulF64 = func(ctx context.Context, value float64, handle uint32) uint32 {
			panic("series_element_rmul_f64 not implemented")
		}
	}
	if b.SeriesElementRModF64 == nil {
		b.SeriesElementRModF64 = func(ctx context.Context, value float64, handle uint32) uint32 {
			panic("series_element_rmod_f64 not implemented")
		}
	}
...
// Bind registers all runtime functions with the wazero runtime using named modules.
// Each module is created as a separate host module, and functions are exported with
// their simple names (the module provides the namespace).
func (b *Bindings) Bind(ctx context.Context, rt wazero.Runtime) error {
	// Create host modules for each namespace
	if err := b.bindCoreModule(ctx, rt); err != nil {
		return err
	}
	if err := b.bindSeriesModule(ctx, rt); err != nil {
		return err
	}
	if err := b.bindStateModule(ctx, rt); err != nil {
		return err
	}
	if err := b.bindStringModule(ctx, rt); err != nil {
		return err
	}
	if err := b.bindMathModule(ctx, rt); err != nil {
		return err
	}
	if err := b.bindTimeModule(ctx, rt); err != nil {
		return err
	}
	return nil
}

// bindCoreModule creates the arc.core module with channel operations and panic.
func (b *Bindings) bindCoreModule(ctx context.Context, rt wazero.Runtime) error {
	m := rt.NewHostModuleBuilder(ModuleCore)

	// Channel operations
	m.NewFunctionBuilder().WithFunc(b.wrapChannelReadU8()).Export("channel_read_u8")
	m.NewFunctionBuilder().WithFunc(b.wrapChannelWriteU8()).Export("channel_write_u8")
	m.NewFunctionBuilder().WithFunc(b.wrapChannelReadU16()).Export("channel_read_u16")
	m.NewFunctionBuilder().WithFunc(b.wrapChannelWriteU16()).Export("channel_write_u16")
	m.NewFunctionBuilder().WithFunc(b.wrapChannelReadU32()).Export("channel_read_u32")
	m.NewFunctionBuilder().WithFunc(b.wrapChannelWriteU32()).Export("channel_write_u32")
	m.NewFunctionBuilder().WithFunc(b.wrapChannelReadU64()).Export("channel_read_u64")
	m.NewFunctionBuilder().WithFunc(b.wrapChannelWriteU64()).Export("channel_write_u64")
	m.NewFunctionBuilder().WithFunc(b.wrapChannelReadI8()).Export("channel_read_i8")
	m.NewFunctionBuilder().WithFunc(b.wrapChannelWriteI8()).Export("channel_write_i8")
	m.NewFunctionBuilder().WithFunc(b.wrapChannelReadI16()).Export("channel_read_i16")
	m.NewFunctionBuilder().WithFunc(b.wrapChannelWriteI16()).Export("channel_write_i16")
	m.NewFunctionBuilder().WithFunc(b.wrapChannelReadI32()).Export("channel_read_i32")
	m.NewFunctionBuilder().WithFunc(b.wrapChannelWriteI32()).Export("channel_write_i32")
	m.NewFunctionBuilder().WithFunc(b.wrapChannelReadI64()).Export("channel_read_i64")
	m.NewFunctionBuilder().WithFunc(b.wrapChannelWriteI64()).Export("channel_write_i64")
	m.NewFunctionBuilder().WithFunc(b.wrapChannelReadF32()).Export("channel_read_f32")
	m.NewFunctionBuilder().WithFunc(b.wrapChannelWriteF32()).Export("channel_write_f32")
	m.NewFunctionBuilder().WithFunc(b.wrapChannelReadF64()).Export("channel_read_f64")
	m.NewFunctionBuilder().WithFunc(b.wrapChannelWriteF64()).Export("channel_write_f64")
	m.NewFunctionBuilder().WithFunc(b.wrapChannelReadStr()).Export("channel_read_str")
	m.NewFunctionBuilder().WithFunc(b.wrapChannelWriteStr()).Export("channel_write_str")


	// Panic
	m.NewFunctionBuilder().WithFunc(b.Panic).Export("panic")

	_, err := m.Instantiate(ctx)
	return err
}

// bindSeriesModule creates the arc.series module with series operations.
func (b *Bindings) bindSeriesModule(ctx context.Context, rt wazero.Runtime) error {
	m := rt.NewHostModuleBuilder(ModuleSeries)

	// U8 series operations
	m.NewFunctionBuilder().WithFunc(b.SeriesCreateEmptyU8).Export("create_empty_u8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesSetElementU8()).Export("set_element_u8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesIndexU8()).Export("index_u8")

	// Scalar arithmetic: element_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementAddU8()).Export("element_add_u8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementMulU8()).Export("element_mul_u8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementSubU8()).Export("element_sub_u8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementDivU8()).Export("element_div_u8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementModU8()).Export("element_mod_u8")

	// Reverse scalar arithmetic: element_r<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRSubU8()).Export("element_rsub_u8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRDivU8()).Export("element_rdiv_u8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRAddU8()).Export("element_radd_u8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRMulU8()).Export("element_rmul_u8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRModU8()).Export("element_rmod_u8")

	// Series-to-series arithmetic: series_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesAddU8).Export("series_add_u8")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesMulU8).Export("series_mul_u8")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesSubU8).Export("series_sub_u8")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesDivU8).Export("series_div_u8")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesModU8).Export("series_mod_u8")

	// Series-to-series comparison: compare_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareGTU8).Export("compare_gt_u8")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareLTU8).Export("compare_lt_u8")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareGEU8).Export("compare_ge_u8")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareLEU8).Export("compare_le_u8")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareEQU8).Export("compare_eq_u8")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareNEU8).Export("compare_ne_u8")

	// Series-to-scalar comparison: compare_<op>_scalar_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareGTScalarU8()).Export("compare_gt_scalar_u8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareLTScalarU8()).Export("compare_lt_scalar_u8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareGEScalarU8()).Export("compare_ge_scalar_u8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareLEScalarU8()).Export("compare_le_scalar_u8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareEQScalarU8()).Export("compare_eq_scalar_u8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareNEScalarU8()).Export("compare_ne_scalar_u8")

	// U16 series operations
	m.NewFunctionBuilder().WithFunc(b.SeriesCreateEmptyU16).Export("create_empty_u16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesSetElementU16()).Export("set_element_u16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesIndexU16()).Export("index_u16")

	// Scalar arithmetic: element_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementAddU16()).Export("element_add_u16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementMulU16()).Export("element_mul_u16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementSubU16()).Export("element_sub_u16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementDivU16()).Export("element_div_u16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementModU16()).Export("element_mod_u16")

	// Reverse scalar arithmetic: element_r<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRSubU16()).Export("element_rsub_u16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRDivU16()).Export("element_rdiv_u16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRAddU16()).Export("element_radd_u16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRMulU16()).Export("element_rmul_u16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRModU16()).Export("element_rmod_u16")

	// Series-to-series arithmetic: series_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesAddU16).Export("series_add_u16")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesMulU16).Export("series_mul_u16")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesSubU16).Export("series_sub_u16")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesDivU16).Export("series_div_u16")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesModU16).Export("series_mod_u16")

	// Series-to-series comparison: compare_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareGTU16).Export("compare_gt_u16")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareLTU16).Export("compare_lt_u16")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareGEU16).Export("compare_ge_u16")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareLEU16).Export("compare_le_u16")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareEQU16).Export("compare_eq_u16")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareNEU16).Export("compare_ne_u16")

	// Series-to-scalar comparison: compare_<op>_scalar_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareGTScalarU16()).Export("compare_gt_scalar_u16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareLTScalarU16()).Export("compare_lt_scalar_u16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareGEScalarU16()).Export("compare_ge_scalar_u16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareLEScalarU16()).Export("compare_le_scalar_u16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareEQScalarU16()).Export("compare_eq_scalar_u16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareNEScalarU16()).Export("compare_ne_scalar_u16")

	// U32 series operations
	m.NewFunctionBuilder().WithFunc(b.SeriesCreateEmptyU32).Export("create_empty_u32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesSetElementU32()).Export("set_element_u32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesIndexU32()).Export("index_u32")

	// Scalar arithmetic: element_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementAddU32()).Export("element_add_u32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementMulU32()).Export("element_mul_u32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementSubU32()).Export("element_sub_u32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementDivU32()).Export("element_div_u32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementModU32()).Export("element_mod_u32")

	// Reverse scalar arithmetic: element_r<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRSubU32()).Export("element_rsub_u32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRDivU32()).Export("element_rdiv_u32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRAddU32()).Export("element_radd_u32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRMulU32()).Export("element_rmul_u32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRModU32()).Export("element_rmod_u32")

	// Series-to-series arithmetic: series_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesAddU32).Export("series_add_u32")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesMulU32).Export("series_mul_u32")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesSubU32).Export("series_sub_u32")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesDivU32).Export("series_div_u32")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesModU32).Export("series_mod_u32")

	// Series-to-series comparison: compare_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareGTU32).Export("compare_gt_u32")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareLTU32).Export("compare_lt_u32")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareGEU32).Export("compare_ge_u32")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareLEU32).Export("compare_le_u32")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareEQU32).Export("compare_eq_u32")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareNEU32).Export("compare_ne_u32")

	// Series-to-scalar comparison: compare_<op>_scalar_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareGTScalarU32()).Export("compare_gt_scalar_u32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareLTScalarU32()).Export("compare_lt_scalar_u32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareGEScalarU32()).Export("compare_ge_scalar_u32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareLEScalarU32()).Export("compare_le_scalar_u32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareEQScalarU32()).Export("compare_eq_scalar_u32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareNEScalarU32()).Export("compare_ne_scalar_u32")

	// U64 series operations
	m.NewFunctionBuilder().WithFunc(b.SeriesCreateEmptyU64).Export("create_empty_u64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesSetElementU64()).Export("set_element_u64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesIndexU64()).Export("index_u64")

	// Scalar arithmetic: element_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementAddU64()).Export("element_add_u64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementMulU64()).Export("element_mul_u64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementSubU64()).Export("element_sub_u64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementDivU64()).Export("element_div_u64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementModU64()).Export("element_mod_u64")

	// Reverse scalar arithmetic: element_r<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRSubU64()).Export("element_rsub_u64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRDivU64()).Export("element_rdiv_u64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRAddU64()).Export("element_radd_u64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRMulU64()).Export("element_rmul_u64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRModU64()).Export("element_rmod_u64")

	// Series-to-series arithmetic: series_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesAddU64).Export("series_add_u64")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesMulU64).Export("series_mul_u64")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesSubU64).Export("series_sub_u64")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesDivU64).Export("series_div_u64")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesModU64).Export("series_mod_u64")

	// Series-to-series comparison: compare_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareGTU64).Export("compare_gt_u64")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareLTU64).Export("compare_lt_u64")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareGEU64).Export("compare_ge_u64")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareLEU64).Export("compare_le_u64")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareEQU64).Export("compare_eq_u64")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareNEU64).Export("compare_ne_u64")

	// Series-to-scalar comparison: compare_<op>_scalar_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareGTScalarU64()).Export("compare_gt_scalar_u64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareLTScalarU64()).Export("compare_lt_scalar_u64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareGEScalarU64()).Export("compare_ge_scalar_u64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareLEScalarU64()).Export("compare_le_scalar_u64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareEQScalarU64()).Export("compare_eq_scalar_u64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareNEScalarU64()).Export("compare_ne_scalar_u64")

	// I8 series operations
	m.NewFunctionBuilder().WithFunc(b.SeriesCreateEmptyI8).Export("create_empty_i8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesSetElementI8()).Export("set_element_i8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesIndexI8()).Export("index_i8")

	// Scalar arithmetic: element_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementAddI8()).Export("element_add_i8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementMulI8()).Export("element_mul_i8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementSubI8()).Export("element_sub_i8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementDivI8()).Export("element_div_i8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementModI8()).Export("element_mod_i8")

	// Reverse scalar arithmetic: element_r<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRSubI8()).Export("element_rsub_i8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRDivI8()).Export("element_rdiv_i8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRAddI8()).Export("element_radd_i8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRMulI8()).Export("element_rmul_i8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRModI8()).Export("element_rmod_i8")

	// Series-to-series arithmetic: series_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesAddI8).Export("series_add_i8")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesMulI8).Export("series_mul_i8")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesSubI8).Export("series_sub_i8")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesDivI8).Export("series_div_i8")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesModI8).Export("series_mod_i8")

	// Series-to-series comparison: compare_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareGTI8).Export("compare_gt_i8")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareLTI8).Export("compare_lt_i8")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareGEI8).Export("compare_ge_i8")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareLEI8).Export("compare_le_i8")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareEQI8).Export("compare_eq_i8")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareNEI8).Export("compare_ne_i8")

	// Series-to-scalar comparison: compare_<op>_scalar_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareGTScalarI8()).Export("compare_gt_scalar_i8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareLTScalarI8()).Export("compare_lt_scalar_i8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareGEScalarI8()).Export("compare_ge_scalar_i8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareLEScalarI8()).Export("compare_le_scalar_i8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareEQScalarI8()).Export("compare_eq_scalar_i8")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareNEScalarI8()).Export("compare_ne_scalar_i8")

	// I16 series operations
	m.NewFunctionBuilder().WithFunc(b.SeriesCreateEmptyI16).Export("create_empty_i16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesSetElementI16()).Export("set_element_i16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesIndexI16()).Export("index_i16")

	// Scalar arithmetic: element_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementAddI16()).Export("element_add_i16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementMulI16()).Export("element_mul_i16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementSubI16()).Export("element_sub_i16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementDivI16()).Export("element_div_i16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementModI16()).Export("element_mod_i16")

	// Reverse scalar arithmetic: element_r<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRSubI16()).Export("element_rsub_i16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRDivI16()).Export("element_rdiv_i16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRAddI16()).Export("element_radd_i16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRMulI16()).Export("element_rmul_i16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRModI16()).Export("element_rmod_i16")

	// Series-to-series arithmetic: series_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesAddI16).Export("series_add_i16")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesMulI16).Export("series_mul_i16")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesSubI16).Export("series_sub_i16")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesDivI16).Export("series_div_i16")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesModI16).Export("series_mod_i16")

	// Series-to-series comparison: compare_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareGTI16).Export("compare_gt_i16")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareLTI16).Export("compare_lt_i16")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareGEI16).Export("compare_ge_i16")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareLEI16).Export("compare_le_i16")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareEQI16).Export("compare_eq_i16")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareNEI16).Export("compare_ne_i16")

	// Series-to-scalar comparison: compare_<op>_scalar_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareGTScalarI16()).Export("compare_gt_scalar_i16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareLTScalarI16()).Export("compare_lt_scalar_i16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareGEScalarI16()).Export("compare_ge_scalar_i16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareLEScalarI16()).Export("compare_le_scalar_i16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareEQScalarI16()).Export("compare_eq_scalar_i16")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareNEScalarI16()).Export("compare_ne_scalar_i16")

	// I32 series operations
	m.NewFunctionBuilder().WithFunc(b.SeriesCreateEmptyI32).Export("create_empty_i32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesSetElementI32()).Export("set_element_i32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesIndexI32()).Export("index_i32")

	// Scalar arithmetic: element_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementAddI32()).Export("element_add_i32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementMulI32()).Export("element_mul_i32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementSubI32()).Export("element_sub_i32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementDivI32()).Export("element_div_i32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementModI32()).Export("element_mod_i32")

	// Reverse scalar arithmetic: element_r<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRSubI32()).Export("element_rsub_i32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRDivI32()).Export("element_rdiv_i32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRAddI32()).Export("element_radd_i32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRMulI32()).Export("element_rmul_i32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRModI32()).Export("element_rmod_i32")

	// Series-to-series arithmetic: series_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesAddI32).Export("series_add_i32")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesMulI32).Export("series_mul_i32")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesSubI32).Export("series_sub_i32")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesDivI32).Export("series_div_i32")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesModI32).Export("series_mod_i32")

	// Series-to-series comparison: compare_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareGTI32).Export("compare_gt_i32")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareLTI32).Export("compare_lt_i32")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareGEI32).Export("compare_ge_i32")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareLEI32).Export("compare_le_i32")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareEQI32).Export("compare_eq_i32")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareNEI32).Export("compare_ne_i32")

	// Series-to-scalar comparison: compare_<op>_scalar_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareGTScalarI32()).Export("compare_gt_scalar_i32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareLTScalarI32()).Export("compare_lt_scalar_i32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareGEScalarI32()).Export("compare_ge_scalar_i32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareLEScalarI32()).Export("compare_le_scalar_i32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareEQScalarI32()).Export("compare_eq_scalar_i32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareNEScalarI32()).Export("compare_ne_scalar_i32")

	// I64 series operations
	m.NewFunctionBuilder().WithFunc(b.SeriesCreateEmptyI64).Export("create_empty_i64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesSetElementI64()).Export("set_element_i64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesIndexI64()).Export("index_i64")

	// Scalar arithmetic: element_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementAddI64()).Export("element_add_i64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementMulI64()).Export("element_mul_i64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementSubI64()).Export("element_sub_i64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementDivI64()).Export("element_div_i64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementModI64()).Export("element_mod_i64")

	// Reverse scalar arithmetic: element_r<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRSubI64()).Export("element_rsub_i64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRDivI64()).Export("element_rdiv_i64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRAddI64()).Export("element_radd_i64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRMulI64()).Export("element_rmul_i64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRModI64()).Export("element_rmod_i64")

	// Series-to-series arithmetic: series_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesAddI64).Export("series_add_i64")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesMulI64).Export("series_mul_i64")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesSubI64).Export("series_sub_i64")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesDivI64).Export("series_div_i64")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesModI64).Export("series_mod_i64")

	// Series-to-series comparison: compare_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareGTI64).Export("compare_gt_i64")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareLTI64).Export("compare_lt_i64")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareGEI64).Export("compare_ge_i64")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareLEI64).Export("compare_le_i64")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareEQI64).Export("compare_eq_i64")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareNEI64).Export("compare_ne_i64")

	// Series-to-scalar comparison: compare_<op>_scalar_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareGTScalarI64()).Export("compare_gt_scalar_i64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareLTScalarI64()).Export("compare_lt_scalar_i64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareGEScalarI64()).Export("compare_ge_scalar_i64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareLEScalarI64()).Export("compare_le_scalar_i64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareEQScalarI64()).Export("compare_eq_scalar_i64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareNEScalarI64()).Export("compare_ne_scalar_i64")

	// F32 series operations
	m.NewFunctionBuilder().WithFunc(b.SeriesCreateEmptyF32).Export("create_empty_f32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesSetElementF32()).Export("set_element_f32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesIndexF32()).Export("index_f32")

	// Scalar arithmetic: element_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementAddF32()).Export("element_add_f32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementMulF32()).Export("element_mul_f32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementSubF32()).Export("element_sub_f32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementDivF32()).Export("element_div_f32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementModF32()).Export("element_mod_f32")

	// Reverse scalar arithmetic: element_r<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRSubF32()).Export("element_rsub_f32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRDivF32()).Export("element_rdiv_f32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRAddF32()).Export("element_radd_f32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRMulF32()).Export("element_rmul_f32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRModF32()).Export("element_rmod_f32")

	// Series-to-series arithmetic: series_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesAddF32).Export("series_add_f32")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesMulF32).Export("series_mul_f32")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesSubF32).Export("series_sub_f32")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesDivF32).Export("series_div_f32")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesModF32).Export("series_mod_f32")

	// Series-to-series comparison: compare_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareGTF32).Export("compare_gt_f32")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareLTF32).Export("compare_lt_f32")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareGEF32).Export("compare_ge_f32")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareLEF32).Export("compare_le_f32")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareEQF32).Export("compare_eq_f32")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareNEF32).Export("compare_ne_f32")

	// Series-to-scalar comparison: compare_<op>_scalar_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareGTScalarF32()).Export("compare_gt_scalar_f32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareLTScalarF32()).Export("compare_lt_scalar_f32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareGEScalarF32()).Export("compare_ge_scalar_f32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareLEScalarF32()).Export("compare_le_scalar_f32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareEQScalarF32()).Export("compare_eq_scalar_f32")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareNEScalarF32()).Export("compare_ne_scalar_f32")

	// F64 series operations
	m.NewFunctionBuilder().WithFunc(b.SeriesCreateEmptyF64).Export("create_empty_f64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesSetElementF64()).Export("set_element_f64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesIndexF64()).Export("index_f64")

	// Scalar arithmetic: element_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementAddF64()).Export("element_add_f64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementMulF64()).Export("element_mul_f64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementSubF64()).Export("element_sub_f64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementDivF64()).Export("element_div_f64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementModF64()).Export("element_mod_f64")

	// Reverse scalar arithmetic: element_r<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRSubF64()).Export("element_rsub_f64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRDivF64()).Export("element_rdiv_f64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRAddF64()).Export("element_radd_f64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRMulF64()).Export("element_rmul_f64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesElementRModF64()).Export("element_rmod_f64")

	// Series-to-series arithmetic: series_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesAddF64).Export("series_add_f64")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesMulF64).Export("series_mul_f64")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesSubF64).Export("series_sub_f64")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesDivF64).Export("series_div_f64")
	m.NewFunctionBuilder().WithFunc(b.SeriesSeriesModF64).Export("series_mod_f64")

	// Series-to-series comparison: compare_<op>_<type>
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareGTF64).Export("compare_gt_f64")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareLTF64).Export("compare_lt_f64")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareGEF64).Export("compare_ge_f64")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareLEF64).Export("compare_le_f64")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareEQF64).Export("compare_eq_f64")
	m.NewFunctionBuilder().WithFunc(b.SeriesCompareNEF64).Export("compare_ne_f64")

	// Series-to-scalar comparison: compare_<op>_scalar_<type>
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareGTScalarF64()).Export("compare_gt_scalar_f64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareLTScalarF64()).Export("compare_lt_scalar_f64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareGEScalarF64()).Export("compare_ge_scalar_f64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareLEScalarF64()).Export("compare_le_scalar_f64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareEQScalarF64()).Export("compare_eq_scalar_f64")
	m.NewFunctionBuilder().WithFunc(b.wrapSeriesCompareNEScalarF64()).Export("compare_ne_scalar_f64")


	// Unary operations (negate for signed types)
	m.NewFunctionBuilder().WithFunc(b.SeriesNegateF64).Export("negate_f64")
	m.NewFunctionBuilder().WithFunc(b.SeriesNegateF32).Export("negate_f32")
	m.NewFunctionBuilder().WithFunc(b.SeriesNegateI64).Export("negate_i64")
	m.NewFunctionBuilder().WithFunc(b.SeriesNegateI32).Export("negate_i32")
	m.NewFunctionBuilder().WithFunc(b.SeriesNegateI16).Export("negate_i16")
	m.NewFunctionBuilder().WithFunc(b.SeriesNegateI8).Export("negate_i8")
	m.NewFunctionBuilder().WithFunc(b.SeriesNotU8).Export("not_u8")

	// Generic series operations
	m.NewFunctionBuilder().WithFunc(b.SeriesLen).Export("len")
	m.NewFunctionBuilder().WithFunc(b.SeriesSlice).Export("slice")

	_, err := m.Instantiate(ctx)
	return err
}

// bindStateModule creates the arc.state module with state persistence operations.
func (b *Bindings) bindStateModule(ctx context.Context, rt wazero.Runtime) error {
	m := rt.NewHostModuleBuilder(ModuleState)

	// Primitive state operations
	m.NewFunctionBuilder().WithFunc(b.wrapStateLoadU8()).Export("load_u8")
	m.NewFunctionBuilder().WithFunc(b.wrapStateStoreU8()).Export("store_u8")
	m.NewFunctionBuilder().WithFunc(b.wrapStateLoadU16()).Export("load_u16")
	m.NewFunctionBuilder().WithFunc(b.wrapStateStoreU16()).Export("store_u16")
	m.NewFunctionBuilder().WithFunc(b.wrapStateLoadU32()).Export("load_u32")
	m.NewFunctionBuilder().WithFunc(b.wrapStateStoreU32()).Export("store_u32")
	m.NewFunctionBuilder().WithFunc(b.wrapStateLoadU64()).Export("load_u64")
	m.NewFunctionBuilder().WithFunc(b.wrapStateStoreU64()).Export("store_u64")
	m.NewFunctionBuilder().WithFunc(b.wrapStateLoadI8()).Export("load_i8")
	m.NewFunctionBuilder().WithFunc(b.wrapStateStoreI8()).Export("store_i8")
	m.NewFunctionBuilder().WithFunc(b.wrapStateLoadI16()).Export("load_i16")
	m.NewFunctionBuilder().WithFunc(b.wrapStateStoreI16()).Export("store_i16")
	m.NewFunctionBuilder().WithFunc(b.wrapStateLoadI32()).Export("load_i32")
	m.NewFunctionBuilder().WithFunc(b.wrapStateStoreI32()).Export("store_i32")
	m.NewFunctionBuilder().WithFunc(b.wrapStateLoadI64()).Export("load_i64")
	m.NewFunctionBuilder().WithFunc(b.wrapStateStoreI64()).Export("store_i64")
	m.NewFunctionBuilder().WithFunc(b.wrapStateLoadF32()).Export("load_f32")
	m.NewFunctionBuilder().WithFunc(b.wrapStateStoreF32()).Export("store_f32")
	m.NewFunctionBuilder().WithFunc(b.wrapStateLoadF64()).Export("load_f64")
	m.NewFunctionBuilder().WithFunc(b.wrapStateStoreF64()).Export("store_f64")
	m.NewFunctionBuilder().WithFunc(b.wrapStateLoadStr()).Export("load_str")
	m.NewFunctionBuilder().WithFunc(b.wrapStateStoreStr()).Export("store_str")


	// Series state operations
	m.NewFunctionBuilder().WithFunc(b.StateLoadSeriesU8).Export("load_series_u8")
	m.NewFunctionBuilder().WithFunc(b.StateStoreSeriesU8).Export("store_series_u8")
	m.NewFunctionBuilder().WithFunc(b.StateLoadSeriesU16).Export("load_series_u16")
	m.NewFunctionBuilder().WithFunc(b.StateStoreSeriesU16).Export("store_series_u16")
	m.NewFunctionBuilder().WithFunc(b.StateLoadSeriesU32).Export("load_series_u32")
	m.NewFunctionBuilder().WithFunc(b.StateStoreSeriesU32).Export("store_series_u32")
	m.NewFunctionBuilder().WithFunc(b.StateLoadSeriesU64).Export("load_series_u64")
	m.NewFunctionBuilder().WithFunc(b.StateStoreSeriesU64).Export("store_series_u64")
	m.NewFunctionBuilder().WithFunc(b.StateLoadSeriesI8).Export("load_series_i8")
	m.NewFunctionBuilder().WithFunc(b.StateStoreSeriesI8).Export("store_series_i8")
	m.NewFunctionBuilder().WithFunc(b.StateLoadSeriesI16).Export("load_series_i16")
	m.NewFunctionBuilder().WithFunc(b.StateStoreSeriesI16).Export("store_series_i16")
	m.NewFunctionBuilder().WithFunc(b.StateLoadSeriesI32).Export("load_series_i32")
	m.NewFunctionBuilder().WithFunc(b.StateStoreSeriesI32).Export("store_series_i32")
	m.NewFunctionBuilder().WithFunc(b.StateLoadSeriesI64).Export("load_series_i64")
	m.NewFunctionBuilder().WithFunc(b.StateStoreSeriesI64).Export("store_series_i64")
	m.NewFunctionBuilder().WithFunc(b.StateLoadSeriesF32).Export("load_series_f32")
	m.NewFunctionBuilder().WithFunc(b.StateStoreSeriesF32).Export("store_series_f32")
	m.NewFunctionBuilder().WithFunc(b.StateLoadSeriesF64).Export("load_series_f64")
	m.NewFunctionBuilder().WithFunc(b.StateStoreSeriesF64).Export("store_series_f64")
...
// bindStringModule creates the arc.string module with string operations.
func (b *Bindings) bindStringModule(ctx context.Context, rt wazero.Runtime) error {
	m := rt.NewHostModuleBuilder(ModuleString)

	m.NewFunctionBuilder().WithFunc(b.StringFromLiteral).Export("from_literal")
	m.NewFunctionBuilder().WithFunc(b.StringConcat).Export("concat")
	m.NewFunctionBuilder().WithFunc(b.StringEqual).Export("equal")
	m.NewFunctionBuilder().WithFunc(b.StringLen).Export("len")

	_, err := m.Instantiate(ctx)
	return err
}

// bindMathModule creates the math module with math stdlib functions.
func (b *Bindings) bindMathModule(ctx context.Context, rt wazero.Runtime) error {
	...
	m.NewFunctionBuilder().WithFunc(b.wrapMathPowU16()).Export("pow_u16")
	m.NewFunctionBuilder().WithFunc(b.wrapMathPowU32()).Export("pow_u32")
	m.NewFunctionBuilder().WithFunc(b.wrapMathPowU64()).Export("pow_u64")
	m.NewFunctionBuilder().WithFunc(b.wrapMathPowI8()).Export("pow_i8")
	m.NewFunctionBuilder().WithFunc(b.wrapMathPowI16()).Export("pow_i16")
...
// bindTimeModule creates the time module with time stdlib functions.
func (b *Bindings) bindTimeModule(ctx context.Context, rt wazero.Runtime) error {
...
func (b *Bindings) wrapSeriesElementRAddU8() func(context.Context, uint32, uint32) uint32 {
	return func(ctx context.Context, value uint32, handle uint32) uint32 {
		return b.SeriesElementRAddU8(ctx, uint8(value), handle)
	}
}

func (b *Bindings) wrapSeriesElementRMulU8() func(context.Context, uint32, uint32) uint32 {
	return func(ctx context.Context, value uint32, handle uint32) uint32 {
		return b.SeriesElementRMulU8(ctx, uint8(value), handle)
	}
}

func (b *Bindings) wrapSeriesElementRModU8() func(context.Context, uint32, uint32) uint32 {
	return func(ctx context.Context, value uint32, handle uint32) uint32 {
		return b.SeriesElementRModU8(ctx, uint8(value), handle)
	}
}
...
func (b *Bindings) wrapSeriesElementRAddU16() func(context.Context, uint32, uint32) uint32 {
	return func(ctx context.Context, value uint32, handle uint32) uint32 {
		return b.SeriesElementRAddU16(ctx, uint16(value), handle)
	}
}

func (b *Bindings) wrapSeriesElementRMulU16() func(context.Context, uint32, uint32) uint32 {
	return func(ctx context.Context, value uint32, handle uint32) uint32 {
		return b.SeriesElementRMulU16(ctx, uint16(value), handle)
	}
}

func (b *Bindings) wrapSeriesElementRModU16() func(context.Context, uint32, uint32) uint32 {
	return func(ctx context.Context, value uint32, handle uint32) uint32 {
		return b.SeriesElementRModU16(ctx, uint16(value), handle)
	}
}
...
func (b *Bindings) wrapSeriesElementRAddU32() func(context.Context, uint32, uint32) uint32 {
	return func(ctx context.Context, value uint32, handle uint32) uint32 {
		return b.SeriesElementRAddU32(ctx, uint32(value), handle)
	}
}

func (b *Bindings) wrapSeriesElementRMulU32() func(context.Context, uint32, uint32) uint32 {
	return func(ctx context.Context, value uint32, handle uint32) uint32 {
		return b.SeriesElementRMulU32(ctx, uint32(value), handle)
	}
}

func (b *Bindings) wrapSeriesElementRModU32() func(context.Context, uint32, uint32) uint32 {
	return func(ctx context.Context, value uint32, handle uint32) uint32 {
		return b.SeriesElementRModU32(ctx, uint32(value), handle)
	}
}
...
func (b *Bindings) wrapSeriesElementRAddU64() func(context.Context, uint64, uint32) uint32 {
	return func(ctx context.Context, value uint64, handle uint32) uint32 {
		return b.SeriesElementRAddU64(ctx, uint64(value), handle)
	}
}

func (b *Bindings) wrapSeriesElementRMulU64() func(context.Context, uint64, uint32) uint32 {
	return func(ctx context.Context, value uint64, handle uint32) uint32 {
		return b.SeriesElementRMulU64(ctx, uint64(value), handle)
	}
}

func (b *Bindings) wrapSeriesElementRModU64() func(context.Context, uint64, uint32) uint32 {
	return func(ctx context.Context, value uint64, handle uint32) uint32 {
		return b.SeriesElementRModU64(ctx, uint64(value), handle)
	}
}
...
func (b *Bindings) wrapSeriesElementRAddI8() func(context.Context, uint32, uint32) uint32 {
	return func(ctx context.Context, value uint32, handle uint32) uint32 {
		return b.SeriesElementRAddI8(ctx, int8(value), handle)
	}
}

func (b *Bindings) wrapSeriesElementRMulI8() func(context.Context, uint32, uint32) uint32 {
	return func(ctx context.Context, value uint32, handle uint32) uint32 {
		return b.SeriesElementRMulI8(ctx, int8(value), handle)
	}
}

func (b *Bindings) wrapSeriesElementRModI8() func(context.Context, uint32, uint32) uint32 {
	return func(ctx context.Context, value uint32, handle uint32) uint32 {
		return b.SeriesElementRModI8(ctx, int8(value), handle)
	}
}
...
func (b *Bindings) wrapSeriesElementRAddI16() func(context.Context, uint32, uint32) uint32 {
	return func(ctx context.Context, value uint32, handle uint32) uint32 {
		return b.SeriesElementRAddI16(ctx, int16(value), handle)
	}
}

func (b *Bindings) wrapSeriesElementRMulI16() func(context.Context, uint32, uint32) uint32 {
	return func(ctx context.Context, value uint32, handle uint32) uint32 {
		return b.SeriesElementRMulI16(ctx, int16(value), handle)
	}
}

func (b *Bindings) wrapSeriesElementRModI16() func(context.Context, uint32, uint32) uint32 {
	return func(ctx context.Context, value uint32, handle uint32) uint32 {
		return b.SeriesElementRModI16(ctx, int16(value), handle)
	}
}
...
func (b *Bindings) wrapSeriesElementRAddI32() func(context.Context, uint32, uint32) uint32 {
	return func(ctx context.Context, value uint32, handle uint32) uint32 {
		return b.SeriesElementRAddI32(ctx, int32(value), handle)
	}
}

func (b *Bindings) wrapSeriesElementRMulI32() func(context.Context, uint32, uint32) uint32 {
	return func(ctx context.Context, value uint32, handle uint32) uint32 {
		return b.SeriesElementRMulI32(ctx, int32(value), handle)
	}
}

func (b *Bindings) wrapSeriesElementRModI32() func(context.Context, uint32, uint32) uint32 {
	return func(ctx context.Context, value uint32, handle uint32) uint32 {
		return b.SeriesElementRModI32(ctx, int32(value), handle)
	}
}
...
func (b *Bindings) wrapSeriesElementRAddI64() func(context.Context, uint64, uint32) uint32 {
	return func(ctx context.Context, value uint64, handle uint32) uint32 {
		return b.SeriesElementRAddI64(ctx, int64(value), handle)
	}
}

func (b *Bindings) wrapSeriesElementRMulI64() func(context.Context, uint64, uint32) uint32 {
	return func(ctx context.Context, value uint64, handle uint32) uint32 {
		return b.SeriesElementRMulI64(ctx, int64(value), handle)
	}
}

func (b *Bindings) wrapSeriesElementRModI64() func(context.Context, uint64, uint32) uint32 {
	return func(ctx context.Context, value uint64, handle uint32) uint32 {
		return b.SeriesElementRModI64(ctx, int64(value), handle)
	}
}
...
func (b *Bindings) wrapSeriesElementRAddF32() func(context.Context, float32, uint32) uint32 {
	return func(ctx context.Context, value float32, handle uint32) uint32 {
		return b.SeriesElementRAddF32(ctx, float32(value), handle)
	}
}

func (b *Bindings) wrapSeriesElementRMulF32() func(context.Context, float32, uint32) uint32 {
	return func(ctx context.Context, value float32, handle uint32) uint32 {
		return b.SeriesElementRMulF32(ctx, float32(value), handle)
	}
}

func (b *Bindings) wrapSeriesElementRModF32() func(context.Context, float32, uint32) uint32 {
	return func(ctx context.Context, value float32, handle uint32) uint32 {
		return b.SeriesElementRModF32(ctx, float32(value), handle)
	}
}
...
func (b *Bindings) wrapSeriesElementRAddF64() func(context.Context, float64, uint32) uint32 {
	return func(ctx context.Context, value float64, handle uint32) uint32 {
		return b.SeriesElementRAddF64(ctx, float64(value), handle)
	}
}

func (b *Bindings) wrapSeriesElementRMulF64() func(context.Context, float64, uint32) uint32 {
	return func(ctx context.Context, value float64, handle uint32) uint32 {
		return b.SeriesElementRMulF64(ctx, float64(value), handle)
	}
}

func (b *Bindings) wrapSeriesElementRModF64() func(context.Context, float64, uint32) uint32 {
	return func(ctx context.Context, value float64, handle uint32) uint32 {
		return b.SeriesElementRModF64(ctx, float64(value), handle)
	}
}
