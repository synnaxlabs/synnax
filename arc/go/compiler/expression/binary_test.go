...
var _ = Describe("Binary Operations", func() {
	DescribeTable("should compile binary expressions correctly",
		...
		Entry(
			...
			int32(2),
			OpCall,
			uint32(268), // MathIntPowI32 for 3^2
			OpCall,
			uint32(268), // MathIntPowI32 for 2^9
		),
