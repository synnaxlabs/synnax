...
var _ = Describe("Binary Operations", func() {
	...
	DescribeTable(
		...
		Entry(
			"bitwise and binds tighter than xor",
			"i32(1) ^ i32(2) & i32(3)",
			types.I32(),
			OpI32Const, int32(1),
			OpI32Const, int32(2),
		...
		Entry(
			"bitwise xor binds tighter than or",
			"i32(1) | i32(2) ^ i32(3)",
			types.I32(),
			OpI32Const, int32(1),
			OpI32Const, int32(2),
		...
		Entry(
			"left shift binds tighter than bitwise and",
			"i32(2) << i32(1) & i32(3)",
			types.I32(),
			OpI32Const, int32(2),
			OpI32Const, int32(1),
	...
	Describe("Literal Coercion", func() {
		...
		It("Should coerce a literal type", func(bCtx SpecContext) {
			bytecode, exprType := compileWithAnalyzer(bCtx, "2 + x", []symbol.Symbol{
				{Name: "x", Kind: symbol.KindVariable, Type: types.F64()},
			})
		...
		Describe("Series-Series Arithmetic", func() {
			DescribeTable("should emit correct opcodes for series-series arithmetic",
				...
				Entry("u8 series + u8 series", "a + b",
					[]symbol.Symbol{
						seriesSymbol("a", types.U8(), 0),
						seriesSymbol("b", types.U8(), 1),
					},
				...
				Entry("u16 series + u16 series", "a + b",
					[]symbol.Symbol{
						seriesSymbol("a", types.U16(), 0),
						seriesSymbol("b", types.U16(), 1),
					},
				...
				Entry("u32 series + u32 series", "a + b",
					[]symbol.Symbol{
						seriesSymbol("a", types.U32(), 0),
						seriesSymbol("b", types.U32(), 1),
					},
				...
				Entry("u64 series + u64 series", "a + b",
					[]symbol.Symbol{
						seriesSymbol("a", types.U64(), 0),
						seriesSymbol("b", types.U64(), 1),
					},
				...
				Entry("i8 series + i8 series", "a + b",
					[]symbol.Symbol{
						seriesSymbol("a", types.I8(), 0),
						seriesSymbol("b", types.I8(), 1),
					},
				...
				Entry("i16 series + i16 series", "a + b",
					[]symbol.Symbol{
						seriesSymbol("a", types.I16(), 0),
						seriesSymbol("b", types.I16(), 1),
					},
				...
				Entry("i32 series + i32 series", "a + b",
					[]symbol.Symbol{
						seriesSymbol("a", types.I32(), 0),
						seriesSymbol("b", types.I32(), 1),
					},
				...
				Entry("i64 series + i64 series", "a + b",
					[]symbol.Symbol{
						seriesSymbol("a", types.I64(), 0),
						seriesSymbol("b", types.I64(), 1),
					},
				...
				Entry("f32 series + f32 series", "a + b",
					[]symbol.Symbol{
						seriesSymbol("a", types.F32(), 0),
						seriesSymbol("b", types.F32(), 1),
					},
				...
				Entry("f64 series + f64 series", "a + b",
					[]symbol.Symbol{
						seriesSymbol("a", types.F64(), 0),
						seriesSymbol("b", types.F64(), 1),
					},
