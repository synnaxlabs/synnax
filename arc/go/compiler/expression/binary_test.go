	...
	Describe("Series Operations", func() {
		Describe("Series-Series Arithmetic", func() {
			DescribeTable("should emit correct opcodes for series-series arithmetic",
				...
				Entry("u8 series + u8 series", "a + b",
					...
					OpLocalGet, 0, OpLocalGet, 1, OpCall, seriesArithmeticIdx("+", types.U8(), false),
				),
				Entry("u16 series + u16 series", "a + b",
					...
					OpLocalGet, 0, OpLocalGet, 1, OpCall, seriesArithmeticIdx("+", types.U16(), false),
				),
				Entry("u32 series + u32 series", "a + b",
					...
					OpLocalGet, 0, OpLocalGet, 1, OpCall, seriesArithmeticIdx("+", types.U32(), false),
				),
				Entry("u64 series + u64 series", "a + b",
					...
					OpLocalGet, 0, OpLocalGet, 1, OpCall, seriesArithmeticIdx("+", types.U64(), false),
				),
				Entry("i8 series + i8 series", "a + b",
					...
					OpLocalGet, 0, OpLocalGet, 1, OpCall, seriesArithmeticIdx("+", types.I8(), false),
				),
				Entry("i16 series + i16 series", "a + b",
					...
					OpLocalGet, 0, OpLocalGet, 1, OpCall, seriesArithmeticIdx("+", types.I16(), false),
				),
				Entry("i32 series + i32 series", "a + b",
					...
					OpLocalGet, 0, OpLocalGet, 1, OpCall, seriesArithmeticIdx("+", types.I32(), false),
				),
				Entry("i64 series + i64 series", "a + b",
					...
					OpLocalGet, 0, OpLocalGet, 1, OpCall, seriesArithmeticIdx("+", types.I64(), false),
				),
				Entry("f32 series + f32 series", "a + b",
					...
					OpLocalGet, 0, OpLocalGet, 1, OpCall, seriesArithmeticIdx("+", types.F32(), false),
				),
				Entry("f64 series + f64 series", "a + b",
					...
					OpLocalGet, 0, OpLocalGet, 1, OpCall, seriesArithmeticIdx("+", types.F64(), false),
				),
		...
		Describe("Scalar-Series Arithmetic", func() {
			DescribeTable("should emit correct opcodes for scalar-series arithmetic",
				...
				// Addition - commutative, uses series_element_add
				Entry("u8 scalar + u8 series", "5 + data",
					symbol.MapResolver{"data": seriesSymbol("data", types.U8(), 0)},
					types.Series(types.U8()),
					OpI32Const, int32(5), OpLocalGet, 0, OpCall, seriesArithmeticIdx("+", types.U8(), true),
				),
				Entry("u16 scalar + u16 series", "5 + data",
					symbol.MapResolver{"data": seriesSymbol("data", types.U16(), 0)},
					types.Series(types.U16()),
					OpI32Const, int32(5), OpLocalGet, 0, OpCall, seriesArithmeticIdx("+", types.U16(), true),
				),
				Entry("u32 scalar + u32 series", "5 + data",
					symbol.MapResolver{"data": seriesSymbol("data", types.U32(), 0)},
					types.Series(types.U32()),
					OpI32Const, int32(5), OpLocalGet, 0, OpCall, seriesArithmeticIdx("+", types.U32(), true),
				),
				Entry("u64 scalar + u64 series", "5 + data",
					symbol.MapResolver{"data": seriesSymbol("data", types.U64(), 0)},
					types.Series(types.U64()),
					OpI64Const, int64(5), OpLocalGet, 0, OpCall, seriesArithmeticIdx("+", types.U64(), true),
				),
				Entry("i8 scalar + i8 series", "5 + data",
					symbol.MapResolver{"data": seriesSymbol("data", types.I8(), 0)},
					types.Series(types.I8()),
					OpI32Const, int32(5), OpLocalGet, 0, OpCall, seriesArithmeticIdx("+", types.I8(), true),
				),
				Entry("i16 scalar + i16 series", "5 + data",
					symbol.MapResolver{"data": seriesSymbol("data", types.I16(), 0)},
					types.Series(types.I16()),
					OpI32Const, int32(5), OpLocalGet, 0, OpCall, seriesArithmeticIdx("+", types.I16(), true),
				),
				Entry("i32 scalar + i32 series", "5 + data",
					symbol.MapResolver{"data": seriesSymbol("data", types.I32(), 0)},
					types.Series(types.I32()),
					OpI32Const, int32(5), OpLocalGet, 0, OpCall, seriesArithmeticIdx("+", types.I32(), true),
				),
				Entry("i64 scalar + i64 series", "5 + data",
					symbol.MapResolver{"data": seriesSymbol("data", types.I64(), 0)},
					types.Series(types.I64()),
					OpI64Const, int64(5), OpLocalGet, 0, OpCall, seriesArithmeticIdx("+", types.I64(), true),
				),
				Entry("f32 scalar + f32 series", "2.5 + data",
					symbol.MapResolver{"data": seriesSymbol("data", types.F32(), 0)},
					types.Series(types.F32()),
					OpF32Const, float32(2.5), OpLocalGet, 0, OpCall, seriesArithmeticIdx("+", types.F32(), true),
				),
				Entry("f64 scalar + f64 series", "2.5 + data",
					symbol.MapResolver{"data": seriesSymbol("data", types.F64(), 0)},
					types.Series(types.F64()),
					OpF64Const, float64(2.5), OpLocalGet, 0, OpCall, seriesArithmeticIdx("+", types.F64(), true),
				),
				...
				Entry("u8 scalar - u8 series", "5 - data",
					symbol.MapResolver{"data": seriesSymbol("data", types.U8(), 0)},
					types.Series(types.U8()),
					OpI32Const, int32(5), OpLocalGet, 0, OpCall, seriesReverseArithmeticIdx("-", types.U8()),
				),
				Entry("u16 scalar - u16 series", "5 - data",
					symbol.MapResolver{"data": seriesSymbol("data", types.U16(), 0)},
					types.Series(types.U16()),
					OpI32Const, int32(5), OpLocalGet, 0, OpCall, seriesReverseArithmeticIdx("-", types.U16()),
				),
				Entry("u32 scalar - u32 series", "5 - data",
					symbol.MapResolver{"data": seriesSymbol("data", types.U32(), 0)},
					types.Series(types.U32()),
					OpI32Const, int32(5), OpLocalGet, 0, OpCall, seriesReverseArithmeticIdx("-", types.U32()),
				),
				Entry("u64 scalar - u64 series", "5 - data",
					symbol.MapResolver{"data": seriesSymbol("data", types.U64(), 0)},
					types.Series(types.U64()),
					OpI64Const, int64(5), OpLocalGet, 0, OpCall, seriesReverseArithmeticIdx("-", types.U64()),
				),
				Entry("i8 scalar - i8 series", "5 - data",
					symbol.MapResolver{"data": seriesSymbol("data", types.I8(), 0)},
					types.Series(types.I8()),
					OpI32Const, int32(5), OpLocalGet, 0, OpCall, seriesReverseArithmeticIdx("-", types.I8()),
				),
				Entry("i16 scalar - i16 series", "5 - data",
					symbol.MapResolver{"data": seriesSymbol("data", types.I16(), 0)},
					types.Series(types.I16()),
					OpI32Const, int32(5), OpLocalGet, 0, OpCall, seriesReverseArithmeticIdx("-", types.I16()),
				),
				Entry("i32 scalar - i32 series", "5 - data",
					symbol.MapResolver{"data": seriesSymbol("data", types.I32(), 0)},
					types.Series(types.I32()),
					OpI32Const, int32(5), OpLocalGet, 0, OpCall, seriesReverseArithmeticIdx("-", types.I32()),
				),
				Entry("i64 scalar - i64 series", "5 - data",
					symbol.MapResolver{"data": seriesSymbol("data", types.I64(), 0)},
					types.Series(types.I64()),
					OpI64Const, int64(5), OpLocalGet, 0, OpCall, seriesReverseArithmeticIdx("-", types.I64()),
				),
				Entry("f32 scalar - f32 series", "2.5 - data",
					symbol.MapResolver{"data": seriesSymbol("data", types.F32(), 0)},
					types.Series(types.F32()),
					OpF32Const, float32(2.5), OpLocalGet, 0, OpCall, seriesReverseArithmeticIdx("-", types.F32()),
				),
				Entry("f64 scalar - f64 series", "2.5 - data",
					symbol.MapResolver{"data": seriesSymbol("data", types.F64(), 0)},
					types.Series(types.F64()),
					OpF64Const, float64(2.5), OpLocalGet, 0, OpCall, seriesReverseArithmeticIdx("-", types.F64()),
				),

				// Multiplication - commutative, uses series_element_mul
				Entry("u8 scalar * u8 series", "5 * data",
					symbol.MapResolver{"data": seriesSymbol("data", types.U8(), 0)},
					types.Series(types.U8()),
					OpI32Const, int32(5), OpLocalGet, 0, OpCall, seriesArithmeticIdx("*", types.U8(), true),
				...
				// Modulo - commutative, uses series_element_mod
				Entry("u8 scalar % u8 series", "5 % data",
					symbol.MapResolver{"data": seriesSymbol("data", types.U8(), 0)},
					types.Series(types.U8()),
					OpI32Const, int32(5), OpLocalGet, 0, OpCall, seriesArithmeticIdx("%", types.U8(), true),
				...
				Entry("f64 scalar % f64 series", "2.5 % data",
					symbol.MapResolver{"data": seriesSymbol("data", types.F64(), 0)},
					types.Series(types.F64()),
					OpF64Const, 2.5, OpLocalGet, 0, OpCall, seriesArithmeticIdx("%", types.F64(), true),
				),
			)
		})
		...
		Describe("Series-Series Comparisons", func() {
			DescribeTable("should emit correct opcodes for series-series comparisons",
				...
				Entry("u8 series > u8 series", "a > b",
					...
					types.Series(types.U8()),
					OpLocalGet, 0, OpLocalGet, 1, OpCall, seriesComparisonIdx(">", types.U8()),
				),
				Entry("u16 series > u16 series", "a > b",
					symbol.MapResolver{
						"a": seriesSymbol("a", types.U16(), 0),
					...
					types.Series(types.U8()),
					OpLocalGet, 0, OpLocalGet, 1, OpCall, seriesComparisonIdx(">", types.U16()),
				),
				Entry("u32 series > u32 series", "a > b",
					symbol.MapResolver{
						"a": seriesSymbol("a", types.U32(), 0),
					...
					types.Series(types.U8()),
					OpLocalGet, 0, OpLocalGet, 1, OpCall, seriesComparisonIdx(">", types.U32()),
				),
				Entry("u64 series > u64 series", "a > b",
					symbol.MapResolver{
						"a": seriesSymbol("a", types.U64(), 0),
					...
					types.Series(types.U8()),
					OpLocalGet, 0, OpLocalGet, 1, OpCall, seriesComparisonIdx(">", types.U64()),
				),
				Entry("i8 series > i8 series", "a > b",
					symbol.MapResolver{
						"a": seriesSymbol("a", types.I8(), 0),
					...
					types.Series(types.U8()),
					OpLocalGet, 0, OpLocalGet, 1, OpCall, seriesComparisonIdx(">", types.I8()),
				),
				Entry("i16 series > i16 series", "a > b",
					symbol.MapResolver{
						"a": seriesSymbol("a", types.I16(), 0),
					...
					types.Series(types.U8()),
					OpLocalGet, 0, OpLocalGet, 1, OpCall, seriesComparisonIdx(">", types.I16()),
				),
				Entry("i32 series > i32 series", "a > b",
					symbol.MapResolver{
						"a": seriesSymbol("a", types.I32(), 0),
					...
					types.Series(types.U8()),
					OpLocalGet, 0, OpLocalGet, 1, OpCall, seriesComparisonIdx(">", types.I32()),
				),
				Entry("i64 series > i64 series", "a > b",
					symbol.MapResolver{
						"a": seriesSymbol("a", types.I64(), 0),
					...
					types.Series(types.U8()),
					OpLocalGet, 0, OpLocalGet, 1, OpCall, seriesComparisonIdx(">", types.I64()),
				),
				Entry("f32 series > f32 series", "a > b",
					symbol.MapResolver{
						"a": seriesSymbol("a", types.F32(), 0),
					...
					types.Series(types.U8()),
					OpLocalGet, 0, OpLocalGet, 1, OpCall, seriesComparisonIdx(">", types.F32()),
				),
				Entry("f64 series > f64 series", "a > b",
					symbol.MapResolver{
						"a": seriesSymbol("a", types.F64(), 0),
					...
					types.Series(types.U8()),
					OpLocalGet, 0, OpLocalGet, 1, OpCall, seriesComparisonIdx(">", types.F64()),
				),
		...
		Describe("Series-Scalar Comparisons", func() {
			...
			DescribeTable("should emit correct opcodes for series-scalar comparisons",
				...
				Entry("f64 series > f64 scalar", "data > 10.0",
					symbol.MapResolver{"data": seriesSymbol("data", types.F64(), 0)},
					types.Series(types.U8()),
					OpLocalGet, 0, OpF64Const, float64(10.0), OpCall, seriesComparisonIdx(">", types.F64()),
				),
				Entry("i32 series > i32 scalar", "data > i32(10)",
					symbol.MapResolver{"data": seriesSymbol("data", types.I32(), 0)},
					types.Series(types.U8()),
					OpLocalGet, 0, OpI32Const, int32(10), OpCall, seriesComparisonIdx(">", types.I32()),
				),
				Entry("u64 series > u64 scalar", "data > u64(10)",
					symbol.MapResolver{"data": seriesSymbol("data", types.U64(), 0)},
					types.Series(types.U8()),
					OpLocalGet, 0, OpI64Const, int64(10), OpCall, seriesComparisonIdx(">", types.U64()),
				),
