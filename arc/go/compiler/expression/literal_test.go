...
var _ = Describe("Literal Compilation", func() {
	...
	Describe("Series Literal Compilation", func() {
		...
		Describe("Multiple Literals", func() {
			DescribeTable(
				"should compile multi-element series",
				expectSeriesLiteralWithHint,
				Entry(
					"three i32 literals",
					"[i32(1), i32(2), i32(3)]",
		...
		Describe("Type Coercion", func() {
			DescribeTable(
				"should compile series with type coercion",
				expectSeriesLiteralWithHint,
				Entry(
					"int literals in f64 series",
					"[1, 2, 3]",
					nil,
					types.Series(types.F64()),
					OpI32Const,
				...
				Entry(
					"mixed int and float literals in f64",
					"[1, 2.5]",
					nil,
					types.Series(types.F64()),
					OpI32Const,
