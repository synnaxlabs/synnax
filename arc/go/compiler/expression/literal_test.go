...
var _ = Describe("Literal Compilation", func() {
	...
	DescribeTable("should compile string literals (no placeholders)",
		expectExpression,

		Entry(
			"format string, simple body",
			`f"hi"`,
			types.String(),
			OpI32Const, int32(0),
			OpI32Const, int32(2),
		...
		Entry(
			"format string, newline escape processed",
			`f"a\nb"`,
			types.String(),
			OpI32Const, int32(0),
			OpI32Const, int32(3),
		...
		Entry(
			"format string, escaped backslash",
			`f"\\n"`,
			types.String(),
			OpI32Const, int32(0),
			OpI32Const, int32(2),
		...
		Entry(
			"raw string preserves backslash-n verbatim",
			`r"a\nb"`,
			types.String(),
			OpI32Const, int32(0),
			OpI32Const, int32(4),
		...
		Entry(
			"raw string preserves backslash sequence",
			`r"C:\path"`,
			types.String(),
			OpI32Const, int32(0),
			OpI32Const, int32(7),
		...
		Entry(
			"rf prefix with no placeholders preserves backslashes",
			`rf"a\nb"`,
			types.String(),
			OpI32Const, int32(0),
			OpI32Const, int32(4),
		...
		Describe("Empty Series", func() {
			DescribeTable("should compile empty series with type hint",
				...
				Entry("empty i8 series", "[]", nil, types.Series(types.I8()),
					OpI32Const, int32(0), OpCall, uint32(0),
				),
		...
		Describe("Single Element Series", func() {
			DescribeTable("should compile single element series",
				...
				Entry("single i8", "[i8(42)]", nil, types.Series(types.I8()),
					...
					OpI32Const, int32(0), OpI32Const, int32(42), OpCall, uint32(1),
				),
				...
				Entry("single i64", "[42]", nil, types.Series(types.I64()),
					OpI32Const, int32(1), OpCall, uint32(0),
					OpI32Const, int32(0), OpI64Const, int64(42), OpCall, uint32(1),
				),
				...
				Entry("single f32", "[f32(3.14)]", nil, types.Series(types.F32()),
					OpI32Const, int32(1), OpCall, uint32(0),
					OpI32Const, int32(0), OpF32Const, float32(3.14), OpCall, uint32(1),
				),
				Entry("single f64", "[3.14]", nil, types.Series(types.F64()),
					OpI32Const, int32(1), OpCall, uint32(0),
					OpI32Const, int32(0), OpF64Const, float64(3.14), OpCall, uint32(1),
				),
			)
		})
		...
		Describe("Multiple Literals", func() {
			DescribeTable("should compile multi-element series",
				...
				Entry("three i32 literals", "[i32(1), i32(2), i32(3)]", nil, types.Series(types.I32()),
					...
					OpI32Const, int32(2), OpI32Const, int32(3), OpCall, uint32(1),
				),
				Entry("three i64 literals", "[1, 2, 3]", nil, types.Series(types.I64()),
					OpI32Const, int32(3), OpCall, uint32(0),
					OpI32Const, int32(0), OpI64Const, int64(1), OpCall, uint32(1),
					OpI32Const, int32(1), OpI64Const, int64(2), OpCall, uint32(1),
					OpI32Const, int32(2), OpI64Const, int64(3), OpCall, uint32(1),
				),
				Entry("three f64 literals", "[1.1, 2.2, 3.3]", nil, types.Series(types.F64()),
					OpI32Const, int32(3), OpCall, uint32(0),
					OpI32Const, int32(0), OpF64Const, float64(1.1), OpCall, uint32(1),
					OpI32Const, int32(1), OpF64Const, float64(2.2), OpCall, uint32(1),
					OpI32Const, int32(2), OpF64Const, float64(3.3), OpCall, uint32(1),
				),
				Entry("five u8 literals", "[u8(10), u8(20), u8(30), u8(40), u8(50)]", nil, types.Series(types.U8()),
					OpI32Const, int32(5), OpCall, uint32(0),
					OpI32Const, int32(0), OpI32Const, int32(10), OpCall, uint32(1),
					OpI32Const, int32(1), OpI32Const, int32(20), OpCall, uint32(1),
					OpI32Const, int32(2), OpI32Const, int32(30), OpCall, uint32(1),
					OpI32Const, int32(3), OpI32Const, int32(40), OpCall, uint32(1),
					OpI32Const, int32(4), OpI32Const, int32(50), OpCall, uint32(1),
				),
			)
		})
		...
		Describe("With Function Calls", func() {
			DescribeTable("should compile series with function call elements",
				...
				Entry("single function call", "[getI32()]",
					...
					types.Series(types.I32()),
					OpI32Const, int32(1), OpCall, uint32(0),
					OpI32Const, int32(0), OpCall, uint32(7), OpCall, uint32(1),
				),
				Entry("two function calls", "[getI32(), getI32()]",
					...
					OpI32Const, int32(2), OpCall, uint32(0),
					OpI32Const, int32(0), OpCall, uint32(7), OpCall, uint32(1),
					OpI32Const, int32(1), OpCall, uint32(7), OpCall, uint32(1),
				),
				Entry("function call returning f64", "[getF64()]",
					...
					types.Series(types.F64()),
					OpI32Const, int32(1), OpCall, uint32(0),
					OpI32Const, int32(0), OpCall, uint32(9), OpCall, uint32(1),
				),
				Entry("function call with argument", "[add(1, 2)]",
					...
					OpI32Const, int32(1), OpCall, uint32(0),
					OpI32Const, int32(0),
					OpI32Const, int32(1), OpI32Const, int32(2), OpCall, uint32(5),
					OpCall, uint32(1),
				),
				...
				Entry("function call then literal", "[getI32(), i32(42)]",
					...
					OpI32Const, int32(2), OpCall, uint32(0),
					OpI32Const, int32(0), OpCall, uint32(7), OpCall, uint32(1),
					OpI32Const, int32(1), OpI32Const, int32(42), OpCall, uint32(1),
				),
				Entry("function call in expression", "[getI32() + i32(1)]",
					...
					OpI32Const, int32(1), OpCall, uint32(0),
					OpI32Const, int32(0),
					OpCall, uint32(7), OpI32Const, int32(1), OpI32Add,
					OpCall, uint32(1),
				),
			)
		})
		...
		Describe("Type Coercion", func() {
			DescribeTable("should compile series with type coercion",
				...
				Entry("int literals in f64 series", "[1, 2, 3]", nil, types.Series(types.F64()),
					OpI32Const, int32(3), OpCall, uint32(0),
					OpI32Const, int32(0), OpF64Const, float64(1), OpCall, uint32(1),
					OpI32Const, int32(1), OpF64Const, float64(2), OpCall, uint32(1),
					OpI32Const, int32(2), OpF64Const, float64(3), OpCall, uint32(1),
				),
				Entry("int literals in f32 series", "[1, 2]", nil, types.Series(types.F32()),
					OpI32Const, int32(2), OpCall, uint32(0),
					OpI32Const, int32(0), OpF32Const, float32(1), OpCall, uint32(1),
					OpI32Const, int32(1), OpF32Const, float32(2), OpCall, uint32(1),
				),
				Entry("mixed int and float literals in f64", "[1, 2.5]", nil, types.Series(types.F64()),
					OpI32Const, int32(2), OpCall, uint32(0),
					OpI32Const, int32(0), OpF64Const, float64(1), OpCall, uint32(1),
					OpI32Const, int32(1), OpF64Const, float64(2.5), OpCall, uint32(1),
				),
			)
		})
	})
