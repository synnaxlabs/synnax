...
import { type Config } from "@/schematic/node/valves/electricRegulatorMotorized/config";
import { Primitive } from "@/schematic/node/valves/electricRegulatorMotorized/Primitive";
import { type Theming } from "@/theming";
export type { Config };

export const VARIANT = "electricRegulatorMotorized";
export const NAME = "Motorized";
const ZERO_PROPS = { orientation: "left" as const, scale: 1 };
export const defaultConfig = (t: Theming.Theme): Config => ({
  color: t.colors.gray.l11,
  label: Label.defaultConfig("Electric Regulator Motorized"),
  ...ZERO_PROPS,
});
