...
export const SpringLoadedRelief = ({
  ...
  <Toggle.Button
    ...
    className={CSS.cls(CSS.B("spring-loaded-relief-valve"), className)}
    enabled={enabled}
  >
    ...
    <Primitive.SVG
      ...
      scale={scale}
    >
      <Primitive.Path d="M46.3625 54.1079C45.6312 54.4779 45.6311 55.5223 46.3624 55.8924L81.7435 73.7989C83.7389 74.8088 86.098 73.3588 86.0982 71.1224L86.1002 38.883C86.1003 36.6465 83.7414 35.1962 81.7458 36.2059L46.3625 54.1079Z" />
      <Primitive.Path d="M71 38.0014V72.0014" strokeWidth={4} strokeLinecap="round" />
      <Primitive.Path d="M41.6389 55.8923C42.3702 55.5222 42.3702 54.4778 41.6389 54.1077L6.2567 36.2035C4.26118 35.1937 1.90217 36.6438 1.90217 38.8803L1.90217 71.1197C1.90217 73.3562 4.26119 74.8063 6.2567 73.7965L41.6389 55.8923Z" />
