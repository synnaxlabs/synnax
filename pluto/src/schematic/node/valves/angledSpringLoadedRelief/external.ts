...
import { type Config } from "@/schematic/node/valves/angledSpringLoadedRelief/config";
import { Primitive } from "@/schematic/node/valves/angledSpringLoadedRelief/Primitive";
import { type Theming } from "@/theming";
export type { Config };

export const VARIANT = "angledSpringLoadedReliefValve";
export const NAME = "Angled Spring Loaded Relief";
...
export const defaultConfig = (t: Theming.Theme): Config => ({
  ...
  label: Label.defaultConfig("Angled Spring Loaded Relief Valve"),
