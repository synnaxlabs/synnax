  ...
  return (
    ...
    >
      ...
      <Base.SVG
        ...
        scale={scale}
      >
        <Base.Path d="M23.3625 55.6237C22.6312 55.9937 22.6311 57.0381 23.3624 57.4082L58.7435 75.3147C60.7389 76.3246 63.098 74.8747 63.0981 72.6382L63.1001 40.3988C63.1003 38.1624 60.7414 36.7121 58.7458 37.7217L23.3625 55.6237Z" />
        <Base.Path d="M48 38.633V72.633" strokeLinecap="round" strokeWidth={4} />
        <Base.Path d="M21.8923 58.4348C21.5222 57.7035 20.4778 57.7035 20.1077 58.4348L2.20349 93.817C1.19372 95.8125 2.64384 98.1715 4.8803 98.1715H37.1197C39.3562 98.1715 40.8063 95.8125 39.7965 93.817L21.8923 58.4348Z" />
        <Base.Circle cx="21" cy="56.0737" r="4" fill={colorStr} />
        <Base.Path
