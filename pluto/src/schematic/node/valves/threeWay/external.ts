...
import { type Config } from "@/schematic/node/valves/threeWay/config";
import { Primitive } from "@/schematic/node/valves/threeWay/Primitive";
import { telem } from "@/telem/aether";
import { control } from "@/telem/control/aether";
import { type Theming } from "@/theming";
export type { Config };

export const VARIANT = "threeWayValve";
export const NAME = "Three Way";
...
export const defaultConfig = (t: Theming.Theme): Config => ({
  ...
  label: Label.defaultConfig("Three Way"),
  ...ZERO_TOGGLE_PROPS,
});
