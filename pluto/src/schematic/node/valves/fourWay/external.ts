...
import { type Config } from "@/schematic/node/valves/fourWay/config";
import { Primitive } from "@/schematic/node/valves/fourWay/Primitive";
import { telem } from "@/telem/aether";
import { control } from "@/telem/control/aether";
import { type Theming } from "@/theming";
export type { Config };

export const VARIANT = "fourWayValve";
export const NAME = "Four Way";
...
export const defaultConfig = (t: Theming.Theme): Config => ({
  ...
  label: Label.defaultConfig("Four Way Valve"),
  ...ZERO_TOGGLE_PROPS,
});
