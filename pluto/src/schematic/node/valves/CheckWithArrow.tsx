    ...
    >
      ...
      >
        <Base.Path
          ...
          fill={colorStr}
        />
        <Base.Path d="M62.5 6H32.5" strokeLinecap="round" />
        <Base.Circle cx="7.5" cy="13.5" r="6" fill={colorStr} />
        <Base.Path d="M49 34.5L11.8545 15.7035C9.85901 14.6937 7.5 16.1438 7.5 18.3803V50.6197C7.5 52.8562 9.85901 54.3063 11.8545 53.2965L49 34.5ZM49 34.5L86.1455 15.7035C88.141 14.6937 90.5 16.1438 90.5 18.3803V50.6197C90.5 52.8562 88.141 54.3063 86.1455 53.2965L49 34.5Z" />
      </Base.SVG>
    </Base.Div>
  );
};
