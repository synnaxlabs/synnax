...
import { type Config } from "@/schematic/node/valves/springLoadedRelief/config";
import { Primitive } from "@/schematic/node/valves/springLoadedRelief/Primitive";
import { type Theming } from "@/theming";
export type { Config };

export const VARIANT = "springLoadedReliefValve";
export const NAME = "Spring Loaded Relief";
...
export const defaultConfig = (t: Theming.Theme): Config => ({
  ...
  label: Label.defaultConfig("Spring Loaded Relief Valve"),
