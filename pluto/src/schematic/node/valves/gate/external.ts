...
import { type Config, VARIANT } from "@/schematic/node/valves/gate/config";
import { Primitive } from "@/schematic/node/valves/gate/Primitive";

export * from "@/schematic/node/valves/gate/config";

export const defaultConfig = (t: Theming.Theme): Config => ({
  variant: VARIANT,
  color: t.colors.gray.l11,
  label: Label.defaultConfig("Gate Valve"),
