...
import { type Config } from "@/schematic/node/valves/angled/config";
import { Primitive } from "@/schematic/node/valves/angled/Primitive";
import { telem } from "@/telem/aether";
import { control } from "@/telem/control/aether";
import { type Theming } from "@/theming";
export type { Config };

export const VARIANT = "angledValve";
export const NAME = "Angled";
...
export const defaultConfig = (t: Theming.Theme): Config => ({
  ...
  label: Label.defaultConfig("Angled Valve"),
  ...ZERO_TOGGLE_PROPS,
});
