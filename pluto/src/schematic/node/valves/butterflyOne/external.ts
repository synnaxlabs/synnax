...
import { type Config } from "@/schematic/node/valves/butterflyOne/config";
import { Primitive } from "@/schematic/node/valves/butterflyOne/Primitive";
import { telem } from "@/telem/aether";
import { control } from "@/telem/control/aether";
import { type Theming } from "@/theming";
export type { Config };

export const VARIANT = "butterflyValveOne";
export const NAME = "Butterfly (Remote)";
...
export const defaultConfig = (t: Theming.Theme): Config => ({
  ...
  label: Label.defaultConfig("Butterfly Valve (Remote)"),
  ...ZERO_TOGGLE_PROPS,
});
