...
import { Primitive as Angled } from "@/schematic/node/valves/Angled";
import { Primitive as AngledRelief } from "@/schematic/node/valves/AngledRelief";
import { Primitive as AngledSpringLoadedRelief } from "@/schematic/node/valves/AngledSpringLoadedRelief";
import { Primitive as Ball } from "@/schematic/node/valves/Ball";
import { Primitive as Breather } from "@/schematic/node/valves/Breather";
import { Primitive as ButterflyOne } from "@/schematic/node/valves/ButterflyOne";
import { Primitive as ButterflyTwo } from "@/schematic/node/valves/ButterflyTwo";
import { Primitive as Check } from "@/schematic/node/valves/Check";
import { Primitive as CheckWithArrow } from "@/schematic/node/valves/CheckWithArrow";
import { Primitive as ElectricRegulator } from "@/schematic/node/valves/ElectricRegulator";
import { Primitive as ElectricRegulatorMotorized } from "@/schematic/node/valves/ElectricRegulatorMotorized";
import { Primitive as FourWay } from "@/schematic/node/valves/FourWay";
import { Primitive as Gate } from "@/schematic/node/valves/Gate";
import { Primitive as IsoCheck } from "@/schematic/node/valves/IsoCheck";
import { Primitive as Manual } from "@/schematic/node/valves/Manual";
import { Primitive as Needle } from "@/schematic/node/valves/Needle";
import { Primitive as Regulator } from "@/schematic/node/valves/Regulator";
import { Primitive as RegulatorManual } from "@/schematic/node/valves/RegulatorManual";
import { Primitive as Relief } from "@/schematic/node/valves/Relief";
import { Primitive as Solenoid } from "@/schematic/node/valves/Solenoid";
import { Primitive as SpringLoadedRelief } from "@/schematic/node/valves/SpringLoadedRelief";
import { Primitive as ThreeWay } from "@/schematic/node/valves/ThreeWay";
import { Primitive as ThreeWayBall } from "@/schematic/node/valves/ThreeWayBall";
import { Primitive as Valve } from "@/schematic/node/valves/Valve";
