...
import { type Config } from "@/schematic/node/valves/butterflyTwo/config";
import { Primitive } from "@/schematic/node/valves/butterflyTwo/Primitive";
import { telem } from "@/telem/aether";
import { control } from "@/telem/control/aether";
import { type Theming } from "@/theming";
export type { Config };

export const VARIANT = "butterflyValveTwo";
export const NAME = "Butterfly (Manual)";
...
export const defaultConfig = (t: Theming.Theme): Config => ({
  ...
  label: Label.defaultConfig("Butterfly Valve (Manual)"),
  ...ZERO_TOGGLE_PROPS,
});
