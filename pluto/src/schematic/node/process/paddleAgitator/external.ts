...
import { type Config } from "@/schematic/node/process/paddleAgitator/config";
import { Primitive } from "@/schematic/node/process/paddleAgitator/Primitive";
...
export const VARIANT = "paddleAgitator";
export const NAME = "Paddle Agitator";
...
export const defaultConfig = (t: Theming.Theme): Config => ({
  ...
  label: Label.defaultConfig("Paddle Agitator"),
  ...ZERO_TOGGLE_PROPS,
});
