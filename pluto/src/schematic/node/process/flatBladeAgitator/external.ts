...
import { type Config } from "@/schematic/node/process/flatBladeAgitator/config";
import { Primitive } from "@/schematic/node/process/flatBladeAgitator/Primitive";
...
export const VARIANT = "flatBladeAgitator";
export const NAME = "Flat Blade Agitator";
