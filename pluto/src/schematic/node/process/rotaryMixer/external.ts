...
import { type Config } from "@/schematic/node/process/rotaryMixer/config";
import { Primitive } from "@/schematic/node/process/rotaryMixer/Primitive";
...
export const VARIANT = "rotaryMixer";
export const NAME = "Rotary Mixer";
...
export const defaultConfig = (t: Theming.Theme): Config => ({
  ...
  label: Label.defaultConfig("Rotary Mixer"),
  ...ZERO_TOGGLE_PROPS,
});
