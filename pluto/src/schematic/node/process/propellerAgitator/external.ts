...
import { type Config } from "@/schematic/node/process/propellerAgitator/config";
import { Primitive } from "@/schematic/node/process/propellerAgitator/Primitive";
...
export const VARIANT = "propellerAgitator";
export const NAME = "Propeller Agitator";
...
export const defaultConfig = (t: Theming.Theme): Config => ({
  ...
  label: Label.defaultConfig("Propeller Agitator"),
  ...ZERO_TOGGLE_PROPS,
});
