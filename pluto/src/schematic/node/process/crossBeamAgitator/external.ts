...
import { type Config } from "@/schematic/node/process/crossBeamAgitator/config";
...
export const VARIANT = "crossBeamAgitator";
export const NAME = "Cross Beam Agitator";
...
export const defaultConfig = (t: Theming.Theme): Config => ({
  ...
  label: Label.defaultConfig("Cross Beam Agitator"),
  ...ZERO_TOGGLE_PROPS,
});
