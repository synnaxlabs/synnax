...
import { type Config } from "@/schematic/node/process/helicalAgitator/config";
import { Primitive } from "@/schematic/node/process/helicalAgitator/Primitive";
...
export const VARIANT = "helicalAgitator";
export const NAME = "Helical Agitator";
...
export const defaultConfig = (t: Theming.Theme): Config => ({
  ...
  label: Label.defaultConfig("Helical Agitator"),
  ...ZERO_TOGGLE_PROPS,
});
