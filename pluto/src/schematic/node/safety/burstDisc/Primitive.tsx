  ...
  return (
    <Base.Div {...rest} className={CSS(CSS.B("symbol"), className)}>
      ...
      <Base.SVG
        ...
        scale={scale}
      >
        <Base.Path d="M24 24C24 35.1852 15.2546 44.4725 3.87626 45.8297C2.90571 45.9455 2 45.1407 2 44V4C2 2.85926 2.90571 2.0545 3.87626 2.17027C15.2546 3.52755 24 12.8148 24 24Z" />
        <Base.Path
          ...
          fill={colorStr}
        />
        <Base.Path d="M33 24H2" strokeLinecap="round" />
      </Base.SVG>
    </Base.Div>
  );
};
