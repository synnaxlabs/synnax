...
export const Primitive = ({
  ...
  <Base.Div {...rest} className={CSS(CSS.B("flowmeter-Electromagnetic"), className)}>
    ...
    >
      ...
      <Base.Path d="M47.5 17.5H55.5" strokeLinecap="round" />
      <Base.Path d="M15.5 17.5H23.5" strokeLinecap="round" />
      <Base.Path
