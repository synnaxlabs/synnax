...
import { type Config } from "@/schematic/node/meters/positiveDisplacement/config";
import { Primitive } from "@/schematic/node/meters/positiveDisplacement/Primitive";
import { type Spec } from "@/schematic/node/spec";
import { type Theming } from "@/theming";
export type { Config };

export const VARIANT = "flowmeterPositiveDisplacement";
export const NAME = "Positive Displacement";
const ZERO_PROPS = { orientation: "left" as const, scale: 1 };
export const defaultConfig = (t: Theming.Theme): Config => ({
  color: t.colors.gray.l11,
  label: Label.defaultConfig("Positive Displacement Flowmeter"),
  ...ZERO_PROPS,
});
