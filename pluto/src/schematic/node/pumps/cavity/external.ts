...
import { type Config } from "@/schematic/node/pumps/cavity/config";
import { Primitive } from "@/schematic/node/pumps/cavity/Primitive";
...
export const VARIANT = "cavityPump";
export const NAME = "Cavity";
...
export const defaultConfig = (t: Theming.Theme): Config => ({
  ...
  label: Label.defaultConfig("Cavity Pump"),
  ...ZERO_TOGGLE_PROPS,
});
