...
import { type Config } from "@/schematic/node/pumps/ejection/config";
import { Primitive } from "@/schematic/node/pumps/ejection/Primitive";
...
export const VARIANT = "ejectionPump";
export const NAME = "Ejection";
...
export const defaultConfig = (t: Theming.Theme): Config => ({
  ...
  label: Label.defaultConfig("Ejection Pump"),
  ...ZERO_TOGGLE_PROPS,
});
