...
import { type Config } from "@/schematic/node/pumps/liquidRing/config";
import { Primitive } from "@/schematic/node/pumps/liquidRing/Primitive";
...
export const VARIANT = "liquidRingCompressor";
export const NAME = "Liquid Ring Compressor";
...
export const defaultConfig = (t: Theming.Theme): Config => ({
  ...
  label: Label.defaultConfig("Liquid Ring Compressor"),
  ...ZERO_TOGGLE_PROPS,
});
