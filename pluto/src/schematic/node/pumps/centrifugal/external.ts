...
import { type Config } from "@/schematic/node/pumps/centrifugal/config";
import { Primitive } from "@/schematic/node/pumps/centrifugal/Primitive";
...
export const VARIANT = "centrifugalCompressor";
export const NAME = "Centrifugal Compressor";
...
export const defaultConfig = (t: Theming.Theme): Config => ({
  ...
  label: Label.defaultConfig("Centrifugal Compressor"),
  ...ZERO_TOGGLE_PROPS,
});
