...
import { type Config, VARIANT } from "@/schematic/node/pumps/vacuum/config";
import { Primitive } from "@/schematic/node/pumps/vacuum/Primitive";
import { type Spec } from "@/schematic/node/spec";

export * from "@/schematic/node/pumps/vacuum/config";

export const defaultConfig = (t: Theming.Theme): Config => ({
  variant: VARIANT,
  color: t.colors.gray.l11,
  label: Label.defaultConfig("Vacuum Pump"),
