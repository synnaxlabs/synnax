...
import { type Config } from "@/schematic/node/pumps/ejector/config";
import { Primitive } from "@/schematic/node/pumps/ejector/Primitive";
...
export const VARIANT = "ejectorCompressor";
export const NAME = "Ejector Compressor";
...
export const defaultConfig = (t: Theming.Theme): Config => ({
  ...
  label: Label.defaultConfig("Ejector Compressor"),
  ...ZERO_TOGGLE_PROPS,
});
