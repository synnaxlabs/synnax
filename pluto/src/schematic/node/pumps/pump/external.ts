...
import { type Config, VARIANT } from "@/schematic/node/pumps/pump/config";
import { Primitive } from "@/schematic/node/pumps/pump/Primitive";
import { type Spec } from "@/schematic/node/spec";
import { type Theming } from "@synnaxlabs/charon";

export * from "@/schematic/node/pumps/pump/config";

export const defaultConfig = (t: Theming.Theme): Config => ({
  variant: VARIANT,
  color: t.colors.gray.l11,
  label: Label.defaultConfig("Pump"),
