...
import { type Config } from "@/schematic/node/pumps/piston/config";
import { Primitive } from "@/schematic/node/pumps/piston/Primitive";
...
export const VARIANT = "pistonPump";
export const NAME = "Piston";
...
export const defaultConfig = (t: Theming.Theme): Config => ({
  ...
  label: Label.defaultConfig("Piston Pump"),
  ...ZERO_TOGGLE_PROPS,
});
