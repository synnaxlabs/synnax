...
import { type Config } from "@/schematic/node/pumps/turbo/config";
import { Primitive } from "@/schematic/node/pumps/turbo/Primitive";
...
export const VARIANT = "turboCompressor";
export const NAME = "Turbo Compressor";
...
export const defaultConfig = (t: Theming.Theme): Config => ({
  ...
  label: Label.defaultConfig("Turbo Compressor"),
  ...ZERO_TOGGLE_PROPS,
});
