...
// streamer, and canceling it has no implications after NewStreamer returns.
func (db *DB) NewStreamer(cfg StreamerConfig) (Streamer[StreamerRequest, StreamerResponse], error) {
