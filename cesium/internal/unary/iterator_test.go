			...
			Describe("Channel Indexed", func() {
				...
				Describe("Happy Path", func() {
					...
					Specify("Next and Prev", func() {
						...
						Expect(iter.Value().SeriesAt(0).Data).To(EqualUnmarshal([]int64{15}))
						Expect(iter.Value().SeriesAt(1).Data).To(EqualUnmarshal([]int64{16, 17}))
						...
						Expect(iter.Value().SeriesAt(0).Data).To(EqualUnmarshal([]int64{12, 13, 14}))
						...
						Expect(iter.Value().SeriesAt(0).Data).To(EqualUnmarshal([]int64{15}))
						Expect(iter.Value().SeriesAt(1).Data).To(EqualUnmarshal([]int64{16, 17, 18, 19}))
						Expect(iter.Value().SeriesAt(2).Data).To(EqualUnmarshal([]int64{20}))
				...
				Describe("Requests Exhaustion", func() {
					...
					Describe("Auto Exhaustion", func() {
						...
						Specify("Partial Domain 3 - Regression", func() {
							...
							Expect(iter.Len()).To(Equal(int64(2)))
							Expect(iter.Value().SeriesAt(0).Data).To(Equal(telem.NewSeriesV[int64](5, 6).Data))
							Expect(iter.Next(ctx, unary.AutoSpan)).To(BeTrue())
							Expect(iter.View()).To(Equal((12 * telem.SecondTS).SpanRange(2 * telem.Second)))
							Expect(iter.Len()).To(Equal(int64(2)))
							Expect(iter.Value().SeriesAt(0).Data).To(Equal(telem.NewSeriesV[int64](7, 8).Data))
							Expect(iter.Next(ctx, unary.AutoSpan)).To(BeFalse())
						...
						Describe("Regression tests: discontinuity", func() {
							...
							Specify("Multiple Domain - Forward - View in discontinuity", func() {
								...
								Expect(f.SeriesAt(0).Data).To(EqualUnmarshal([]int64{0, 1, 4, 6}))
								...
								f = iter.Value()
								Expect(f.Count()).To(Equal(2))
								Expect(f.SeriesAt(0).Data).To(EqualUnmarshal([]int64{10, 11, 12}))
								Expect(f.SeriesAt(0).TimeRange).To(Equal((10 * telem.SecondTS).Range(12*telem.SecondTS + 1)))
								Expect(f.SeriesAt(1).Data).To(EqualUnmarshal([]int64{13}))
								...
								f = iter.Value()
								Expect(f.Count()).To(Equal(1))
								Expect(f.SeriesAt(0).Data).To(EqualUnmarshal([]int64{15, 17}))
							...
							Specify("Multiple Domain - Forward - uneven crossing", func() {
								...
								Expect(i.Value().SeriesAt(0).Data).To(EqualUnmarshal([]int64{4, 6}))
								Expect(i.Value().SeriesAt(0).TimeRange).To(Equal((2 * telem.SecondTS).Range(6*telem.SecondTS + 1)))
								Expect(i.Value().SeriesAt(1).Data).To(EqualUnmarshal([]int64{10}))
								...
								Expect(i.Value().Count()).To(Equal(2))
								Expect(i.Value().SeriesAt(0).Data).To(EqualUnmarshal([]int64{11, 12}))
								Expect(i.Value().SeriesAt(0).TimeRange).To(Equal((11 * telem.SecondTS).Range(12*telem.SecondTS + 1)))
								Expect(i.Value().SeriesAt(1).Data).To(EqualUnmarshal([]int64{13}))
							...
							Specify("View is full domain", func() {
								...
								Expect(i.Value().Count()).To(Equal(2))
								Expect(i.Value().SeriesAt(0).Data).To(EqualUnmarshal([]int64{0, 1, 4, 6}))
								Expect(i.Value().SeriesAt(0).TimeRange).To(Equal((0 * telem.SecondTS).Range(6*telem.SecondTS + 1)))
								Expect(i.Value().SeriesAt(1).Data).To(EqualUnmarshal([]int64{10, 11, 12}))
							...
							Specify("Multiple Domain - Backward - view in discontinuity", func() {
								...
								Expect(i.Value().SeriesAt(1).Data).To(EqualUnmarshal([]int64{13, 15, 17}))
								...
								Expect(i.Value().Count()).To(Equal(1))
								Expect(i.Value().SeriesAt(0).Data).To(EqualUnmarshal([]int64{10}))
							...
							Specify("View is full domain", func() {
								...
								Expect(i.Value().Count()).To(Equal(1))
								Expect(i.Value().SeriesAt(0).Data).To(EqualUnmarshal([]int64{13, 15, 17}))
								...
								Expect(i.Value().Count()).To(Equal(1))
								Expect(i.Value().SeriesAt(0).Data).To(EqualUnmarshal([]int64{10, 11, 12}))
				...
				Describe("Regressions", func() {
					...
					It("Should bound an iterator's view to a sought domain", func() {
						...
						Expect(i.Value().SeriesAt(0).Data).To(Equal(telem.NewSeriesV[int64](3, 4, 5).Data))

						Expect(i.SeekGE(ctx, 7*telem.SecondTS)).To(BeTrue())
						Expect(i.Next(ctx, 2*telem.Second)).To(BeTrue())
						Expect(i.Value().SeriesAt(0).Data).To(Equal(telem.NewSeriesV[int64](10, 11).Data))
					...
					It("Should auto-span through a domain split between two indices", func() {
						...
						Expect(i.Value().SeriesAt(0).Data).To(EqualUnmarshal([]int64{10, 11, 12, 13, 14, 15, 16, 17}))
						Expect(i.Next(ctx, cesium.AutoSpan)).To(BeTrue())
						Expect(i.Value().SeriesAt(0).Data).To(EqualUnmarshal([]int64{18, 19, 20}))
						Expect(i.Close()).To(Succeed())
					...
					Context("Cut-off domain on index channel", func() {
						...
						It("Should auto-span with a cut-off domain", func() {
							...
							Expect(i.SeekFirst(ctx)).To(BeTrue())
							Expect(i.Next(ctx, cesium.AutoSpan)).To(BeTrue())
							Expect(i.Value().SeriesAt(0).Data).To(Equal(telem.NewSecondsTSV(10, 11, 12, 13, 14, 15).Data))
							Expect(i.Value().SeriesAt(1).Data).To(Equal(telem.NewSecondsTSV(16).Data))
							Expect(i.Next(ctx, cesium.AutoSpan)).To(BeTrue())
							Expect(i.Value().SeriesAt(0).Data).To(Equal(telem.NewSecondsTSV(17, 18, 19, 20, 21, 22, 23).Data))
							Expect(i.Close()).To(Succeed())
						})
						...
						It("Should call next properly with a cut-off domain", func() {
							...
							Expect(i.Value().SeriesAt(1).Data).To(Equal(telem.NewSecondsTSV(16).Data))
							Expect(i.Next(ctx, 3*telem.Second)).To(BeTrue())
							Expect(i.Value().SeriesAt(0).Data).To(Equal(telem.NewSecondsTSV(17, 18, 19).Data))
							Expect(i.Next(ctx, 4*telem.Second)).To(BeTrue())
							Expect(i.Value().SeriesAt(0).Data).To(Equal(telem.NewSecondsTSV(20, 21, 22, 23).Data))
							Expect(i.Close()).To(Succeed())
						...
						It("Should call prev properly with a cut-off domain", func() {
							...
							Expect(i.Value().SeriesAt(0).Data).To(Equal(telem.NewSecondsTSV(15).Data))
							Expect(i.Value().SeriesAt(1).Data).To(Equal(telem.NewSecondsTSV(16, 17, 18, 19, 20, 21, 22, 23).Data))
							Expect(i.Prev(ctx, 2*telem.Second)).To(BeTrue())
							Expect(i.Value().SeriesAt(0).Data).To(Equal(telem.NewSecondsTSV(13, 14).Data))
							Expect(i.Prev(ctx, 3*telem.Second)).To(BeTrue())
							Expect(i.Value().SeriesAt(0).Data).To(Equal(telem.NewSecondsTSV(10, 11, 12).Data))
							Expect(i.Close()).To(Succeed())
