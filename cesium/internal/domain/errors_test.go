...
var _ = Describe("Errors", func() {
	Describe("RangeWriteConflict", func() {
		It("Should correctly format a range overlap error", func() {
			...
			err := domain.RangeWriteConflict(writerTr, existingTr)
