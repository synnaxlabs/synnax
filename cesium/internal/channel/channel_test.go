...
var _ = Describe("Channel", func() {
	...
	DescribeTable("Validation", func(substring string, ch channel.Channel) {
		...
		Entry("Transient channel that is not virtual",
			"transient: only virtual channels can be transient",
			cesium.Channel{Name: "Steinbeck", Key: 9998, Transient: true, Index: 123, DataType: telem.Float32T},
		),
