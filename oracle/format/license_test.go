...
var _ = Describe("License", func() {
	...
	BeforeEach(func() {
		...
		Expect(os.WriteFile(filepath.Join(repoRoot, "licenses/headers/template.txt"), []byte(fakeTemplate), 0o644)).To(Succeed())
	})
	...
	It("Should preserve a generated-code banner that follows a stale header", func(ctx SpecContext) {
		l := MustSucceed(format.NewLicense(repoRoot))
		stale := []byte("// Copyright 1999 Synnax Labs, Inc.\n//\n// Governed by BSL.\n\n// Code generated by protoc-gen-go. DO NOT EDIT.\n// versions:\n// \tprotoc-gen-go v1.36.11\n\npackage x\n")
		out := MustSucceed(l.Format(ctx, stale, "/abs/foo.go"))
		Expect(string(out)).ToNot(ContainSubstring("1999"))
		Expect(string(out)).To(ContainSubstring("// Code generated by protoc-gen-go. DO NOT EDIT."))
		Expect(string(out)).To(HaveSuffix("package x\n"))
	})
