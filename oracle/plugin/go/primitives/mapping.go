...
var mapping = map[string]primitives.Mapping{
	...
	"timestamp":          {TargetType: "telem.TimeStamp", Imports: []primitives.Import{{Category: "internal", Path: "github.com/synnaxlabs/x/telem"}}},
	"timespan":           {TargetType: "telem.TimeSpan", Imports: []primitives.Import{{Category: "internal", Path: "github.com/synnaxlabs/x/telem"}}},
	"time_range":         {TargetType: "telem.TimeRange", Imports: []primitives.Import{{Category: "internal", Path: "github.com/synnaxlabs/x/telem"}}},
	"time_range_bounded": {TargetType: "telem.TimeRange", Imports: []primitives.Import{{Category: "internal", Path: "github.com/synnaxlabs/x/telem"}}},
	"data_type":          {TargetType: "telem.DataType", Imports: []primitives.Import{{Category: "internal", Path: "github.com/synnaxlabs/x/telem"}}},
