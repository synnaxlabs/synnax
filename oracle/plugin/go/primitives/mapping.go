...
// Package primitives provides Go-specific primitive type mappings for Oracle code
// generation.
package primitives
...
var Mappings = map[string]primitives.Mapping{
	...
	"uint12": {
		TargetType: "types.Uint12",
		Imports: []primitives.Import{
			{Category: "internal", Path: "github.com/synnaxlabs/x/types"},
		},
	},
	"uint16": {TargetType: "uint16"},
	"uint20": {
		TargetType: "types.Uint20",
		Imports: []primitives.Import{
			{Category: "internal", Path: "github.com/synnaxlabs/x/types"},
		},
	},
	...
	"record": {
		TargetType: "msgpack.EncodedJSON",
		Imports: []primitives.Import{
			{Category: "internal", Path: "github.com/synnaxlabs/x/encoding/msgpack"},
		},
	},
