...
var translatorFileTemplate = template.Must(
	template.New("go-pb-translator").
		Funcs(templateFuncs).
...
// {{.Name}}ToPB converts {{.GoTypeShort}} to {{.PBTypeShort}} using provided type
// converters.
...
// {{.Name}}FromPB converts {{.PBTypeShort}} to {{.GoTypeShort}} using provided type
// converters.
...
// {{.TypeName}}ToPBAny converts {{.TypeName}} to *anypb.Any for use with generic
