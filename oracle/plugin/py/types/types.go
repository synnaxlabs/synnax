...
// formatVariantDocstring renders a union variant's Google-style docstring,
// including an Attributes section for its flattened fields, matching regular
// struct documentation.
func formatVariantDocstring(v unionVariantData) string {
	return googleDocstring(v.Doc, v.Fields)
}

// hasVariantDocumentation reports whether a union variant has a type-level doc
// or any documented field, in which case a docstring should be emitted.
func hasVariantDocumentation(v unionVariantData) bool {
