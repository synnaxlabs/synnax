...
var mapping = map[string]primitives.Mapping{
	...
	"timestamp":          {TargetType: "telem::TimeStamp", Imports: []primitives.Import{{Category: "internal", Path: "x/cpp/telem/telem.h"}}},
	"timespan":           {TargetType: "telem::TimeSpan", Imports: []primitives.Import{{Category: "internal", Path: "x/cpp/telem/telem.h"}}},
	"time_range":         {TargetType: "telem::TimeRange", Imports: []primitives.Import{{Category: "internal", Path: "x/cpp/telem/telem.h"}}},
	"time_range_bounded": {TargetType: "telem::TimeRange", Imports: []primitives.Import{{Category: "internal", Path: "x/cpp/telem/telem.h"}}},
	"data_type":          {TargetType: "telem::DataType", Imports: []primitives.Import{{Category: "internal", Path: "x/cpp/telem/telem.h"}}},
