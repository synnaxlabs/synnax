...
var mapping = map[string]primitives.Mapping{
	...
	"timestamp":          {TargetType: "x::telem::TimeStamp", Imports: []primitives.Import{{Category: "internal", Path: "x/cpp/telem/telem.h"}}},
	"timespan":           {TargetType: "x::telem::TimeSpan", Imports: []primitives.Import{{Category: "internal", Path: "x/cpp/telem/telem.h"}}},
	"time_range":         {TargetType: "x::telem::TimeRange", Imports: []primitives.Import{{Category: "internal", Path: "x/cpp/telem/telem.h"}}},
