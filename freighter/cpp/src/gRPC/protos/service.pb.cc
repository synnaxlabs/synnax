...
const ::uint32_t TableStruct_service_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::test::Message, _impl_.payload_),
};

static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        {0, -1, -1, sizeof(::test::Message)},
};
...
const char descriptor_table_protodef_service_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    "\n\rservice.proto\022\004test\"\032\n\007Message\022\017\n\007payl"
    "oad\030\001 \001(\t28\n\016messageService\022&\n\004Exec\022\r.te"
    "st.Message\032\r.test.Message\"\000b\006proto3"
};
...
const ::_pbi::TcParseTable<0, 1, 0, 28, 2> Message::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastUS1,
     {10, 63, 0, PROTOBUF_FIELD_OFFSET(Message, _impl_.payload_)}},
  }}, {{
    65535, 65535
  }}, {{
    // string payload = 1;
...
::uint8_t* Message::_InternalSerialize(
  ...
  if (!this->_internal_payload().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "test.Message.payload");
