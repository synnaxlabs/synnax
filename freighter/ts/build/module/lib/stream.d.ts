...
export interface StreamSenderCloser<RQ extends Payload> extends StreamSender<RQ> {
    closeSend(): void;
}
export interface ClientStream<RQ extends Payload, RS extends Payload> extends StreamSenderCloser<RQ>, StreamReceiver<RS> {
}
