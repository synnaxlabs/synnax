...
**Jira
Issue**: [DA-154- [Delta & Cesium] - Segment Architecture](https://synnaxlabs.atlassian.net/browse/DA-154)
...
and Aspen. DL
uses [Aspen](https://github.com/synnaxlabs/synnax/blob/main/docs/rfc/220518-aspen-distributed-storage.md)
for querying cluster topology as well as storing distributed key-value data. It
uses one or
more [Cesium](https://github.com/synnaxlabs/synnax/blob/main/docs/rfc/220517-cesium-segment-storage.md)
...
[Cesium RFC](https://github.com/synnaxlabs/synnax/blob/main/docs/rfc/220517-cesium-segment-storage.md)
.
