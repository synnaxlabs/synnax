...
<Header>
    <Header.Title>Writing Domains</Header.Title>
</Header>

This page walks you through what Domains are, and how they apply when writing data to
a cluster.

## What is a Domain?

Domains represent regions of continuously written samples in a Channel. Domains have a
time range where the start is the timestamp of the first sample in the domain, and the
...
be vertical i.e. all channels must have a single array specified, and number of samples.
You can read more about frame alignment here.
