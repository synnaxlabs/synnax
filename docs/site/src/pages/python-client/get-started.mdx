---
title: "Python Client - Get Started"
...
<details>
<summary> <h4>In case you'd like a recap, here's the entire code block.</h4> </summary>
...
<details>
<summary> <h4>And here it is all in one simple script.</h4> </summary>
