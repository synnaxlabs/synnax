...
following list summarizes each one. If you’d like deeper descriptions on each, see here.

1. **Name** - A human readable name for the channel. We reccomend keeping channel names
