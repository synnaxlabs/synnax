...
<ChannelType>
<Text.Text slot="summary" level="p"><Icon.Wave.Sine /> Analog input ([`analog`](https://support.labjack.com/docs/14-0-analog-inputs-t-series-datasheet))</Text.Text>
...
<ChannelType>
<Text.Text slot="summary" level="p"><Icon.Units.Temperature /> Thermocouple ([`thermocouple`](https://support.labjack.com/docs/14-1-1-thermocouple-t7-t8-t-series-datasheet))</Text.Text>
...
<ChannelType>
<Text.Text slot="summary" level="p"><Icon.Wave.Square /> Digital input ([`digital`](https://support.labjack.com/docs/13-0-digital-i-o-t-series-datasheet))</Text.Text>
...
- **Thermocouple performance** -> Thermocouple channels lower the maximum sample rate
  because LJM processes them outside the stream.
