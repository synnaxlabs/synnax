...
```json
{
  ...
  "enable_integrations": ["labjack", "ni", "opc", "modbus", "sequence"],
...
<Table.Data
  ...
  data={[
    ...
    },
    {
      ...
      default: "[]",
      description:
        "Comma-separated list of device integrations to enable. Options: labjack, modbus, ni, opc, sequence.",
    },
    {
      option: "--disable-integrations",
      default: "[]",
      description:
        "Comma-separated list of device integrations to disable. Options: labjack, modbus, ni, opc, sequence.",
    },
  ]}
/>
