...
import { Table, Text, Driver } from "@/components";
...
## <Text.Step step="1" level="h2">Installation</Text.Step>
...
<Driver.DownloadURL os="ni-linux-rt" />
...
## <Text.Step step="2" level="h2">Connect to the Synnax Core</Text.Step>
...
## <Text.Step step="3" level="h2">Check the Driver Status</Text.Step>
