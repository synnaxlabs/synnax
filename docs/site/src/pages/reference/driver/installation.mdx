...
```json
{
  ...
  "enable_integrations": ["arc", "ethercat", "labjack", "modbus", "ni", "opc"],
...
<Table.Data
  ...
  data={[
    ...
    },
    {
      ...
      default: "[]",
      description:
        "Comma-separated list of device integrations to enable. Options: arc, ethercat, labjack, modbus, ni, opc.",
    },
    {
      option: "--disable-integrations",
      default: "[]",
      description:
        "Comma-separated list of device integrations to disable. Options: arc, ethercat, labjack, modbus, ni, opc.",
    },
  ]}
/>
