...
<ChannelType>
<Text.Text slot="summary" level="p"><Icon.Units.Voltage /> Voltage ([`ao_voltage`](https://www.ni.com/docs/en-US/bundle/ni-daqmx-c-api-ref/page/group__ni-daqmx__c__functions__channel__configuration__creation__create__analog__output__channel_1gad278075876eeff4223fdb90ce58f0a15.html))</Text.Text>
...
<ChannelType>
<Text.Text slot="summary" level="p"><Icon.Units.Current /> Current ([`ao_current`](https://www.ni.com/docs/en-US/bundle/ni-daqmx-c-api-ref/page/group__ni-daqmx__c__functions__channel__configuration__creation__create__analog__output__channel_1ga1ae6afadb89de214c4823ca7144ab28d.html))</Text.Text>
...
<ChannelType>
<Text.Text slot="summary" level="p"><Icon.Wave.Sine /> Function generator ([`ao_func_gen`](https://www.ni.com/docs/en-US/bundle/ni-daqmx-c-api-ref/page/group__ni-daqmx__c__functions__channel__configuration__creation__create__analog__output__channel_1ga7146d8ebdf2336e5200c4d2549f67494.html))</Text.Text>
...
| `state_channel` | number | Yes      | -       | Synnax state channel key                 |
| `port`          | number | Yes      | -       | Physical port                            |
| `wave_type`     | enum   | No       | `Sine`  | `Sine`, `Triangle`, `Square`, `Sawtooth` |
| `frequency`     | number | No       | `0`     | Waveform frequency (Hz)                  |
| `amplitude`     | number | No       | `0`     | Waveform amplitude                       |
| `offset`        | number | No       | `0`     | Waveform DC offset                       |
