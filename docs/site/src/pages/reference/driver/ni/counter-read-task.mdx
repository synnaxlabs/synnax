...
| `meas_method`  | enum   | No       | `LowFreq1Ctr` | `LowFreq1Ctr`, `HighFreq2Ctr`, `DynAvg`              |
...
| `terminalA`      | string | No       | -                 | PFI terminal for encoder A signal    |
| `terminalB`      | string | No       | -                 | PFI terminal for encoder B signal    |
| `custom_scale`   | object | No       | -                 | Custom scaling                       |
...
| `units`          | enum   | No       | `RPM`   | `RPM`, `Radians/s`, `Degrees`           |
| `decoding_type`  | enum   | No       | `X4`    | `X1`, `X2`, `X4`, `TwoPulse`            |
...
| `device`          | string  | Yes      | -            | Device identifier                                  |
| `port`            | number  | Yes      | -            | Counter port (0-indexed)                           |
| `units`           | enum    | No       | `Meters`     | `Meters`, `Inches`                                 |
| `decoding_type`   | enum    | No       | `X4`         | `X1`, `X2`, `X4`, `TwoPulse`                       |
...
| `terminalZ`       | string  | No       | -            | PFI terminal for Z-index signal                    |
| `custom_scale`    | object  | No       | -            | Custom scaling                                     |
...
| `device`          | string  | Yes      | -            | Device identifier                                  |
| `port`            | number  | Yes      | -            | Counter port (0-indexed)                           |
| `units`           | enum    | No       | `Degrees`    | `Degrees`, `Radians`                               |
| `decoding_type`   | enum    | No       | `X4`         | `X1`, `X2`, `X4`, `TwoPulse`                       |
| `pulses_per_rev`  | number  | No       | `24`         | Number of encoder pulses per revolution            |
...
| `activeEdge`   | enum   | No       | `Rising` | `Rising`, `Falling`             |
| `terminal`     | string | No       | -        | PFI terminal for signal routing |
| `custom_scale` | object | No       | -        | Custom scaling                  |
...
config.channels[2].z_index_enabled = true;
