...
Acquires data from counter inputs on NI devices at a specified sample rate. Counter
tasks can measure frequency, count edges, track encoder positions, measure pulse widths,
and more.
