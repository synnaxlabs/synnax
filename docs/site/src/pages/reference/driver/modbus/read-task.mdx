...
Acquires data from Modbus TCP/IP servers by reading from registers, coils, and discrete
inputs at a specified sample rate.
...
- **Software timing**: Modbus tasks use software timing with ~100μs precision (may
