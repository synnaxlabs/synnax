...
<ChannelType>
<Text.Text slot="summary" level="p"><Icon.Wave.Sine /> Holding Register Input ([`holding_register`](https://www.modbustools.com/modbus.html#function03))</Text.Text>
...
<ChannelType>
<Text.Text slot="summary" level="p"><Icon.Wave.Sine /> Input Register ([`input_register`](https://www.modbustools.com/modbus.html#function04))</Text.Text>
