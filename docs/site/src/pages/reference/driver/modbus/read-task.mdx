...
[connected to a Modbus server](/reference/driver/modbus/connect-server).
...
To stop and start a task, you can open up the Tasks Toolbar on the left-hand side and
