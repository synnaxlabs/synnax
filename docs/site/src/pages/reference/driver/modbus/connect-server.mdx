...
Open the Search and Command Palette:

**1a.** Click on the palette at the top of the Console, OR

**1b.** Use the keyboard shortcut `Ctrl+Shift+P` (Windows) / `Cmd+Shift+P` (macOS).

**2.** Ensure you're in command mode (the input should start with `>`).

**3.** Type "Modbus" and select `Connect a Modbus Server` to open the configuration
dialog.
