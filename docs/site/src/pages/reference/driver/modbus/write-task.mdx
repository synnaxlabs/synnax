...
<ChannelType>
<Text.Text slot="summary" level="p"><Icon.Wave.Sine /> Holding Register Output ([`holding_register`](https://www.modbustools.com/modbus.html))</Text.Text>
...
<ChannelType>
<Text.Text slot="summary" level="p"><Icon.Wave.Square /> Coil Output ([`coil`](https://www.modbustools.com/modbus.html))</Text.Text>
