...
- [Read Task](/reference/driver/http/read-task) - Acquire data from HTTP servers
- [Write Task](/reference/driver/http/write-task) - Send commands to HTTP servers
...
- [Alert Task](/reference/driver/pagerduty/alert-task) - Send PagerDuty alerts when
  statuses change
