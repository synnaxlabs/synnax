...
2. The [Synnax Driver](/reference/driver/get-started) running on your network. Note that
   the Core comes with an embedded Driver that could be used for this purpose.
