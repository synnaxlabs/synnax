...
know that a series should be of a certain javascript type (`number`, `string`, `object`, `bigint`),
...
The `at` method can be used to access a javascript object containing a single value
