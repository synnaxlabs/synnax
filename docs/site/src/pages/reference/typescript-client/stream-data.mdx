...
page guides you through using the TypeScript client to stream data from a Synnax Core.
If you'd like a conceptual overview of how streams work in Synnax, check out the
