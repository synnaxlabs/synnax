...
data to them. Check out the [reading data](/reference/typescript-client/read-data)
and [writing data](/reference/typescript-client/write-data) guides to learn more.