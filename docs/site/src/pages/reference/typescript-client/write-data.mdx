...
Alternatively, you could initiate a writer in Auto-Commit mode by passing in the
configuration argument `enableAutoCommit: true`. In Auto-Commit mode, a writer would
