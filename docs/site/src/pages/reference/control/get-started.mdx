...
nextURL: "/reference/control/arc/introduction"
next: "Introduction to Arc"
---
...
**[Python](/reference/control/python/get-started)** gives you the flexibility to write
whatever software you need, with access to the entire Python ecosystem. Python sequences
run externally and communicate with Synnax over the network, which introduces latency
and makes control loop timing less predictable. Use Python for automations where you
need maximum flexibility, and Arc for automations where you need consistent, low-latency
control.
