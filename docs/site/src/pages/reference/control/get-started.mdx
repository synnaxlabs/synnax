...
control. Control sequences [stream data](/reference/concepts/streams) from a set
of input channels, perform some computations, and [write
data](/reference/concepts/writes) to a set of output channels.

# <<<<<<< Updated upstream

A control sequence is just a process, such as a Python script or a loop, that [streams
data](/reference/concepts/streams) from a set of input channels, performs some
