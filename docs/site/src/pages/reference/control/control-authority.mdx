...
```arc channels="press_vlv_cmd, vent_vlv_cmd"
stage emergency {
...
and
[`set_authority` built-in](/reference/control/arc/reference/standard-library/control#set_authority)
