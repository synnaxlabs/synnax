...
4. Channel triggers only react to new writes — values written before stage entry are
   ignored

Stages don't remember their previous state. If you transition away and come back,
everything starts over.

This is important for **resumable sequences** — a common pattern where a sequence parks
