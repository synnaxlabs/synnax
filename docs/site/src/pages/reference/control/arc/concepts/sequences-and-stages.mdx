...
stages, with only one stage active at a time. When you enter a stage, its flows
execute; when you leave, they stop.
...
All flows in a stage run simultaneously. This is different from traditional
...
Direct assignments behave like constant flows. They continuously set the value while
the stage is active. Use whichever is clearer for your use case.
