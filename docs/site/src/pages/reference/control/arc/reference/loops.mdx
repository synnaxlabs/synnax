...
prev: "Statements"
prevURL: "/reference/control/arc/reference/statements"
...
[stateful variables](/reference/control/arc/reference/variables#stateful) instead.
...
A `for` with a condition repeats while the condition is true (a `bool`, or a non-zero
numeric):
...
| Conditional           | `for condition { }`                    | Repeat while condition is true |
