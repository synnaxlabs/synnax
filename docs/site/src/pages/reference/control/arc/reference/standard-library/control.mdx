...
title: "Control"
description: "Arc standard library reference for the control module and set_authority"
...
promote or release writes that target shared channels. Import it with `import control`
before use.
