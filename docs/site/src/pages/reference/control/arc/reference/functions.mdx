...
[routing tables](/reference/control/arc/reference/flow#output-routing-tables) to connect
multiple outputs:
...
Use [routing tables](/reference/control/arc/reference/flow#input-routing-tables) to map
