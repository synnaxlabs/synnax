...
| `%d`    | int      | Decimal           | `42` → `42`             |
| `%b`    | int      | Binary            | `5` → `101`             |
| `%#b`   | int      | Binary, prefix    | `5` → `0b101`           |
| `%o`    | int      | Octal             | `8` → `10`              |
| `%#o`   | int      | Octal, prefix     | `8` → `010`             |
| `%x`    | int, str | Hex               | `255` → `ff`            |
| `%#x`   | int      | Hex, prefix       | `255` → `0xff`          |
...
| `%E`    | float    | Scientific, upper | `3.14` → `3.140000E+00` |
| `%g`    | float    | Compact           | `3.14` → `3.14`         |
| `%G`    | float    | Compact, upper    | `3.14` → `3.14`         |
| `%s`    | str      | String            | `"ok"` → `ok`           |
| `%q`    | str      | Quoted            | `"ok"` → `"ok"`         |
| `%v`    | any      | Default form      | `3.14` → `3.14`         |
| `%5d`   | int      | Width 5           | `42` → `␣␣␣42`          |
| `%-5d`  | int      | Width 5, left     | `42` → `42␣␣␣`          |
| `%05d`  | int      | Width 5, zero-pad | `42` → `00042`          |
| `%+d`   | int      | Force sign        | `42` → `+42`            |
| `% d`   | int      | Space for `+`     | `42` → `␣42`            |
| `%.2f`  | float    | Precision 2       | `3.14159` → `3.14`      |
| `%+f`   | float    | Force sign        | `3.14` → `+3.140000`    |
| `%6.2f` | float    | Width 6, prec 2   | `3.14` → `␣␣3.14`       |
| `%5s`   | str      | Width 5           | `"ok"` → `␣␣␣ok`        |
| `%-5s`  | str      | Width 5, left     | `"ok"` → `ok␣␣␣`        |
