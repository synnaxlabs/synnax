...
your application in the `Pluto.Provider` and `Pluto.Canvas` components.
...
Check out this [guide](/reference/pluto/line-plot) to learn how to plot data in real-time.
