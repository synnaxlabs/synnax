...
description: "The Provider and Canvas are the central components of the Pluto library"
---
...
If you're using visualization components like a line plots, you'll need to set up a 
rendering canvas for them to access. This comes in the form of the `Pluto.Canvas`
component.

To increase performance, pluto re-uses the canvas element across all visualizations. You
should only use one `Pluto.Canvas` component in your application, and we recommend placing
it as a fixed element that stretches across your entire application. Here's our previous
