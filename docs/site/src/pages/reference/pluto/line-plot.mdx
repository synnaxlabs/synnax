...
import { RealTimePlot, HistoricalPlot } from "@/pages/reference/pluto/Plot"
...
specifies the time range of the data to display.

### Example

Here's an example that displays data from a channel over a 30-minute period

<ComponentFrame>
    <HistoricalPlot client:only="react" />
</ComponentFrame>
