...
next: "Writers"
nextURL: "/reference/client/working-with-data/writers"
prev: "Series & Frames"
prevURL: "/reference/client/series-and-frames"
...
```typescript
const streamer = await client.openStreamer(["channel1", "channel2"]);
```
