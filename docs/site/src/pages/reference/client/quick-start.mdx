...
<Note.Note variant="info" className="compact">
  ...
  covered in [Channels](/reference/client/channels#creating-channels)
</Note.Note>
...
<Note.Note variant="info" className="compact">
  ...
  <a href="/reference/client/working-with-data/writers">Writers</a>.
</Note.Note>
...
<Client.Tabs client:load exclude={["console", "cpp"]}>
  ...
  <Fragment slot="python">
    ...
    The returned data is a [`Series`](/reference/client/series-and-frames#series) object, which contains the time-range occupied by the data. Notably, the `Series` can be treated exactly like a `numpy.ndarray`.
...
- **[Channels](/reference/client/channels)** - Master channel creation, retrieval,
  renaming, and deletion
- **[Reading Data](/reference/client/read-data)** - Explore different ways to read data
  from Synnax
- **[Writing Data](/reference/client/write-data)** - Learn best practices for writing
  data to Synnax
- **[Examples](/reference/client/examples)** - Browse full working examples
