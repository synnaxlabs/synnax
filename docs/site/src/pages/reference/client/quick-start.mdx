...
<Note.Note variant="info" className="compact">
  ...
  [Writing Data](/reference/client/write-data).
</Note.Note>
...
<Note.Note variant="info" className="compact">
  Reading and streamers are covered in [Iterators](/reference/client/advanced/iterators)
  and [Streaming Data](/reference/client/read-data#streaming-data), respectively.
  Range-based reading is covered in [Reading from
...
- **[Writing Data](/reference/client/write-data)** - Learn best practices for writing
  data to Synnax
- **[Examples](/reference/client/examples)** - Browse full working examples for common
  use cases
