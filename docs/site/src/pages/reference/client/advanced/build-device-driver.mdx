...
### <Step step={1} level="h3">Arduino Code</Step>
...
### <Step step={2} level="h3">Serial Connection</Step>
...
### <Step step={3} level="h3">Reading from Arduino</Step>
...
### <Step step={4} level="h3">Setting up Synnax Client</Step>
...
### <Step step={5} level="h3">Writing to Synnax</Step>
...
### <Step step={6} level="h3">Console Plot</Step>
...
### <Step step={2} level="h3">Synnax Command Channel</Step>
...
### <Step step={3} level="h3">Streaming Commands</Step>
...
### <Step step={4} level="h3">Console Control</Step>
...
### <Step step={2} level="h3">Synnax Channels</Step>
...
### <Step step={3} level="h3">Combined Read-Write Loop</Step>
...
### <Step step={4} level="h3">Console Setup</Step>
