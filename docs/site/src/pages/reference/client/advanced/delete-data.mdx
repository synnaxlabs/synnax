...
next: "Iterators"
nextURL: "/reference/client/advanced/iterators"
prev: "Writers"
prevURL: "/reference/client/working-with-data/writers"
...
For example, to remove data in the range `[00:01, 00:03)` on the `my_index_ch` and
`my_tc` channels:
