...
next: "Auto-Indexing"
nextURL: "/reference/client/advanced/auto-indexing"
prev: "Writing Data"
...
- **Chunk-based file ingestion** -> When loading historical data from files, committing
  ...
  complete datasets.
- **Batch processing** -> When ingesting large volumes of historical data where
  real-time visibility is not required and performance optimization by reducing commit
  overhead is desired.
