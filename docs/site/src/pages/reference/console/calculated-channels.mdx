...
automatically activates the calculation. When you stop streaming, the calculation pauses.
...
historical data for any time range where both sensors have recorded data. The calculation
will be applied to the historical data as if it had been running continuously.
