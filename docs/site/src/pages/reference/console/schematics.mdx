...
The style tab on allows users to edit (<Icon.Edit color="var(--pluto-primary-z)"/>) the
symbol's label, size, orientation, color, and other visual properties.
...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      {<td>Invert the visual state of the valve when True</td>}
    </tr>
    <tr>
      <td>
        <b>Units</b>
