...
Create reate a channel from the
[Channels Toolbar](/reference/console/ui-overview#channels), or with the "Create
Channel" command in the
...
Example: `cdaq1_mod2_0` as `nv_110` or `nv_facility`ß
