...
A [channel](/reference/concepts/channels) is a data store that represents ordered values
in Synnax. Channels are commonly used to store data from sources such as sensors.
