...
You can also attach arbitrary meta-data to a range, including links to external resources.
To add a new field, simply click on a cell in the meta data section of the range 
overview page. 
