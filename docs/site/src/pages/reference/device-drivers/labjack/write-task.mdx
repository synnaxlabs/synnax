...
device and created the relevant channels in Synnax. Check out the [Configure
Device](/reference/device-drivers/labjack/configure-device) guide for more information.
