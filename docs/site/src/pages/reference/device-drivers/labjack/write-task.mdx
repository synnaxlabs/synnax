...
description: "Learn how to control LabJack devices using Synnax."
prev: "Read Task"
...
The LabJack Write Task is used to control LabJack devices from Synnax. In this guide,
we'll walk you through the steps to create a LabJack Write Task in Synnax.
...
To create a write task from the Devices Toolbar, open the Synnax Console and click on
...
You'll see an option called "Create a LabJack Write Task". Select this option to open
...
the top-right corner and select "LabJack Write Task".
