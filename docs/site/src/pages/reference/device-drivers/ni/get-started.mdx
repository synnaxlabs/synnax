...
The NI driver is compatible with Linux, Windows, and NI Linux RT. The driver will not
be able to find your devices when running on MacOS or within a containerized environment
