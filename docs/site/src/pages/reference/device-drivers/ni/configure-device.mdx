...
Console when a new device is connected. To start configuring the device, simply click
the "Configure" button in the notification.
...
Alternatively, you can find connected devices in the resources toolbar. To open the
device configuration dialog, right click on the device and select "Configure".
...
data, you can start with a [Digital Read
Task](/reference/device-drivers/ni/digital-read-task) or an [Analog Read
Task](/reference/device-drivers/ni/analog-read-task). To send commands, you can use a
[Digital Write Task](/reference/device-drivers/ni/digital-write-task).
