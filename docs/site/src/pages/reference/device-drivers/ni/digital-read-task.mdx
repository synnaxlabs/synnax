...
prev: "Digital Write Task"
prevURL: "/reference/device-drivers/ni/digital-write-task"
---
...
<Video client:only="react" id="device-drivers/ni/digital-read-task/digital-read-task-select-device" />
...
<Video client:only="react" id="device-drivers/ni/digital-read-task/digital-read-task-add-channel" />
...
<Video client:only="react" id="device-drivers/ni/digital-read-task/digital-read-task-start" />
