...
the task for, right-click on it, and select "Create NI Digital Read Task".
...
click on the Search and Command Palette at the top. You can also open this palette with
