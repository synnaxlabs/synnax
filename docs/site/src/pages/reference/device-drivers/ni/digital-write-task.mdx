...
outputs of your device based on values written to Synnax [command channels](#how-commands-work-in-synnax).
...
you'd like to create the task for, right-click on it, and select "Create Digital write Task".
...
The first step is to select the NI device you'd like to write to the outputs of. Use
