...
1. [A Synnax deployment running on your network]](/reference/cluster/quick-start)
2. [The Synnax Console installed on your machine](/reference/console/get-started)
3. An OPC UA compliant server running on your device. This server should be reachable from the Synnax database deployment.
