...
process that writes data to Holding Registers or Coils on the Modbus server based on
...
3. **Data Type** - For Holding Registers, select the data type (`int16`, `uint16`,
