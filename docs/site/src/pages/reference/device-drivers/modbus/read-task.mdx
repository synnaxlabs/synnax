...
precision on the order of 100 μs. Under heavy load, this timing precision may degrade.
...
selecting the add icon (<Icon.Add />), or opening the context menu on a Modbus server
