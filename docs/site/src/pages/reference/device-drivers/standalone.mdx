...
description: "Deploy the standalone driver on a separate machine from the Core."
...
installed, we'll need to configure it to connect to your Core.
...
## <StepText step="2" level="h2">Connect to a Core</StepText>
