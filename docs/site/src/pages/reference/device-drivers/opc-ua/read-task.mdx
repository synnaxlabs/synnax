...
Palette at the top. You can also open this palette with Command Palette at the top. You
can also open this palette with `Ctrl+Shift+P` on Windows or `Cmd+Shift+P` on macOS.
