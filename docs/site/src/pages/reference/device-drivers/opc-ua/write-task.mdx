...
"OPC". You'll see an option called "Create a New Digital write Task". Select this
...
database](/reference/cluster/quick-start) with a memory-backed data store. This will
