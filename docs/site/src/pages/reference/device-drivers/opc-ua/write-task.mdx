...
<Table>
    ...
    <tbody>
        ...
        <tr>
            <td>Stream Rate</td>
            <td>How often, in Hz, Synnax streams data to the Synnax database. This
            option is only available when array sampling is off.</td>
        </tr>
        <tr>
            <td>Array Size</td>
            <td>The number of samples to read in bulk from the OPC UA server. This
            option is only available when array sampling is on.</td>
        </tr>
    </tbody>
</Table>
