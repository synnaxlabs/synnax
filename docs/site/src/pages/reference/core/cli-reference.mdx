...
<Table
  ...
  data={[
    ...
    },
    {
      option: "--enable-integrations",
      default: "[]",
      description: "Device integrations to enable (labjack, modbus, ni, opc, sequence).",
    },
    {
      option: "--disable-integrations",
      default: "[]",
      description: "Device integrations to disable (labjack, modbus, ni, opc, sequence).",
    },
    {
      option: "--peers/-p",
      default: "[]",
...
Removes the Synnax Windows Service. This will stop the service if it is running
