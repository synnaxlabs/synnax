...
<Table
  ...
  data={[
    ...
    },
    {
      ...
      default: "2.5s",
      description:
        "The duration after which a telemetry streamer will be closed by the Core if it stops receiving messages. It's rarely necessary to change this value.",
    },
    {
      option: "--no-driver",
      default: "false",
      description:
        "Disables the embedded device driver for the Synnax database. This is useful when you want to run Synnax without any device integration.",
    },
    {
