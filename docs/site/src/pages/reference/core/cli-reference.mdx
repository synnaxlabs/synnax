  ...
  data={[
    {
      ...
      behavior:
        "A new user is created with the configured username and marked as the root user. Credentials are registered and the user is granted the <code>Owner</code> role. The ",
    },
    {
