...
A standalone Core needs a license from your organization. A Core without one starts, but
only login and the license screen work until a token is activated from the Console. The
