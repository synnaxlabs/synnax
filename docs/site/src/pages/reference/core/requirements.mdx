...
- [National Instruments](https://docs.synnaxlabs.com/reference/device-drivers/ni) -
  Windows, Linux
- [LabJack](https://docs.synnaxlabs.com/reference/device-drivers/labjack) - Windows,
  Linux, macOS
- [OPC UA](https://docs.synnaxlabs.com/reference/device-drivers/opc-ua) - Windows,
  Linux, macOS, or a containerized environment
- [Modbus](https://docs.synnaxlabs.com/reference/device-drivers/modbus) - Windows,
  Linux, macOS, or a containerized environment
