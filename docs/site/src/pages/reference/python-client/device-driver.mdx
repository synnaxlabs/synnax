...
There are two components we need to install to get started with Synnax: the [cluster](/reference/cluster/get-started)
...
console with a switch on a [schematic](/reference/console/schematic) to control the
