...
If you are interested in streaming data at a lower rate than what is being written to the server, you can use the optional `downsample` parameter to specify the number of frames to skip before returning the next frame:
