...
description: "Use the Synna Python client to connect with a Synnax cluster."
---
...
The `synnax` library requires Python 3.10 or higher, and is available on
...
<Note variant="info">
Python can be difficult to get installed and running correctly, so we've put together a
[troubleshooting guide](/reference/python-client/troubleshooting) that you can
reference.
</Note>
...
Synnax! Next, learn how to create [channels](/reference/python-client/channels) for
storing data.
