...
# You can also create a channel by creating the channel locally and passing it to the
...
Now that we know how to create and retrieve channels, we can start
[reading](/reference/python-client/read-data) and
[writing](/reference/python-client/write-data) data to them.
