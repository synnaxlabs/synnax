...
checking out our [concepts](../concepts/write-domains) page to learn more about
the best practices for writing data to Synnax.

{/*We will want to replace that link when we remove the domain page.*/}
...
[concepts](../concepts/write-domains#transactions) page to learn more about how
they work.

{/* Again, how will this change when we rewrite the writer page? */}
