...
<Table
    ...
    data={[
        ...
        },
        {
            ...
            default: "\"\"",
            description: "Comma seperated list of device integrations. This is useful when you don't want particular integrations."   
        },
        {
            option: "--enable-integrations",
            default: "ni,opc",
            description: "Comma seperated list of device integrations. This is useful when you only want particular integrations. All integrations are enabled by default."
        }
    ]}
/>
