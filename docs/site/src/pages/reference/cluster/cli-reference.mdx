...
<Table
    ...
    data={[
        ...
        },
        {
            option: "--product-key",
            default: "\"\"",
            description: `Product license key to use Synnax outside of demo
                mode. The key should be entered with quotation marks as in
                <code>"000000-00000000-0000000000"</code>.`,
        },
    ]}
/>
...
```json
{
    ...
    "username": "synnax",
    "password": "seldon",
    "product-key": "000000-00000000-0000000000",
}
```
</slot>
<slot slot="yaml">
