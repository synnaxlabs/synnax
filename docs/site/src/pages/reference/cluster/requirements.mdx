...
<Note.Note variant="info">
  ...
  hardware that is at least 2x the minimum requirements. This leaves ample room for
...
intensive. For most production deployments, we recommend using a minimum of 8GB of RAM.
