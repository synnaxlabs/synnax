...
dependencies. Modern Arc-based calculated channels automatically detect dependencies from
the expression, making this field obsolete. It is maintained for backward compatibility
