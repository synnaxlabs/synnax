...
The expression field is only used for [calculated
channels](/reference/console/calculated-channels). This experssion is a Lua string that
calculated what value should be written to the channel and returns it with `return`.
