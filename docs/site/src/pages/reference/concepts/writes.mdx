...
same number of samples for each channel. For example, this frame is
...
<Rule title="Rule 3">Rules 1 and 2 do not apply to virtual channels.</Rule>
...
<Rule>Command channels almost always require separate indexes.</Rule>
