...
transaction, we open a new writer and being writing data frames using a file like 
...
During this period, a user can write continuous frames of data to the domain. These
