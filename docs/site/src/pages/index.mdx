...
Role | Description
--- | ---
<a href="/guide/analyst">Analyst</a> | Explore and analyze data, and automate post-processing.
<a href="/guide/developer">Developer</a> | Extend Synnax with your own applications and develop drivers for custom hardware.
...
{/* <a href="/role/sys-admin" style={{whiteSpace: "nowrap"}}>System Administrator</a> | Deploy Synnax in your environment of choice. */}
