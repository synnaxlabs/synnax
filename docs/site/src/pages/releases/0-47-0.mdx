...
- Added validation for National Instruments AI minimum sample rate to prevent
...
- Fixed an issue where devices would accidentally regroup on Core startup.
- Fixed channel renaming synchronization issues across the system.
- Fixed issues with opening streamers when channel key is 0.
