...
<Note.Note variant="warning">
  Embedded control sequences (Lua-based) have been deprecated and removed. New
  automations should use [Arc](/reference/control/arc/introduction) instead.
</Note.Note>

This release originally introduced a Lua-based embedded control sequencing system. It
has since been replaced by [Arc](/reference/control/arc/introduction), Synnax's reactive
automation language. While this new system does not replace the existing
