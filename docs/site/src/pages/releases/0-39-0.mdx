...
<Note.Note variant="warning">
  Embedded control sequences (Lua-based) were deprecated in v0.52 and have been removed.
  New automations should use [Arc](/reference/control/arc/introduction) instead.
</Note.Note>
