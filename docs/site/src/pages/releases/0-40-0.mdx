...
release, we've introduced a new [clock skew detection
algorithm](/reference/device-drivers/timing) that automatically corrects for timing
offsets in hardware timed tasks.
