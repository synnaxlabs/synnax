...
- The Synnax Demo Core is now automatically available on the Core toolbar selector when
  starting the Synnax Console.
...
- Multi-node clusters now support key-value state forwarding.
