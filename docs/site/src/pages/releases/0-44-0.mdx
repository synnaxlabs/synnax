...
In Python, simply [call `read_latest`](/reference/python-client/read-data) with the
...
[`readLatest` method](/reference/typescript-client/read-data) that works in the same
way.
