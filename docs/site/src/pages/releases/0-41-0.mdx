...
release. In the new Devices Toolbar, we've added real-time information on device health.
...
independent, category specific toolbars. There are new toolbars for devices, users,
channels, and workspaces. workspace toolbars. The Ranges Toolbar and Tasks Toolbar have
also been moved to the left-hand side of the Console.
...
The new Devices Toolbar provides real-time information on the status of Synnax Drivers
