...
description: "Register multiple users to a Synnax Core and manage their permissions."
---
...
**Connect a Core** button in the top-right corner of the Cores Dropdown and enter your
...
can log into the Core by passing their new credentials into the login command instead of
...
the Synnax Console by finding a user in the Users Toolbar on the left-hand side of the
screen, right-clicking a user, and selecting "Edit Permissions".
...
their name in the Users Toolbar on the left-hand side of the screen.
