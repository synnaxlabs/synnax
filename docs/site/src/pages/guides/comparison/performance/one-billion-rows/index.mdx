...
We'll be comparing the performance of Synnax, Timescale, and Influx across three separate
tests that focus on ingestion performance. We'll be running the tests on a single
