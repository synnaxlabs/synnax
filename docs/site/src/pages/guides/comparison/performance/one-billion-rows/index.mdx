...
<Details>
  {/* prettier-ignore */}
  <Text.Text slot="summary" level="small" size="medium" weight={500}><Icon.Table slot="startIcon" /> Tabulated Data - Throughput in Samples/s  </Text.Text>
  <Table>
    <tbody>
      <tr>
        <td>
...
<Details>
<div slot="summary">
<Text.Text level="small" size="medium" weight={500}><Icon.Table slot="startIcon" />Tabulated Data - Memory usage in GB</Text.Text>
</div>
<Table>
  <tbody>
    <tr>
...
<Details>
  {/* prettier-ignore */}
  <Text.Text slot="summary" level="small" size="medium" weight={500}>  <Icon.Table slot="startIcon" />    Tabulated Data - CPU Usage  </Text.Text>
  <Table>
    <tbody>
      <tr>
        <td>
...
<Details>
  <div slot="summary">
    <Text.Text level="small" size="medium" weight={500}><Icon.Table slot="startIcon" />Tabulated Data - Throughput in Samples/s</Text.Text>
  </div>
<Table>
  <tbody>
    <tr>
