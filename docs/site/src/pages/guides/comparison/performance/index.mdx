...
<Details>
  {/* prettier-ignore */}
  <Summary><Text.Text level="small" weight={500}>Tabulated Data - Throughput in Samples/s</Text.Text></Summary>
  <Table>
    <tbody>
      <tr>
        <td>
...
<Details>
<Summary><Text.Text level="small" weight={500}>Tabulated Data - Memory Usage in GB</Text.Text></Summary>
<Table>
  <tbody>
    <tr>
      <td>
...
<Details>
<Summary><Text.Text level="small" weight={500}>Tabulated Data - CPU Usage</Text.Text></Summary>
<Table>
  <tbody>
    <tr>
      <td>
...
## <StepText level="h2" name="Test" step={3}>One Billion Rows</StepText>
...
<Note.Note variant="info">
  ...
  a scenario as well. Our goal is to prove that **Synnax is by far the fastest data
  storage & streaming solution for high-speed hardware sensor data.**
</Note.Note>
