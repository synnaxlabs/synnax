...
import { Auth, Console, Platform } from "@/components";
import { DownloadURL } from "@/components/core/DownloadURL";
import MoveCommand from "@/components/core/MoveCommand.astro";
import { WindowsDownloadButton } from "@/components/core/WindowsDownloadButton";
...
<br />
<br />
<Auth.AuthGate client:only="react">
