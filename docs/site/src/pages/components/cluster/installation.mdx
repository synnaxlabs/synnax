...
import SynnaxVersionOutput from "@/components/SynnaxVersionOutput.astro";
...
<div class="warn">
<b>Note</b> - If you've also installed the [Synnax Python Client](/components/python-client/get-started),
