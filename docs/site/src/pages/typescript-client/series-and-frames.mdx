...
description: "Work with series and frames to access and manipulate data from Synnax."
---

Series and Frames are the two fundamental data types used for working with channel data
