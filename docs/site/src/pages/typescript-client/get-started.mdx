...
| `secure` | Whether to use TLS encryption. This should be set to `true` if the cluster is using TLS.
See [production](/deployment/production) for more information. | `false` |
