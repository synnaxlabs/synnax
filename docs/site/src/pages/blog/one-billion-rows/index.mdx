...
databases: [TimescaleDB](https://timescale.com) and [InfluxDB](https://influxdata.com).
...
[TimescaleDB](https://timescale.com) is a general-purpose time series database built on
top of PostgreSQL. Its flexibility allows it to serve a number of workloads including
IoT, user analytics, and financial data.
...
Timescale uses
[hypertables](https://tigerdata.com/docs/use-timescale/latest/hypertables) to increase
...
[InfluxDB](https://influxdata.com) is a NoSQL time series database also built for
...
- [InfluxDB v2.7.10](https://influxdata.com/downloads/)
...
Inspired by the
[One Billion Row Challenge](https://morling.dev/blog/one-billion-row-challenge/), we'll
be inserting one billion rows of data into each database to see how they handle the
load.
...
[Contact us](https://synnaxlabs.com/contact) to learn more.
