...
**Note:** The 1.5rem horizontal margin indents code blocks slightly from body text.
This is a stylistic choice - some prefer flush alignment. Worth reviewing.
...
2. Table cell text at 14px when body is 16px creates hierarchy but may be too small
