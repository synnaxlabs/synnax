...
### 0.0 The Core round-trip problem
...
#### 0.2.0 High-frequency PID control
...
#### 0.2.2 Coordinated multi-actuator control
...
#### 0.2.3 Closed-loop feedback with state estimation
...
### 0.3 Control authority in a bypassed pipeline
...
#### 0.3.0 How authority works today
...
#### 0.3.1 The bypass removes synchronous validation
...
#### 0.3.2 The authority propagation window
...
#### 0.3.3 Comparison with the current pipeline
...
#### 0.3.5 Authority changes initiated by the Arc program
...
### 1.0 The pipeline is the integration point
...
### 1.3 Consumers define their own semantics
...
### 5.3 Cost breakdown (`large_acq`, 480 kB)
...
### 6.0 The dual-filter authority gap

#### 6.0.0 Problem statement
...
#### 6.0.2 Asymmetry between local and remote controllers
...
#### 6.1.5 Remote authority changes and the existing control channel
