# 17 General purpose device drivers
...
#### 0.2.2 Communicating task state
...
### 0.3 Command and acquisition pipelines
...
### 0.4 Acquisition pipeline overview
...
### 1.0 The build system of choice - Bazel
