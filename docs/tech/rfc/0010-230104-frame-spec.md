...
method
for attaching this information is challenging, and is discussed in detail in the next
section.
...
structure,
or should we only move some of it? My answer: some. Some array information is
effectively
universal, and will never be layer independent. This includes the data type, density,
time
