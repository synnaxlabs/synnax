# 49 Client connection lifecycle
...
- **Intent**: The user's declared wish to be connected to a specific cluster. A non-null
  client exists iff intent exists.
