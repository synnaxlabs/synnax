...
A driver persists some of its meta-data inside the Synnax Server for access by other parts
of the platform, such as the UI. Here are the fields we're going to store inside
Synnax:
