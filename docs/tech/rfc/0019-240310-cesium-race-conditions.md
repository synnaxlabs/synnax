...
The channel's file system also includes the `index.domain` file used for domain
index persist.
...
Notice that changes to the domain index after the position of interest does not invalidate the
position.
