...
### 4.0 The Aether component framework
...
#### 4.0.2 Issues with `React.StrictMode`
...
### 4.2 Integrating telemetry sources
...
#### 4.2.1 Polymorphic satellite proxy
