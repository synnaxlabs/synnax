...
### 3.0 Cluster state synchronization
...
#### 3.0.0 Cluster state data structure
...
#### 3.0.1 Anatomy of a conversation

##### 3.0.1.0 Sync message
...
##### 3.4.0.1 Forward entire store as gossip
