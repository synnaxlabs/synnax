...
- `"unix_sec"` - Unix timestamp in seconds (accepts both integer and decimal, e.g.,
  `1705312200` or `1705312200.5`)
- `"unix_ms"` - Unix timestamp in milliseconds (accepts both integer and decimal, e.g.,
  `1705312200000` or `1705312200000.5`)
- `"unix_us"` - Unix timestamp in microseconds (accepts both integer and decimal, e.g.,
  `1705312200000000` or `1705312200000000.5`)
...
- `time_format`: Required when `time_pointer` is set. Timestamp format, using the same
  ...
  - `"unix_sec"` - Unix timestamp in seconds (decimal)
  - `"unix_ms"` - Unix timestamp in milliseconds (decimal)
  - `"unix_us"` - Unix timestamp in microseconds (decimal)
  - `"unix_ns"` - Unix timestamp in nanoseconds (`int`)
...
- `"timestamp"` - Timestamp value. Requires a `format` field with one of the same five
  ...
  - `"unix_sec"` - Unix timestamp in seconds (written as a JSON number, decimal)
  - `"unix_ms"` - Unix timestamp in milliseconds (written as a JSON number, decimal)
  - `"unix_us"` - Unix timestamp in microseconds (written as a JSON number, decimal)
