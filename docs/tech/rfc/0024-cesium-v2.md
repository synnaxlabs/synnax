# 24 Cesium domain index data structure change
...
### 3.0 Choice of new data structure
...
### 3.1 Difference in domain iterator workflow
...
<div align="center">
    <img width="90%" src="img/0024-cesium-v2/old-vs-new.png">
    <h6>Old vs new iterator workflow </h6>
</div>

### 3.2 Additional remarks on the skip list
