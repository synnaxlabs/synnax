...
- Labeled Ranges as the pivot point around which meta-data revolves.
- What are the edge cases with labeled ranges
- Query and access patterns -> searching

## 3.1 - Experiment 2 - Synnax is not a Primary Metadata Store

- We build links to and between meta-data, we don't store it and structure it ourselves.
- Could potentially involve building and integrating some external systems.
...
What are the strategies for measuring the success of certain experiments?
